declare const libName = "./module.TKXDESTEP.wasm.d.ts";
...
export declare class STEPCAFControl_GDTProperty {
  constructor()
  static GetDimModifiers(theCRI: any, theModifiers: XCAFDimTolObjects_DimensionModifiersSequence): void;
  static GetDimClassOfTolerance(theLAF: any, theHolle: Standard_Boolean, theFV: XCAFDimTolObjects_DimensionFormVariance, theG: XCAFDimTolObjects_DimensionGrade): void;
  static GetDimType(theName: any, theType: XCAFDimTolObjects_DimensionType): Standard_Boolean;
  static GetDatumTargetType(theDescription: any, theType: XCAFDimTolObjects_DatumTargetType): Standard_Boolean;
  static GetDimQualifierType(theDescription: any, theType: XCAFDimTolObjects_DimensionQualifier): Standard_Boolean;
  static GetTolValueType_1(theDescription: any, theType: XCAFDimTolObjects_GeomToleranceTypeValue): Standard_Boolean;
  static GetTolValueType_2(theType: XCAFDimTolObjects_GeomToleranceTypeValue): any;
  static GetDimTypeName(theType: XCAFDimTolObjects_DimensionType): any;
  static GetDimQualifierName(theQualifier: XCAFDimTolObjects_DimensionQualifier): any;
  static GetDimModifierName(theModifier: XCAFDimTolObjects_DimensionModif): any;
  static GetLimitsAndFits(theHole: Standard_Boolean, theFormVariance: XCAFDimTolObjects_DimensionFormVariance, theGrade: XCAFDimTolObjects_DimensionGrade): any;
  static GetDatumTargetName(theDatumType: XCAFDimTolObjects_DatumTargetType): any;
  static IsDimensionalLocation(theType: XCAFDimTolObjects_DimensionType): Standard_Boolean;
  static IsDimensionalSize(theType: XCAFDimTolObjects_DimensionType): Standard_Boolean;
  static GetGeomToleranceType_1(theType: XCAFDimTolObjects_GeomToleranceType): StepDimTol_GeometricToleranceType;
  static GetGeomToleranceType_2(theType: StepDimTol_GeometricToleranceType): XCAFDimTolObjects_GeomToleranceType;
  static GetGeomTolerance(theType: XCAFDimTolObjects_GeomToleranceType): any;
  static GetGeomToleranceModifier(theModifier: XCAFDimTolObjects_GeomToleranceModif): StepDimTol_GeometricToleranceModifier;
  static GetDatumRefModifiers(theModifiers: XCAFDimTolObjects_DatumModifiersSequence, theModifWithVal: XCAFDimTolObjects_DatumModifWithValue, theValue: Standard_Real, theUnit: StepBasic_Unit): any;
  static GetTessellation(theShape: TopoDS_Shape): any;
  delete(): void;
}
...
export declare class STEPCAFControl_Reader {
  ...
  static FindInstance(NAUO: any, STool: any, Tool: STEPConstruct_Tool, ShapeLabelMap: XCAFDoc_DataMapOfShapeLabel): TDF_Label;
...
export declare type module_TKXDESTEP_wasm = {

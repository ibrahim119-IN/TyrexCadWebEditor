declare const libName = "./module.TKLCAF.wasm.d.ts";
...
export declare class TDF_TagSource extends TDF_Attribute {
  ...
  static Set_1(label: TDF_Label): any;
  static NewChild_1(L: TDF_Label): TDF_Label;
...
export declare class TDF_LabelMapHasher {
  constructor();
  static HashCode(theLabel: TDF_Label, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(aLab1: TDF_Label, aLab2: TDF_Label): Standard_Boolean;
  delete(): void;
}
...
export declare class TDataStd_IntegerArray extends TDF_Attribute {
  ...
  DynamicType(): any;
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, lower: Standard_Integer, upper: Standard_Integer, isDelta: Standard_Boolean): any;
  static Set_2(label: TDF_Label, theGuid: Standard_GUID, lower: Standard_Integer, upper: Standard_Integer, isDelta: Standard_Boolean): any;
...
export declare class TDataStd_BooleanArray extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, lower: Standard_Integer, upper: Standard_Integer): any;
  static Set_2(label: TDF_Label, theGuid: Standard_GUID, lower: Standard_Integer, upper: Standard_Integer): any;
  Init(lower: Standard_Integer, upper: Standard_Integer): void;
...
export declare class TDataStd_IntegerList extends TDF_Attribute {
  ...
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label): any;
  static Set_2(label: TDF_Label, theGuid: Standard_GUID): any;
...
export declare class TDataStd_IntPackedMap extends TDF_Attribute {
  ...
  DynamicType(): any;
  static GetID(): Standard_GUID;
  static Set(label: TDF_Label, isDelta: Standard_Boolean): any;
...
export declare class TDF_DerivedAttribute {
  constructor();
  static Register(theNewAttributeFunction: any, theNameSpace: Standard_CString, theTypeName: Standard_CString): any;
  static Attribute(theType: Standard_CString): any;
  static TypeName(theType: Standard_CString): TCollection_AsciiString;
  static Attributes(theList: any): void;
  delete(): void;
}
...
export declare class TDataStd_Expression extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set(label: TDF_Label): any;
...
export declare class TFunction_Function extends TDF_Attribute {
  constructor()
  static Set_1(L: TDF_Label): any;
  static Set_2(L: TDF_Label, DriverID: Standard_GUID): any;
  static GetID(): Standard_GUID;
...
export declare class TDataStd_Real extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, value: Standard_Real): any;
  static Set_2(label: TDF_Label, guid: Standard_GUID, value: Standard_Real): any;
...
export declare class TDataStd_TreeNode extends TDF_Attribute {
  constructor()
  static Find(L: TDF_Label, T: any): Standard_Boolean;
  static Set_1(L: TDF_Label): any;
  static Set_2(L: TDF_Label, ExplicitTreeID: Standard_GUID): any;
...
export declare class TDataStd_Integer extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, value: Standard_Integer): any;
  static Set_2(label: TDF_Label, guid: Standard_GUID, value: Standard_Integer): any;
...
export declare class TDF_Reference extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(I: TDF_Label, Origin: TDF_Label): any;
...
export declare class TDataStd_UAttribute extends TDF_Attribute {
  constructor()
  static Set(label: TDF_Label, LocalID: Standard_GUID): any;
...
export declare class TDataStd_Comment extends TDataStd_GenericExtString {
  ...
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label): any;
  static Set_2(label: TDF_Label, string: TCollection_ExtendedString): any;
  Set_3(S: TCollection_ExtendedString): void;
  SetID_1(guid: Standard_GUID): void;
  SetID_2(): void;
  static get_type_name(): string;
...
export declare class TDataStd_AsciiString extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, string: TCollection_AsciiString): any;
  static Set_2(label: TDF_Label, guid: Standard_GUID, string: TCollection_AsciiString): any;
...
export declare class TDataStd_Directory extends TDataStd_GenericEmpty {
  constructor()
  static Find(current: TDF_Label, D: any): Standard_Boolean;
  static New(label: TDF_Label): any;
  static AddDirectory(dir: any): any;
  static MakeObjectLabel(dir: any): TDF_Label;
  static GetID(): Standard_GUID;
  ID(): Standard_GUID;
  static get_type_name(): string;
  static get_type_descriptor(): any;
...
export declare class TDataStd_NoteBook extends TDataStd_GenericEmpty {
  constructor()
  static Find(current: TDF_Label, N: any): Standard_Boolean;
  static New(label: TDF_Label): any;
  static GetID(): Standard_GUID;
...
export declare class TDocStd_XLink extends TDF_Attribute {
  constructor()
  static Set(atLabel: TDF_Label): any;
  Update(): any;
  ID(): Standard_GUID;
  static GetID(): Standard_GUID;
...
export declare class TDF {
  ...
  static GUIDFromProgID(ProgID: TCollection_ExtendedString, ID: Standard_GUID): Standard_Boolean;
  static ProgIDFromGUID(ID: Standard_GUID, ProgID: TCollection_ExtendedString): Standard_Boolean;
  delete(): void;
}
...
export declare class TDF_ClosureTool {
  constructor();
  static Closure_1(aDataSet: any): void;
  static Closure_2(aDataSet: any, aFilter: TDF_IDFilter, aMode: TDF_ClosureMode): void;
  static Closure_3(aLabel: TDF_Label, aLabMap: TDF_LabelMap, anAttMap: TDF_AttributeMap, aFilter: TDF_IDFilter, aMode: TDF_ClosureMode): void;
  delete(): void;
}

export declare class TDF_ComparisonTool {
  constructor();
  static Compare_1(aSourceDataSet: any, aTargetDataSet: any, aFilter: TDF_IDFilter, aRelocationTable: any): void;
  static SourceUnbound(aRefDataSet: any, aRelocationTable: any, aFilter: TDF_IDFilter, aDiffDataSet: any, anOption: Standard_Integer): Standard_Boolean;
  static TargetUnbound(aRefDataSet: any, aRelocationTable: any, aFilter: TDF_IDFilter, aDiffDataSet: any, anOption: Standard_Integer): Standard_Boolean;
  static Cut(aDataSet: any): void;
  static IsSelfContained(aLabel: TDF_Label, aDataSet: any): Standard_Boolean;
  delete(): void;
}
...
export declare class TDF_CopyLabel {
  ...
  static ExternalReferences_1(Lab: TDF_Label, aExternals: TDF_AttributeMap, aFilter: TDF_IDFilter): Standard_Boolean;
  static ExternalReferences_2(aRefLab: TDF_Label, Lab: TDF_Label, aExternals: TDF_AttributeMap, aFilter: TDF_IDFilter, aDataSet: any): void;
  Perform(): void;
...
export declare class TDF_CopyTool {
  constructor();
  static Copy_1(aSourceDataSet: any, aRelocationTable: any): void;
  static Copy_2(aSourceDataSet: any, aRelocationTable: any, aPrivilegeFilter: TDF_IDFilter): void;
  static Copy_3(aSourceDataSet: any, aRelocationTable: any, aPrivilegeFilter: TDF_IDFilter, aRefFilter: TDF_IDFilter, setSelfContained: Standard_Boolean): void;
  delete(): void;
}
...
export declare class TDF_Tool {
  constructor();
  static NbLabels(aLabel: TDF_Label): Standard_Integer;
  static NbAttributes_1(aLabel: TDF_Label): Standard_Integer;
  static NbAttributes_2(aLabel: TDF_Label, aFilter: TDF_IDFilter): Standard_Integer;
  static IsSelfContained_1(aLabel: TDF_Label): Standard_Boolean;
  static IsSelfContained_2(aLabel: TDF_Label, aFilter: TDF_IDFilter): Standard_Boolean;
  static OutReferers_1(theLabel: TDF_Label, theAtts: TDF_AttributeMap): void;
  static OutReferers_2(aLabel: TDF_Label, aFilterForReferers: TDF_IDFilter, aFilterForReferences: TDF_IDFilter, atts: TDF_AttributeMap): void;
  static OutReferences_1(aLabel: TDF_Label, atts: TDF_AttributeMap): void;
  static OutReferences_2(aLabel: TDF_Label, aFilterForReferers: TDF_IDFilter, aFilterForReferences: TDF_IDFilter, atts: TDF_AttributeMap): void;
  static RelocateLabel(aSourceLabel: TDF_Label, fromRoot: TDF_Label, toRoot: TDF_Label, aTargetLabel: TDF_Label, create: Standard_Boolean): void;
  static Entry(aLabel: TDF_Label, anEntry: TCollection_AsciiString): void;
  static TagList_1(aLabel: TDF_Label, aTagList: TColStd_ListOfInteger): void;
  static TagList_2(anEntry: TCollection_AsciiString, aTagList: TColStd_ListOfInteger): void;
  static Label_1(aDF: any, anEntry: TCollection_AsciiString, aLabel: TDF_Label, create: Standard_Boolean): void;
  static Label_2(aDF: any, anEntry: Standard_CString, aLabel: TDF_Label, create: Standard_Boolean): void;
  static Label_3(aDF: any, aTagList: TColStd_ListOfInteger, aLabel: TDF_Label, create: Standard_Boolean): void;
  static CountLabels(aLabelList: TDF_LabelList, aLabelMap: TDF_LabelIntegerMap): void;
  static DeductLabels(aLabelList: TDF_LabelList, aLabelMap: TDF_LabelIntegerMap): void;
  static DeepDump_1(anOS: Standard_OStream, aDF: any): void;
  static ExtendedDeepDump_1(anOS: Standard_OStream, aDF: any, aFilter: TDF_IDFilter): void;
  static DeepDump_2(anOS: Standard_OStream, aLabel: TDF_Label): void;
  static ExtendedDeepDump_2(anOS: Standard_OStream, aLabel: TDF_Label, aFilter: TDF_IDFilter): void;
  delete(): void;
}
...
export declare class TDataStd_Current extends TDF_Attribute {
  ...
  static Has(acces: TDF_Label): Standard_Boolean;
...
export declare class TDocStd_Modified extends TDF_Attribute {
  constructor()
  static IsEmpty_1(access: TDF_Label): Standard_Boolean;
  static Add(alabel: TDF_Label): Standard_Boolean;
  static Remove(alabel: TDF_Label): Standard_Boolean;
  static Contains(alabel: TDF_Label): Standard_Boolean;
  static Get_1(access: TDF_Label): TDF_LabelMap;
  static Clear_1(access: TDF_Label): void;
  static GetID(): Standard_GUID;
...
export declare class TDocStd_Owner extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static SetDocument_1(indata: any, doc: any): void;
  static SetDocument_2(indata: any, doc: TDocStd_Document): void;
  static GetDocument_1(ofdata: any): any;
...
export declare class TDocStd_XLinkRoot extends TDF_Attribute {
  static GetID(): Standard_GUID;
  static Set(aDF: any): any;
  static Insert(anXLinkPtr: TDocStd_XLinkPtr): void;
  static Remove(anXLinkPtr: TDocStd_XLinkPtr): void;
  ID(): Standard_GUID;
  BackupCopy(): any;
  Restore(anAttribute: any): void;
  NewEmpty(): any;
...
export declare class TFunction_IFunction {
  static NewFunction(L: TDF_Label, ID: Standard_GUID): Standard_Boolean;
  static DeleteFunction(L: TDF_Label): Standard_Boolean;
  static UpdateDependencies_1(Access: TDF_Label): Standard_Boolean;
  Init(L: TDF_Label): void;
  Label(): TDF_Label;
...
export declare class TFunction_Logbook extends TDF_Attribute {
  constructor()
  static Set(Access: TDF_Label): any;
  static GetID(): Standard_GUID;
  Clear(): void;
  IsEmpty(): Standard_Boolean;
...
export declare type module_TKLCAF_wasm = {
  ...
  TDF_DerivedAttribute: typeof TDF_DerivedAttribute;

declare const libName = "./module.TKGeomBase.wasm.d.ts";
...
export declare class AdvApp2Var_ApproxF2var {
  constructor();
  static mma2fnc_(ndimen: integer, nbsesp: integer, ndimse: integer, uvfonc: doublereal, foncnp: AdvApp2Var_EvaluatorFunc2Var, tconst: doublereal, isofav: integer, nbroot: integer, rootlg: doublereal, iordre: integer, ideriv: integer, ndgjac: integer, nbcrmx: integer, ncflim: integer, epsapr: doublereal, ncoeff: integer, courbe: doublereal, nbcrbe: integer, somtab: doublereal, diftab: doublereal, contr1: doublereal, contr2: doublereal, tabdec: doublereal, errmax: doublereal, errmoy: doublereal, iercod: integer): number;
  static mma2roo_(nbpntu: integer, nbpntv: integer, urootl: doublereal, vrootl: doublereal): number;
  static mma2jmx_(ndgjac: integer, iordre: integer, xjacmx: doublereal): number;
  static mmapptt_(a0: integer, a1: integer, a2: integer, a3: doublereal, a4: integer): number;
  static mma2cdi_(ndimen: integer, nbpntu: integer, urootl: doublereal, nbpntv: integer, vrootl: doublereal, iordru: integer, iordrv: integer, contr1: doublereal, contr2: doublereal, contr3: doublereal, contr4: doublereal, sotbu1: doublereal, sotbu2: doublereal, ditbu1: doublereal, ditbu2: doublereal, sotbv1: doublereal, sotbv2: doublereal, ditbv1: doublereal, ditbv2: doublereal, sosotb: doublereal, soditb: doublereal, disotb: doublereal, diditb: doublereal, iercod: integer): number;
  static mma2ds1_(ndimen: integer, uintfn: doublereal, vintfn: doublereal, foncnp: AdvApp2Var_EvaluatorFunc2Var, nbpntu: integer, nbpntv: integer, urootb: doublereal, vrootb: doublereal, isofav: integer, sosotb: doublereal, disotb: doublereal, soditb: doublereal, diditb: doublereal, fpntab: doublereal, ttable: doublereal, iercod: integer): number;
  static mma2ce1_(numdec: integer, ndimen: integer, nbsesp: integer, ndimse: integer, ndminu: integer, ndminv: integer, ndguli: integer, ndgvli: integer, ndjacu: integer, ndjacv: integer, iordru: integer, iordrv: integer, nbpntu: integer, nbpntv: integer, epsapr: doublereal, sosotb: doublereal, disotb: doublereal, soditb: doublereal, diditb: doublereal, patjac: doublereal, errmax: doublereal, errmoy: doublereal, ndegpu: integer, ndegpv: integer, itydec: integer, iercod: integer): number;
  static mma2can_(a0: integer, a1: integer, a2: integer, a3: integer, a4: integer, a5: integer, a6: integer, a7: doublereal, a8: doublereal, a9: doublereal, a10: integer): number;
  static mma1her_(a0: integer, a1: doublereal, a2: integer): number;
  static mma2ac2_(a0: integer, a1: integer, a2: integer, a3: integer, a4: integer, a5: integer, a6: doublereal, a7: integer, a8: doublereal, a9: doublereal, a10: doublereal): number;
  static mma2ac3_(a0: integer, a1: integer, a2: integer, a3: integer, a4: integer, a5: integer, a6: doublereal, a7: integer, a8: doublereal, a9: doublereal, a10: doublereal): number;
  static mma2ac1_(a0: integer, a1: integer, a2: integer, a3: integer, a4: integer, a5: doublereal, a6: doublereal, a7: doublereal, a8: doublereal, a9: doublereal, a10: doublereal, a11: doublereal): number;
  static mma2fx6_(ncfmxu: integer, ncfmxv: integer, ndimen: integer, nbsesp: integer, ndimse: integer, nbupat: integer, nbvpat: integer, iordru: integer, iordrv: integer, epsapr: doublereal, epsfro: doublereal, patcan: doublereal, errmax: doublereal, ncoefu: integer, ncoefv: integer): number;
  delete(): void;
}
...
export declare class mdnombr_1_ {
  constructor();
  delete(): void;
}

export declare class minombr_1_ {
  constructor();
  delete(): void;
}

export declare class maovpar_1_ {
  constructor();
  delete(): void;
}

export declare class maovpch_1_ {
  constructor();
  delete(): void;
}

export declare class mlgdrtl_1_ {
  constructor();
  delete(): void;
}

export declare class mmjcobi_1_ {
  constructor();
  delete(): void;
}

export declare class mmcmcnp_1_ {
  constructor();
  delete(): void;
}

export declare class mmapgss_1_ {
  constructor();
  delete(): void;
}

export declare class mmapgs0_1_ {
  constructor();
  delete(): void;
}

export declare class mmapgs1_1_ {
  constructor();
  delete(): void;
}

export declare class mmapgs2_1_ {
  constructor();
  delete(): void;
}
...
export declare class AdvApp2Var_Data {
  constructor();
  static Getmdnombr(): mdnombr_1_;
  static Getminombr(): minombr_1_;
  static Getmaovpar(): maovpar_1_;
  static Getmaovpch(): maovpch_1_;
  static Getmlgdrtl(): mlgdrtl_1_;
  static Getmmjcobi(): mmjcobi_1_;
  static Getmmcmcnp(): mmcmcnp_1_;
  static Getmmapgss(): mmapgss_1_;
  static Getmmapgs0(): mmapgs0_1_;
  static Getmmapgs1(): mmapgs1_1_;
  static Getmmapgs2(): mmapgs2_1_;
  delete(): void;
}

export declare class AdvApp2Var_MathBase {
  constructor();
  static mmapcmp_(a0: integer, a1: integer, a2: integer, a3: number, a4: number): number;
  static mmdrc11_(a0: integer, a1: integer, a2: integer, a3: doublereal, a4: doublereal, a5: doublereal): number;
  static mmfmca9_(a0: integer, a1: integer, a2: integer, a3: integer, a4: integer, a5: integer, a6: doublereal, a7: doublereal): number;
  static mmfmcb5_(a0: integer, a1: integer, a2: integer, a3: doublereal, a4: integer, a5: integer, a6: integer, a7: doublereal, a8: integer): number;
  static mmwprcs_(a0: doublereal, a1: doublereal, a2: doublereal, a3: doublereal, a4: integer, a5: integer): void;
  static mmcglc1_(ndimax: integer, ndimen: integer, ncoeff: integer, courbe: doublereal, tdebut: doublereal, tfinal: doublereal, epsiln: doublereal, xlongc: doublereal, erreur: doublereal, iercod: integer): number;
  static mmbulld_(nbcoln: integer, nblign: integer, dtabtr: doublereal, numcle: integer): number;
  static mmcdriv_(ndimen: integer, ncoeff: integer, courbe: doublereal, ideriv: integer, ncofdv: integer, crvdrv: doublereal): number;
  static mmcvctx_(ndimen: integer, ncofmx: integer, nderiv: integer, ctrtes: doublereal, crvres: doublereal, tabaux: doublereal, xmatri: doublereal, iercod: integer): number;
  static mdsptpt_(ndimen: integer, point1: doublereal, point2: doublereal, distan: doublereal): number;
  static mmaperx_(ncofmx: integer, ndimen: integer, ncoeff: integer, iordre: integer, crvjac: doublereal, ncfnew: integer, ycvmax: doublereal, errmax: doublereal, iercod: integer): number;
  static mmdrvck_(ncoeff: integer, ndimen: integer, courbe: doublereal, ideriv: integer, tparam: doublereal, pntcrb: doublereal): number;
  static mmeps1_(epsilo: doublereal): number;
  static mmfmca8_(ndimen: integer, ncoefu: integer, ncoefv: integer, ndimax: integer, ncfumx: integer, ncfvmx: integer, tabini: doublereal, tabres: doublereal): number;
  static mmfmcar_(ndimen: integer, ncofmx: integer, ncoefu: integer, ncoefv: integer, patold: doublereal, upara1: doublereal, upara2: doublereal, vpara1: doublereal, vpara2: doublereal, patnew: doublereal, iercod: integer): number;
  static mmfmtb1_(maxsz1: integer, table1: doublereal, isize1: integer, jsize1: integer, maxsz2: integer, table2: doublereal, isize2: integer, jsize2: integer, iercod: integer): number;
  static mmgaus1_(ndimf: integer, bfunx: any, k: integer, xd: doublereal, xf: doublereal, saux1: doublereal, saux2: doublereal, somme: doublereal, niter: integer, iercod: integer): number;
  static mmhjcan_(ndimen: integer, ncourb: integer, ncftab: integer, orcont: integer, ncflim: integer, tcbold: doublereal, tdecop: doublereal, tcbnew: doublereal, iercod: integer): number;
  static mminltt_(ncolmx: integer, nlgnmx: integer, tabtri: doublereal, nbrcol: integer, nbrlgn: integer, ajoute: doublereal, epseg: doublereal, iercod: integer): number;
  static mmjaccv_(ncoef: integer, ndim: integer, ider: integer, crvlgd: doublereal, polaux: doublereal, crvcan: doublereal): number;
  static mmpobas_(tparam: doublereal, iordre: integer, ncoeff: integer, nderiv: integer, valbas: doublereal, iercod: integer): number;
  static mmmpocur_(ncofmx: integer, ndim: integer, ndeg: integer, courbe: doublereal, tparam: doublereal, tabval: doublereal): number;
  static mmposui_(dimmat: integer, nistoc: integer, aposit: integer, posuiv: integer, iercod: integer): number;
  static mmresol_(hdimen: integer, gdimen: integer, hnstoc: integer, gnstoc: integer, mnstoc: integer, matsyh: doublereal, matsyg: doublereal, vecsyh: doublereal, vecsyg: doublereal, hposit: integer, hposui: integer, gposit: integer, mmposui: integer, mposit: integer, vecsol: doublereal, iercod: integer): number;
  static mmrtptt_(ndglgd: integer, rtlegd: doublereal): number;
  static mmsrre2_(tparam: doublereal, nbrval: integer, tablev: doublereal, epsil: doublereal, numint: integer, itypen: integer, iercod: integer): number;
  static mmtrpjj_(ncofmx: integer, ndimen: integer, ncoeff: integer, epsi3d: doublereal, iordre: integer, crvlgd: doublereal, ycvmax: doublereal, errmax: doublereal, ncfnew: integer): number;
  static mmunivt_(ndimen: integer, vector: doublereal, vecnrm: doublereal, epsiln: doublereal, iercod: integer): number;
  static mmvncol_(ndimen: integer, vecin: doublereal, vecout: doublereal, iercod: integer): number;
  static msc_(ndimen: integer, vecte1: doublereal, vecte2: doublereal): doublereal;
  static mvsheld_(n: integer, is: integer, dtab: doublereal, icle: integer): number;
  static mmarcin_(ndimax: integer, ndim: integer, ncoeff: integer, crvold: doublereal, u0: doublereal, u1: doublereal, crvnew: doublereal, iercod: integer): number;
  static mmcvinv_(ndimax: integer, ncoef: integer, ndim: integer, curveo: doublereal, curve: doublereal): number;
  static mmjacan_(ideriv: integer, ndeg: integer, poljac: doublereal, polcan: doublereal): number;
  static mmpocrb_(ndimax: integer, ncoeff: integer, courbe: doublereal, ndim: integer, tparam: doublereal, pntcrb: doublereal): number;
  static mmmrslwd_(normax: integer, nordre: integer, ndim: integer, amat: doublereal, bmat: doublereal, epspiv: doublereal, aaux: doublereal, xmat: doublereal, iercod: integer): number;
  static mmveps3_(eps03: doublereal): number;
  static pow__di(x: doublereal, n: integer): doublereal;
  static mzsnorm_(ndimen: integer, vecteu: doublereal): doublereal;
  delete(): void;
}
...
export declare class AdvApp2Var_SysBase {
  ...
  static maermsg_(cnompg: string, icoder: integer, cnompg_len: ftnlen): number;
  static maitbr8_(itaill: integer, xtab: doublereal, xval: doublereal): number;
  static maovsr8_(ivalcs: integer): number;
  static mgenmsg_(nomprg: string, nomprg_len: ftnlen): number;
  static mgsomsg_(nomprg: string, nomprg_len: ftnlen): number;
  static miraz_(taille: integer, adt: void): void;
  static msifill_(nbintg: integer, ivecin: integer, ivecou: integer): number;
  static msrfill_(nbreel: integer, vecent: doublereal, vecsor: doublereal): number;
  static mswrdbg_(ctexte: string, ctexte_len: ftnlen): number;
  static mvriraz_(taille: integer, adt: void): void;
  delete(): void;
}
...
export declare class PeriodicityInfo {
  constructor();
  delete(): void;
}
...
export declare class AppParCurves {
  constructor();
  static BernsteinMatrix(NbPoles: Standard_Integer, U: math_Vector, A: math_Matrix): void;
  static Bernstein(NbPoles: Standard_Integer, U: math_Vector, A: math_Matrix, DA: math_Matrix): void;
  static SecondDerivativeBernstein(U: Standard_Real, DDA: math_Vector): void;
  static SplineFunction(NbPoles: Standard_Integer, Degree: Standard_Integer, Parameters: math_Vector, FlatKnots: math_Vector, A: math_Matrix, DA: math_Matrix, Index: math_IntegerVector): void;
  delete(): void;
}
...
export declare class GeomLib {
  ...
  static FuseIntervals(Interval1: TColStd_Array1OfReal, Interval2: TColStd_Array1OfReal, Fusion: TColStd_SequenceOfReal, Confusion: Standard_Real): void;
  ...
  static NormEstim(S: any, UV: gp_Pnt2d, Tol: Standard_Real, N: gp_Dir): Standard_Integer;
...
export declare class GeomTools_SurfaceSet {
  ...
  static PrintSurface(S: any, OS: Standard_OStream, compact: Standard_Boolean): void;
  static ReadSurface(IS: Standard_IStream): any;
  delete(): void;
}
...
export declare class GeomTools_CurveSet {
  ...
  Write(OS: Standard_OStream, theProgress: Message_ProgressRange): void;
  Read(IS: Standard_IStream, theProgress: Message_ProgressRange): void;
  static PrintCurve(C: any, OS: Standard_OStream, compact: Standard_Boolean): void;
  static ReadCurve(IS: Standard_IStream): any;
  delete(): void;
}
...
export declare class GeomTools_Curve2dSet {
  ...
  Write(OS: Standard_OStream, theProgress: Message_ProgressRange): void;
  Read(IS: Standard_IStream, theProgress: Message_ProgressRange): void;
  static PrintCurve2d(C: any, OS: Standard_OStream, compact: Standard_Boolean): void;
  static ReadCurve2d(IS: Standard_IStream): any;
  delete(): void;
}

export declare class BndLib {
  constructor();
  static Add_1(L: gp_Lin, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_2(L: gp_Lin2d, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box2d): void;
  static Add_3(C: gp_Circ, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_4(C: gp_Circ, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_5(C: gp_Circ2d, Tol: Standard_Real, B: Bnd_Box2d): void;
  static Add_6(C: gp_Circ2d, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box2d): void;
  static Add_7(C: gp_Elips, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_8(C: gp_Elips, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_9(C: gp_Elips2d, Tol: Standard_Real, B: Bnd_Box2d): void;
  static Add_10(C: gp_Elips2d, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box2d): void;
  static Add_11(P: gp_Parab, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_12(P: gp_Parab2d, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box2d): void;
  static Add_13(H: gp_Hypr, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_14(H: gp_Hypr2d, P1: Standard_Real, P2: Standard_Real, Tol: Standard_Real, B: Bnd_Box2d): void;
  static Add_15(S: gp_Cylinder, UMin: Standard_Real, UMax: Standard_Real, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_16(S: gp_Cylinder, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_17(S: gp_Cone, UMin: Standard_Real, UMax: Standard_Real, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_18(S: gp_Cone, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_19(S: gp_Sphere, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_20(S: gp_Sphere, UMin: Standard_Real, UMax: Standard_Real, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_21(P: gp_Torus, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_22(P: gp_Torus, UMin: Standard_Real, UMax: Standard_Real, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  delete(): void;
}
...
export declare class BndLib_Add3dCurve {
  constructor();
  static Add_1(C: Adaptor3d_Curve, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_2(C: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static AddOptimal_1(C: Adaptor3d_Curve, Tol: Standard_Real, B: Bnd_Box): void;
  static AddOptimal_2(C: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static AddGenCurv(C: Adaptor3d_Curve, UMin: Standard_Real, UMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  delete(): void;
}

export declare class BndLib_AddSurface {
  constructor();
  static Add_1(S: Adaptor3d_Surface, Tol: Standard_Real, B: Bnd_Box): void;
  static Add_2(S: Adaptor3d_Surface, UMin: Standard_Real, UMax: Standard_Real, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static AddOptimal_1(S: Adaptor3d_Surface, Tol: Standard_Real, B: Bnd_Box): void;
  static AddOptimal_2(S: Adaptor3d_Surface, UMin: Standard_Real, UMax: Standard_Real, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  static AddGenSurf(S: Adaptor3d_Surface, UMin: Standard_Real, UMax: Standard_Real, VMin: Standard_Real, VMax: Standard_Real, Tol: Standard_Real, B: Bnd_Box): void;
  delete(): void;
}
...
export declare class CPnts_AbscissaPoint {
  static Length_1(C: Adaptor3d_Curve): Standard_Real;
  static Length_2(C: Adaptor2d_Curve2d): Standard_Real;
  static Length_3(C: Adaptor3d_Curve, Tol: Standard_Real): Standard_Real;
  static Length_4(C: Adaptor2d_Curve2d, Tol: Standard_Real): Standard_Real;
  static Length_5(C: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real): Standard_Real;
  static Length_6(C: Adaptor2d_Curve2d, U1: Standard_Real, U2: Standard_Real): Standard_Real;
  static Length_7(C: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, Tol: Standard_Real): Standard_Real;
  static Length_8(C: Adaptor2d_Curve2d, U1: Standard_Real, U2: Standard_Real, Tol: Standard_Real): Standard_Real;
...
export declare class Extrema_Curve2dTool {
  ...
  static NbIntervals(C: Adaptor2d_Curve2d, S: GeomAbs_Shape): Standard_Integer;
  static Intervals(C: Adaptor2d_Curve2d, T: TColStd_Array1OfReal, S: GeomAbs_Shape): void;
  static DeflCurvIntervals(C: Adaptor2d_Curve2d): any;
  static IsClosed(C: Adaptor2d_Curve2d): Standard_Boolean;
  static IsPeriodic(C: Adaptor2d_Curve2d): Standard_Boolean;
  static Period(C: Adaptor2d_Curve2d): Standard_Real;
  static Value(C: Adaptor2d_Curve2d, U: Standard_Real): gp_Pnt2d;
  static D0(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d): void;
  static D1(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d, V: gp_Vec2d): void;
  static D2(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d): void;
  static D3(C: Adaptor2d_Curve2d, U: Standard_Real, P: gp_Pnt2d, V1: gp_Vec2d, V2: gp_Vec2d, V3: gp_Vec2d): void;
  static DN(C: Adaptor2d_Curve2d, U: Standard_Real, N: Standard_Integer): gp_Vec2d;
  static Resolution(C: Adaptor2d_Curve2d, R3d: Standard_Real): Standard_Real;
  ...
  static IsRational(C: Adaptor2d_Curve2d): Standard_Boolean;
  static NbPoles(C: Adaptor2d_Curve2d): Standard_Integer;
  static NbKnots(C: Adaptor2d_Curve2d): Standard_Integer;
  static Bezier(C: Adaptor2d_Curve2d): any;
  static BSpline(C: Adaptor2d_Curve2d): any;
  delete(): void;
}

export declare class Extrema_CurveTool {
  constructor();
  static FirstParameter(C: Adaptor3d_Curve): Standard_Real;
  static LastParameter(C: Adaptor3d_Curve): Standard_Real;
  static Continuity(C: Adaptor3d_Curve): GeomAbs_Shape;
  static NbIntervals(C: Adaptor3d_Curve, S: GeomAbs_Shape): Standard_Integer;
  static Intervals(C: Adaptor3d_Curve, T: TColStd_Array1OfReal, S: GeomAbs_Shape): void;
  static DeflCurvIntervals(C: Adaptor3d_Curve): any;
  static IsPeriodic(C: Adaptor3d_Curve): Standard_Boolean;
  static Period(C: Adaptor3d_Curve): Standard_Real;
  static Resolution(C: Adaptor3d_Curve, R3d: Standard_Real): Standard_Real;
  static GetType(C: Adaptor3d_Curve): GeomAbs_CurveType;
  static Value(C: Adaptor3d_Curve, U: Standard_Real): gp_Pnt;
  static D0(C: Adaptor3d_Curve, U: Standard_Real, P: gp_Pnt): void;
  static D1(C: Adaptor3d_Curve, U: Standard_Real, P: gp_Pnt, V: gp_Vec): void;
  static D2(C: Adaptor3d_Curve, U: Standard_Real, P: gp_Pnt, V1: gp_Vec, V2: gp_Vec): void;
  static D3(C: Adaptor3d_Curve, U: Standard_Real, P: gp_Pnt, V1: gp_Vec, V2: gp_Vec, V3: gp_Vec): void;
  static DN(C: Adaptor3d_Curve, U: Standard_Real, N: Standard_Integer): gp_Vec;
  ...
  static Degree(C: Adaptor3d_Curve): Standard_Integer;
  static IsRational(C: Adaptor3d_Curve): Standard_Boolean;
  static NbPoles(C: Adaptor3d_Curve): Standard_Integer;
  static NbKnots(C: Adaptor3d_Curve): Standard_Integer;
  static Bezier(C: Adaptor3d_Curve): any;
  static BSpline(C: Adaptor3d_Curve): any;
  delete(): void;
}
...
export declare class Extrema_FuncExtCS extends math_FunctionSetWithDerivatives {
  ...
  SquareDistances(): TColStd_SequenceOfReal;
  PointsOnCurve(): Extrema_SequenceOfPOnCurv;
  PointsOnSurf(): Extrema_SequenceOfPOnSurf;
  delete(): void;
}
...
export declare class Geom2dConvert {
  ...
  static ConcatG1(ArrayOfCurves: TColGeom2d_Array1OfBSplineCurve, ArrayOfToler: TColStd_Array1OfReal, ArrayOfConcatenated: any, ClosedFlag: Standard_Boolean, ClosedTolerance: Standard_Real): void;
  static ConcatC1_1(ArrayOfCurves: TColGeom2d_Array1OfBSplineCurve, ArrayOfToler: TColStd_Array1OfReal, ArrayOfIndices: any, ArrayOfConcatenated: any, ClosedFlag: Standard_Boolean, ClosedTolerance: Standard_Real): void;
  static ConcatC1_2(ArrayOfCurves: TColGeom2d_Array1OfBSplineCurve, ArrayOfToler: TColStd_Array1OfReal, ArrayOfIndices: any, ArrayOfConcatenated: any, ClosedFlag: Standard_Boolean, ClosedTolerance: Standard_Real, AngularTolerance: Standard_Real): void;
...
export declare class GeomConvert {
  ...
  static ConcatG1(ArrayOfCurves: TColGeom_Array1OfBSplineCurve, ArrayOfToler: TColStd_Array1OfReal, ArrayOfConcatenated: any, ClosedFlag: Standard_Boolean, ClosedTolerance: Standard_Real): void;
  static ConcatC1_1(ArrayOfCurves: TColGeom_Array1OfBSplineCurve, ArrayOfToler: TColStd_Array1OfReal, ArrayOfIndices: any, ArrayOfConcatenated: any, ClosedFlag: Standard_Boolean, ClosedTolerance: Standard_Real): void;
  static ConcatC1_2(ArrayOfCurves: TColGeom_Array1OfBSplineCurve, ArrayOfToler: TColStd_Array1OfReal, ArrayOfIndices: any, ArrayOfConcatenated: any, ClosedFlag: Standard_Boolean, ClosedTolerance: Standard_Real, AngularTolerance: Standard_Real): void;
...
export declare class GeomLib_Tool {
  constructor();
  static Parameter_1(Curve: any, Point: gp_Pnt, MaxDist: Standard_Real, U: Standard_Real): Standard_Boolean;
  static Parameters(Surface: any, Point: gp_Pnt, MaxDist: Standard_Real, U: Standard_Real, V: Standard_Real): Standard_Boolean;
  static Parameter_2(Curve: any, Point: gp_Pnt2d, MaxDist: Standard_Real, U: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare class GeomTools {
  constructor();
  static Dump_1(S: any, OS: Standard_OStream): void;
  static Write_1(S: any, OS: Standard_OStream): void;
  static Read_1(S: any, IS: Standard_IStream): void;
  static Dump_2(C: any, OS: Standard_OStream): void;
  static Write_2(C: any, OS: Standard_OStream): void;
  static Read_2(C: any, IS: Standard_IStream): void;
  static Dump_3(C: any, OS: Standard_OStream): void;
  static Write_3(C: any, OS: Standard_OStream): void;
  static Read_3(C: any, IS: Standard_IStream): void;
...
export declare class Hermit {
  constructor();
  static Solution_1(BS: any, TolPoles: Standard_Real, TolKnots: Standard_Real): any;
  static Solution_2(BS: any, TolPoles: Standard_Real, TolKnots: Standard_Real): any;
  static Solutionbis(BS: any, Knotmin: Standard_Real, Knotmax: Standard_Real, TolPoles: Standard_Real, TolKnots: Standard_Real): void;
  delete(): void;
}
...
export declare class ProjLib {
  ...
  static MakePCurveOfType(PC: ProjLib_ProjectedCurve, aC: any): void;
  static IsAnaSurf(theAS: any): Standard_Boolean;
  delete(): void;
}
...
export declare class Extrema_HUBTreeOfSphere {
  ...
  static DownCast(theOther: any): Extrema_HUBTreeOfSphere;
  delete(): void;
}
...
export declare type module_TKGeomBase_wasm = {
  ...
  AdvApp2Var_Network: typeof AdvApp2Var_Network;
  ...
  AdvApp2Var_Framework: typeof AdvApp2Var_Framework;
  ...
  mdnombr_1_: typeof mdnombr_1_;
  minombr_1_: typeof minombr_1_;
  maovpar_1_: typeof maovpar_1_;
  maovpch_1_: typeof maovpch_1_;
  mlgdrtl_1_: typeof mlgdrtl_1_;
  mmjcobi_1_: typeof mmjcobi_1_;
  mmcmcnp_1_: typeof mmcmcnp_1_;
  mmapgss_1_: typeof mmapgss_1_;
  mmapgs0_1_: typeof mmapgs0_1_;
  mmapgs1_1_: typeof mmapgs1_1_;
  mmapgs2_1_: typeof mmapgs2_1_;
  ...
  NCollection_Handle: typeof NCollection_Handle;

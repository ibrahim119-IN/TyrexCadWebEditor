declare const libName = "./module.TKTopAlgo.wasm.d.ts";
...
export declare class BRepApprox_SurfaceTool {
  constructor();
  static FirstUParameter(S: BRepAdaptor_Surface): Standard_Real;
  static FirstVParameter(S: BRepAdaptor_Surface): Standard_Real;
  static LastUParameter(S: BRepAdaptor_Surface): Standard_Real;
  static LastVParameter(S: BRepAdaptor_Surface): Standard_Real;
  static NbUIntervals(S: BRepAdaptor_Surface, Sh: GeomAbs_Shape): Standard_Integer;
  static NbVIntervals(S: BRepAdaptor_Surface, Sh: GeomAbs_Shape): Standard_Integer;
  static UIntervals(S: BRepAdaptor_Surface, T: TColStd_Array1OfReal, Sh: GeomAbs_Shape): void;
  static VIntervals(S: BRepAdaptor_Surface, T: TColStd_Array1OfReal, Sh: GeomAbs_Shape): void;
  static UTrim(S: BRepAdaptor_Surface, First: Standard_Real, Last: Standard_Real, Tol: Standard_Real): any;
  static VTrim(S: BRepAdaptor_Surface, First: Standard_Real, Last: Standard_Real, Tol: Standard_Real): any;
  static IsUClosed(S: BRepAdaptor_Surface): Standard_Boolean;
  static IsVClosed(S: BRepAdaptor_Surface): Standard_Boolean;
  static IsUPeriodic(S: BRepAdaptor_Surface): Standard_Boolean;
  static UPeriod(S: BRepAdaptor_Surface): Standard_Real;
  static IsVPeriodic(S: BRepAdaptor_Surface): Standard_Boolean;
  static VPeriod(S: BRepAdaptor_Surface): Standard_Real;
  static Value(S: BRepAdaptor_Surface, u: Standard_Real, v: Standard_Real): gp_Pnt;
  static D0(S: BRepAdaptor_Surface, u: Standard_Real, v: Standard_Real, P: gp_Pnt): void;
  static D1(S: BRepAdaptor_Surface, u: Standard_Real, v: Standard_Real, P: gp_Pnt, D1u: gp_Vec, D1v: gp_Vec): void;
  static D2(S: BRepAdaptor_Surface, u: Standard_Real, v: Standard_Real, P: gp_Pnt, D1U: gp_Vec, D1V: gp_Vec, D2U: gp_Vec, D2V: gp_Vec, D2UV: gp_Vec): void;
  static D3(S: BRepAdaptor_Surface, u: Standard_Real, v: Standard_Real, P: gp_Pnt, D1U: gp_Vec, D1V: gp_Vec, D2U: gp_Vec, D2V: gp_Vec, D2UV: gp_Vec, D3U: gp_Vec, D3V: gp_Vec, D3UUV: gp_Vec, D3UVV: gp_Vec): void;
  static DN(S: BRepAdaptor_Surface, u: Standard_Real, v: Standard_Real, Nu: Standard_Integer, Nv: Standard_Integer): gp_Vec;
  static UResolution(S: BRepAdaptor_Surface, R3d: Standard_Real): Standard_Real;
  static VResolution(S: BRepAdaptor_Surface, R3d: Standard_Real): Standard_Real;
  ...
  static Bezier(S: BRepAdaptor_Surface): any;
  static BSpline(S: BRepAdaptor_Surface): any;
  static AxeOfRevolution(S: BRepAdaptor_Surface): gp_Ax1;
  static Direction(S: BRepAdaptor_Surface): gp_Dir;
  static BasisCurve(S: BRepAdaptor_Surface): any;
  static NbSamplesU_1(S: BRepAdaptor_Surface): Standard_Integer;
  static NbSamplesV_1(S: BRepAdaptor_Surface): Standard_Integer;
  static NbSamplesU_2(S: BRepAdaptor_Surface, u1: Standard_Real, u2: Standard_Real): Standard_Integer;
  static NbSamplesV_2(S: BRepAdaptor_Surface, v1: Standard_Real, v2: Standard_Real): Standard_Integer;
  delete(): void;
}
...
export declare class BRepApprox_TheMultiLineToolOfApprox {
  constructor();
  static FirstPoint(ML: BRepApprox_TheMultiLineOfApprox): Standard_Integer;
  static LastPoint(ML: BRepApprox_TheMultiLineOfApprox): Standard_Integer;
  static NbP2d(ML: BRepApprox_TheMultiLineOfApprox): Standard_Integer;
  static NbP3d(ML: BRepApprox_TheMultiLineOfApprox): Standard_Integer;
  static Value_1(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabPt: TColgp_Array1OfPnt): void;
  static Value_2(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabPt2d: TColgp_Array1OfPnt2d): void;
  static Value_3(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabPt: TColgp_Array1OfPnt, tabPt2d: TColgp_Array1OfPnt2d): void;
  static Tangency_1(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabV: TColgp_Array1OfVec): Standard_Boolean;
  static Tangency_2(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabV2d: TColgp_Array1OfVec2d): Standard_Boolean;
  static Tangency_3(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabV: TColgp_Array1OfVec, tabV2d: TColgp_Array1OfVec2d): Standard_Boolean;
  static Curvature_1(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabV: TColgp_Array1OfVec): Standard_Boolean;
  static Curvature_2(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabV2d: TColgp_Array1OfVec2d): Standard_Boolean;
  static Curvature_3(ML: BRepApprox_TheMultiLineOfApprox, MPointIndex: Standard_Integer, tabV: TColgp_Array1OfVec, tabV2d: TColgp_Array1OfVec2d): Standard_Boolean;
  static MakeMLBetween(ML: BRepApprox_TheMultiLineOfApprox, I1: Standard_Integer, I2: Standard_Integer, NbPMin: Standard_Integer): BRepApprox_TheMultiLineOfApprox;
  static MakeMLOneMorePoint(ML: BRepApprox_TheMultiLineOfApprox, I1: Standard_Integer, I2: Standard_Integer, indbad: Standard_Integer, OtherLine: BRepApprox_TheMultiLineOfApprox): Standard_Boolean;
  static WhatStatus(ML: BRepApprox_TheMultiLineOfApprox, I1: Standard_Integer, I2: Standard_Integer): Approx_Status;
...
export declare class BRepLib_MakeFace extends BRepLib_MakeShape {
  ...
  Face(): TopoDS_Face;
  static IsDegenerated(theCurve: any, theMaxTol: Standard_Real, theActTol: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare class BRepCheck {
  constructor();
  static Add(List: BRepCheck_ListOfStatus, Stat: BRepCheck_Status): void;
  static Print(Stat: BRepCheck_Status, OS: Standard_OStream): void;
  static SelfIntersection(W: TopoDS_Wire, F: TopoDS_Face, E1: TopoDS_Edge, E2: TopoDS_Edge): Standard_Boolean;
  static PrecCurve(aAC3D: Adaptor3d_Curve): Standard_Real;
  static PrecSurface(aAHSurf: any): Standard_Real;
  delete(): void;
}
...
export declare class BRepClass_Intersector extends Geom2dInt_IntConicCurveOfGInter {
  constructor()
...
export declare class BRepExtrema_ElementFilter {
  constructor();
  PreCheckElements(a0: Standard_Integer, a1: Standard_Integer): any;
  delete(): void;
}
...
export declare class MAT2d_MapBiIntHasher {
  constructor();
  static HashCode(theKey: MAT2d_BiInt, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(Key1: MAT2d_BiInt, Key2: MAT2d_BiInt): Standard_Boolean;
  delete(): void;
}
...
export declare class BRepGProp_EdgeTool {
  constructor();
  static FirstParameter(C: BRepAdaptor_Curve): Standard_Real;
  static LastParameter(C: BRepAdaptor_Curve): Standard_Real;
  static IntegrationOrder(C: BRepAdaptor_Curve): Standard_Integer;
  static Value(C: BRepAdaptor_Curve, U: Standard_Real): gp_Pnt;
  static D1(C: BRepAdaptor_Curve, U: Standard_Real, P: gp_Pnt, V1: gp_Vec): void;
  static NbIntervals(C: BRepAdaptor_Curve, S: GeomAbs_Shape): Standard_Integer;
  static Intervals(C: BRepAdaptor_Curve, T: TColStd_Array1OfReal, S: GeomAbs_Shape): void;
  delete(): void;
}
...
export declare class BRepGProp_MeshCinert extends GProp_GProps {
  ...
  static PreparePolygon(theE: TopoDS_Edge, thePolyg: any): void;
  delete(): void;
}
...
export declare class BRepGProp_MeshProps extends GProp_GProps {
  ...
  static CalculateProps(p1: gp_Pnt, p2: gp_Pnt, p3: gp_Pnt, Apex: gp_Pnt, isVolume: Standard_Boolean, GProps: Standard_Real [10], NbGaussPoints: Standard_Integer, GaussPnts: Standard_Real): void;
  GetMeshObjType(): any;
  delete(): void;
}
...
export declare class Bisector {
  constructor();
  static IsConvex(Cu: any, Sign: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare type module_TKTopAlgo_wasm = {

declare const libName = "./module.TKHLR.wasm.d.ts";
...
export declare class Contap_HContTool {
  ...
  static NbSamplePoints(S: any): Standard_Integer;
  static SamplePoint(S: any, Index: Standard_Integer, U: Standard_Real, V: Standard_Real): void;
...
export declare class Contap_SurfProps {
  constructor();
  static Normale(S: any, U: Standard_Real, V: Standard_Real, P: gp_Pnt, N: gp_Vec): void;
  static DerivAndNorm(S: any, U: Standard_Real, V: Standard_Real, P: gp_Pnt, d1u: gp_Vec, d1v: gp_Vec, N: gp_Vec): void;
  static NormAndDn(S: any, U: Standard_Real, V: Standard_Real, P: gp_Pnt, N: gp_Vec, Dnu: gp_Vec, Dnv: gp_Vec): void;
  delete(): void;
}
...
export declare class HLRAlgo {
  constructor();
  static UpdateMinMax(x: Standard_Real, y: Standard_Real, z: Standard_Real, Min: Standard_Real [16], Max: Standard_Real [16]): void;
  static EnlargeMinMax(tol: Standard_Real, Min: Standard_Real [16], Max: Standard_Real [16]): void;
  static InitMinMax(Big: Standard_Real, Min: Standard_Real [16], Max: Standard_Real [16]): void;
  static EncodeMinMax(Min: any, Max: any, MinMax: any): void;
  static SizeBox(Min: any, Max: any): Standard_Real;
  static DecodeMinMax(MinMax: any, Min: any, Max: any): void;
  static CopyMinMax(IMin: any, IMax: any, OMin: any, OMax: any): void;
  static AddMinMax(IMin: any, IMax: any, OMin: any, OMax: any): void;
  delete(): void;
}
...
export declare class HLRAlgo_PolyInternalSegment {
  constructor();
  delete(): void;
}

export declare class HLRAlgo_TriangleData {
  constructor();
  delete(): void;
}
...
export declare class HLRTopoBRep_DSFiller {
  constructor();
  static Insert(S: TopoDS_Shape, FO: Contap_Contour, DS: HLRTopoBRep_Data, MST: BRepTopAdaptor_MapOfShapeTool, nbIso: Standard_Integer): void;
  delete(): void;
}
...
export declare class HLRTopoBRep_FaceIsoLiner {
  constructor();
  static Perform(FI: Standard_Integer, F: TopoDS_Face, DS: HLRTopoBRep_Data, nbIsos: Standard_Integer): void;
  static MakeVertex(E: TopoDS_Edge, P: gp_Pnt, Par: Standard_Real, Tol: Standard_Real, DS: HLRTopoBRep_Data): TopoDS_Vertex;
  static MakeIsoLine(F: TopoDS_Face, Iso: any, V1: TopoDS_Vertex, V2: TopoDS_Vertex, U1: Standard_Real, U2: Standard_Real, Tol: Standard_Real, DS: HLRTopoBRep_Data): void;
  delete(): void;
}
...
export declare type module_TKHLR_wasm = {

declare const libName = "./module.TKXmlL.wasm.d.ts";
...
export declare class XmlLDrivers {
  constructor();
  static Factory(theGUID: Standard_GUID): any;
  static CreationDate(): TCollection_AsciiString;
  static DefineFormat(theApp: any): void;
  static AttributeDrivers(theMsgDriver: any): any;
  static StorageVersion(): number;
  delete(): void;
}
...
export declare class XmlMDF {
  constructor();
  static FromTo_1(aSource: any, aTarget: XmlObjMgt_Element, aReloc: XmlObjMgt_SRelocationTable, aDrivers: any, theRange: Message_ProgressRange): void;
  static FromTo_2(aSource: XmlObjMgt_Element, aTarget: any, aReloc: XmlObjMgt_RRelocationTable, aDrivers: any, theRange: Message_ProgressRange): Standard_Boolean;
  static AddDrivers(aDriverTable: any, theMessageDriver: any): void;
  delete(): void;
}
...
export declare class XmlMDataStd {
  constructor();
  static AddDrivers(aDriverTable: any, anMsgDrv: any): void;
  delete(): void;
}
...
export declare class XmlObjMgt {
  constructor();
  static IdString(): XmlObjMgt_DOMString;
  static SetExtendedString(theElement: XmlObjMgt_Element, theString: TCollection_ExtendedString): Standard_Boolean;
  static GetExtendedString(theElement: XmlObjMgt_Element, theString: TCollection_ExtendedString): Standard_Boolean;
  static GetStringValue(theElement: XmlObjMgt_Element): XmlObjMgt_DOMString;
  static SetStringValue(theElement: XmlObjMgt_Element, theData: XmlObjMgt_DOMString, isClearText: Standard_Boolean): void;
  static GetTagEntryString(theTarget: XmlObjMgt_DOMString, theTagEntry: TCollection_AsciiString): Standard_Boolean;
  static SetTagEntryString(theSource: XmlObjMgt_DOMString, theTagEntry: TCollection_AsciiString): void;
  static FindChildElement(theSource: XmlObjMgt_Element, theObjId: Standard_Integer): XmlObjMgt_Element;
  static FindChildByRef(theSource: XmlObjMgt_Element, theRefName: XmlObjMgt_DOMString): XmlObjMgt_Element;
  static FindChildByName(theSource: XmlObjMgt_Element, theName: XmlObjMgt_DOMString): XmlObjMgt_Element;
  delete(): void;
}
...
export declare class XmlObjMgt_GP {
  constructor();
  static Translate_1(aTrsf: gp_Trsf): XmlObjMgt_DOMString;
  static Translate_2(aMat: gp_Mat): XmlObjMgt_DOMString;
  static Translate_3(anXYZ: gp_XYZ): XmlObjMgt_DOMString;
  static Translate_4(aStr: XmlObjMgt_DOMString, T: gp_Trsf): Standard_Boolean;
  static Translate_5(aStr: XmlObjMgt_DOMString, T: gp_Mat): Standard_Boolean;
  static Translate_6(aStr: XmlObjMgt_DOMString, T: gp_XYZ): Standard_Boolean;
  delete(): void;
}
...
export declare type module_TKXmlL_wasm = {

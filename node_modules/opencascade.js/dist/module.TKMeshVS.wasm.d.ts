declare const libName = "./module.TKMeshVS.wasm.d.ts";
...
export declare class MeshVS_DataSource extends Standard_Transient {
  Get3DGeom(ID: Graphic3d_ArrayFlags, NbNodes: MeshVS_BuilderPriority, Data: Handle_MeshVS_HArray1OfSequenceOfInteger): Standard_Boolean;
...
export declare class MeshVS_DataSource3D extends MeshVS_DataSource {
  ...
  static CreatePrismTopology(BasePoints: Standard_Integer): any;
  static CreatePyramidTopology(BasePoints: Standard_Integer): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class MeshVS_TwoNodes {
  constructor(aFirst: Standard_Integer, aSecond: Standard_Integer)
  delete(): void;
}
...
export declare class MeshVS_MeshPrsBuilder extends MeshVS_PrsBuilder {
  ...
  static AddVolumePrs(Topo: any, Nodes: TColStd_Array1OfReal, NbNodes: Standard_Integer, Array: any, IsReflected: Standard_Boolean, IsShrinked: Standard_Boolean, IsSelect: Standard_Boolean, ShrinkCoef: Standard_Real): void;
  static HowManyPrimitives(Topo: any, AsPolygons: Standard_Boolean, IsSelect: Standard_Boolean, NbNodes: Standard_Integer, Vertices: Standard_Integer, Bounds: Standard_Integer): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class MeshVS_SymmetricPairHasher {
  constructor();
  static HashCode(theNodePair: MeshVS_NodePair, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(thePair1: MeshVS_NodePair, thePair2: MeshVS_NodePair): Standard_Boolean;
  delete(): void;
}
...
export declare class MeshVS_Tool {
  constructor();
  static CreateAspectFillArea3d_1(theDr: any, UseDefaults: Standard_Boolean): any;
  static CreateAspectFillArea3d_2(theDr: any, Mat: Graphic3d_MaterialAspect, UseDefaults: Standard_Boolean): any;
  static CreateAspectLine3d(theDr: any, UseDefaults: Standard_Boolean): any;
  static CreateAspectMarker3d(theDr: any, UseDefaults: Standard_Boolean): any;
  static CreateAspectText3d(theDr: any, UseDefaults: Standard_Boolean): any;
  static GetNormal(Nodes: TColStd_Array1OfReal, Norm: gp_Vec): Standard_Boolean;
  static GetAverageNormal(Nodes: TColStd_Array1OfReal, Norm: gp_Vec): Standard_Boolean;
  delete(): void;
}
...
export declare class MeshVS_VectorPrsBuilder extends MeshVS_PrsBuilder {
  ...
  static calculateArrow(Points: TColgp_Array1OfPnt, Length: Standard_Real, ArrowPart: Standard_Real): Standard_Real;
...
export declare class MeshVS_TwoColorsHasher {
  constructor();
  static HashCode(theKey: MeshVS_TwoColors, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(theKey1: MeshVS_TwoColors, theKey2: MeshVS_TwoColors): Standard_Boolean;
  delete(): void;
}
...
export declare class MeshVS_TwoNodesHasher {
  constructor();
  static HashCode(theKey: MeshVS_TwoNodes, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(theKey1: MeshVS_TwoNodes, theKey2: MeshVS_TwoNodes): Standard_Boolean;
  delete(): void;
}
...
export declare type module_TKMeshVS_wasm = {
  ...
  MeshVS_TwoNodes: typeof MeshVS_TwoNodes;
  ...
  MeshVS_SymmetricPairHasher: typeof MeshVS_SymmetricPairHasher;

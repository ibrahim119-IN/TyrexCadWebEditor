declare const libName = "./module.TKXCAF.wasm.d.ts";
...
export declare class XCAFDoc_VisMaterialCommon {
  constructor()
  IsEqual(theOther: XCAFDoc_VisMaterialCommon): Standard_Boolean;
...
export declare class XCAFPrs_Style {
  ...
  static HashCode(theStyle: XCAFPrs_Style, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual_2(theS1: XCAFPrs_Style, theS2: XCAFPrs_Style): Standard_Boolean;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  delete(): void;
}

export declare class XCAFPrs_DocumentNode {
  constructor()
  static HashCode(theNode: XCAFPrs_DocumentNode, theN: Standard_Integer): Standard_Integer;
  static IsEqual(theNode1: XCAFPrs_DocumentNode, theNode2: XCAFPrs_DocumentNode): Standard_Boolean;
  delete(): void;
}
...
export declare class XCAFPrs_DocumentExplorer {
  ...
  static FindLabelFromPathId_1(theDocument: any, theId: TCollection_AsciiString, theParentLocation: TopLoc_Location, theLocation: TopLoc_Location): TDF_Label;
  static FindLabelFromPathId_2(theDocument: any, theId: TCollection_AsciiString, theLocation: TopLoc_Location): TDF_Label;
  static FindShapeFromPathId(theDocument: any, theId: TCollection_AsciiString): TopoDS_Shape;
...
export declare class XCAFDoc {
  ...
  static ColorRefGUID(type: XCAFDoc_ColorType): Standard_GUID;
...
export declare class XCAFDoc_Area extends TDataStd_Real {
  ...
  static Set_2(label: TDF_Label, area: Standard_Real): any;
  Get_1(): Standard_Real;
  static Get_2(label: TDF_Label, area: Standard_Real): Standard_Boolean;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class XCAFDoc_AssemblyItemRef extends TDF_Attribute {
  ...
  DynamicType(): any;
  static GetID(): Standard_GUID;
  static Get(theLabel: TDF_Label): any;
  static Set_1(theLabel: TDF_Label, theItemId: XCAFDoc_AssemblyItemId): any;
  static Set_2(theLabel: TDF_Label, theItemId: XCAFDoc_AssemblyItemId, theGUID: Standard_GUID): any;
  static Set_3(theLabel: TDF_Label, theItemId: XCAFDoc_AssemblyItemId, theShapeIndex: Standard_Integer): any;
...
export declare class XCAFDoc_Centroid extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, pnt: gp_Pnt): any;
  Set_2(pnt: gp_Pnt): void;
  Get_1(): gp_Pnt;
  static Get_2(label: TDF_Label, pnt: gp_Pnt): Standard_Boolean;
  ID(): Standard_GUID;
...
export declare class XCAFDoc_ClippingPlaneTool extends TDataStd_GenericEmpty {
  constructor()
  static Set(theLabel: TDF_Label): any;
  static GetID(): Standard_GUID;
  BaseLabel(): TDF_Label;
...
export declare class XCAFDoc_Color extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, C: Quantity_Color): any;
  static Set_2(label: TDF_Label, C: Quantity_ColorRGBA): any;
  static Set_3(label: TDF_Label, C: Quantity_NameOfColor): any;
  static Set_4(label: TDF_Label, R: Standard_Real, G: Standard_Real, B: Standard_Real, alpha: Standard_Real): any;
...
export declare class XCAFDoc_Datum extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, aName: any, aDescription: any, anIdentification: any): any;
  static Set_2(theLabel: TDF_Label): any;
...
export declare class XCAFDoc_DimTol extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, kind: Standard_Integer, aVal: any, aName: any, aDescription: any): any;
...
export declare class XCAFDoc_Editor {
  constructor();
  static Expand_1(Doc: TDF_Label, Shape: TDF_Label, recursively: Standard_Boolean): Standard_Boolean;
  static Expand_2(Doc: TDF_Label, recursively: Standard_Boolean): Standard_Boolean;
  delete(): void;
}

export declare class XCAFDoc_GraphNode extends TDF_Attribute {
  constructor()
  static Find(L: TDF_Label, G: any): Standard_Boolean;
  static Set_1(L: TDF_Label): any;
  static Set_2(L: TDF_Label, ExplicitGraphID: Standard_GUID): any;
...
export declare class XCAFDoc_Location extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, Loc: TopLoc_Location): any;
...
export declare class XCAFDoc_Material extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label, aName: any, aDescription: any, aDensity: Standard_Real, aDensName: any, aDensValType: any): any;
...
export declare class XCAFDoc_Note extends TDF_Attribute {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static IsMine(theLabel: TDF_Label): Standard_Boolean;
  static Get(theLabel: TDF_Label): any;
...
export declare class XCAFDoc_NoteComment extends XCAFDoc_Note {
  ...
  static GetID(): Standard_GUID;
  static Get(theLabel: TDF_Label): any;
  static Set_1(theLabel: TDF_Label, theUserName: TCollection_ExtendedString, theTimeStamp: TCollection_ExtendedString, theComment: TCollection_ExtendedString): any;
...
export declare class XCAFDoc_NoteBalloon extends XCAFDoc_NoteComment {
  ...
  static GetID(): Standard_GUID;
  static Get(theLabel: TDF_Label): any;
  static Set(theLabel: TDF_Label, theUserName: TCollection_ExtendedString, theTimeStamp: TCollection_ExtendedString, theComment: TCollection_ExtendedString): any;
  ID(): Standard_GUID;
  delete(): void;
}
...
export declare class XCAFDoc_NoteBinData extends XCAFDoc_Note {
  ...
  static GetID(): Standard_GUID;
  static Get(theLabel: TDF_Label): any;
  static Set_1(theLabel: TDF_Label, theUserName: TCollection_ExtendedString, theTimeStamp: TCollection_ExtendedString, theTitle: TCollection_ExtendedString, theMIMEtype: TCollection_AsciiString, theFile: OSD_File): any;
  static Set_2(theLabel: TDF_Label, theUserName: TCollection_ExtendedString, theTimeStamp: TCollection_ExtendedString, theTitle: TCollection_ExtendedString, theMIMEtype: TCollection_AsciiString, theData: any): any;
...
export declare class XCAFDoc_ShapeTool extends TDataStd_GenericEmpty {
  ...
  static GetUsers(L: TDF_Label, Labels: TDF_LabelSequence, getsubchilds: Standard_Boolean): Standard_Integer;
  ...
  BaseLabel(): TDF_Label;
  static DumpShape(theDumpLog: Standard_OStream, L: TDF_Label, level: Standard_Integer, deep: Standard_Boolean): void;
  ID(): Standard_GUID;
  ...
  static FindSHUO(Labels: TDF_LabelSequence, theSHUOAttr: any): Standard_Boolean;
...
export declare class XCAFDoc_Volume extends TDataStd_Real {
  ...
  ID(): Standard_GUID;
  Set_1(vol: Standard_Real): void;
  static Set_2(label: TDF_Label, vol: Standard_Real): any;
  Get_1(): Standard_Real;
  static Get_2(label: TDF_Label, vol: Standard_Real): Standard_Boolean;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class XCAFPrs {
  constructor();
  static CollectStyleSettings(L: TDF_Label, loc: TopLoc_Location, settings: XCAFPrs_IndexedDataMapOfShapeStyle, theLayerColor: Quantity_ColorRGBA): void;
  static SetViewNameMode(viewNameMode: Standard_Boolean): void;
  static GetViewNameMode(): Standard_Boolean;
  delete(): void;
}
...
export declare class XCAFPrs_Driver extends TPrsStd_Driver {
  constructor();
...
export declare type module_TKXCAF_wasm = {

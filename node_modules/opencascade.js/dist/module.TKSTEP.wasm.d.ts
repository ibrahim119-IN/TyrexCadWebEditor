declare const libName = "./module.TKSTEP.wasm.d.ts";
...
export declare class STEPConstruct {
  constructor();
  static FindEntity_1(FinderProcess: any, Shape: TopoDS_Shape): any;
  static FindEntity_2(FinderProcess: any, Shape: TopoDS_Shape, Loc: TopLoc_Location): any;
  static FindShape(TransientProcess: any, item: any): TopoDS_Shape;
  static FindCDSR(ComponentBinder: any, AssemblySDR: any, ComponentCDSR: any): Standard_Boolean;
  delete(): void;
}
...
export declare class STEPConstruct_Assembly {
  ...
  ItemLocation(): any;
  GetNAUO(): any;
  static CheckSRRReversesNAUO(theGraph: Interface_Graph, CDSR: any): Standard_Boolean;
  delete(): void;
}

export declare class STEPConstruct_PointHasher {
  constructor();
  static HashCode(thePoint: gp_Pnt, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(Point1: gp_Pnt, Point2: gp_Pnt): Standard_Boolean;
  delete(): void;
}
...
export declare class STEPConstruct_Styles extends STEPConstruct_Tool {
  ...
  static EncodeColor_1(Col: Quantity_Color): any;
  static EncodeColor_2(Col: Quantity_Color, DPDCs: STEPConstruct_DataMapOfAsciiStringTransient, ColRGBs: STEPConstruct_DataMapOfPointTransient): any;
  static DecodeColor(Colour: any, Col: Quantity_Color): Standard_Boolean;
  delete(): void;
}
...
export declare class STEPConstruct_UnitContext {
  ...
  static ConvertSiPrefix(aPrefix: StepBasic_SiPrefix): Standard_Real;
  delete(): void;
}
...
export declare class STEPEdit {
  ...
  static NewModel(): any;
  static SignType(): any;
  static NewSelectSDR(): any;
  static NewSelectPlacedItem(): any;
  static NewSelectShapeRepr(): any;
  delete(): void;
}
...
export declare class StepToGeom {
  constructor();
  static MakeAxis1Placement(SA: any): any;
  static MakeAxis2Placement(SA: any): any;
  static MakeAxisPlacement(SA: any): any;
  static MakeBoundedCurve(SC: any): any;
  static MakeBoundedCurve2d(SC: any): any;
  static MakeBoundedSurface(SS: any): any;
  static MakeBSplineCurve(SC: any): any;
  static MakeBSplineCurve2d(SC: any): any;
  static MakeBSplineSurface(SS: any): any;
  static MakeCartesianPoint(SP: any): any;
  static MakeCartesianPoint2d(SP: any): any;
  static MakeCircle(SC: any): any;
  static MakeCircle2d(SC: any): any;
  static MakeConic(SC: any): any;
  static MakeConic2d(SC: any): any;
  static MakeConicalSurface(SS: any): any;
  static MakeCurve(SC: any): any;
  static MakeCurve2d(SC: any): any;
  static MakeCylindricalSurface(SS: any): any;
  static MakeDirection(SD: any): any;
  static MakeDirection2d(SD: any): any;
  static MakeElementarySurface(SS: any): any;
  static MakeEllipse(SC: any): any;
  static MakeEllipse2d(SC: any): any;
  static MakeHyperbola(SC: any): any;
  static MakeHyperbola2d(SC: any): any;
  static MakeLine(SC: any): any;
  static MakeLine2d(SC: any): any;
  static MakeParabola(SC: any): any;
  static MakeParabola2d(SC: any): any;
  static MakePlane(SP: any): any;
  static MakePolyline(SPL: any): any;
  static MakePolyline2d(SPL: any): any;
  static MakeRectangularTrimmedSurface(SS: any): any;
  static MakeSphericalSurface(SS: any): any;
  static MakeSurface(SS: any): any;
  static MakeSurfaceOfLinearExtrusion(SS: any): any;
  static MakeSurfaceOfRevolution(SS: any): any;
  static MakeSweptSurface(SS: any): any;
  static MakeToroidalSurface(SS: any): any;
  static MakeTransformation2d(SCTO: any, CT: gp_Trsf2d): Standard_Boolean;
  static MakeTransformation3d(SCTO: any, CT: gp_Trsf): Standard_Boolean;
  static MakeTrimmedCurve(SC: any): any;
  static MakeTrimmedCurve2d(SC: any): any;
  static MakeVectorWithMagnitude(SV: any): any;
  static MakeVectorWithMagnitude2d(SV: any): any;
  delete(): void;
}

export declare class StepToTopoDS {
  constructor();
  static DecodeBuilderError(Error: StepToTopoDS_BuilderError): any;
  static DecodeShellError(Error: StepToTopoDS_TranslateShellError): any;
  static DecodeFaceError(Error: StepToTopoDS_TranslateFaceError): any;
  static DecodeEdgeError(Error: StepToTopoDS_TranslateEdgeError): any;
  static DecodeVertexError(Error: StepToTopoDS_TranslateVertexError): any;
  static DecodeVertexLoopError(Error: StepToTopoDS_TranslateVertexLoopError): any;
  static DecodePolyLoopError(Error: StepToTopoDS_TranslatePolyLoopError): any;
  static DecodeGeometricToolError(Error: StepToTopoDS_GeometricToolError): Standard_CString;
  delete(): void;
}
...
export declare class StepToTopoDS_CartesianPointHasher {
  constructor();
  static HashCode(theCartesianPoint: any, theUpperBound: Standard_Integer): Standard_Integer;
...
export declare class StepToTopoDS_PointPairHasher {
  constructor();
  static HashCode(thePointPair: StepToTopoDS_PointPair, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(K1: StepToTopoDS_PointPair, K2: StepToTopoDS_PointPair): Standard_Boolean;
  delete(): void;
}

export declare class StepToTopoDS_GeometricTool {
  constructor();
  static PCurve(SC: any, S: any, PC: any, last: Standard_Integer): Standard_Integer;
  static IsSeamCurve(SC: any, S: any, E: any, EL: any): Standard_Boolean;
  static IsLikeSeam(SC: any, S: any, E: any, EL: any): Standard_Boolean;
  static UpdateParam3d(C: any, w1: Standard_Real, w2: Standard_Real, preci: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare class TopoDSToStep {
  constructor();
  static DecodeBuilderError(E: TopoDSToStep_BuilderError): any;
  static DecodeFaceError(E: TopoDSToStep_MakeFaceError): any;
  static DecodeWireError(E: TopoDSToStep_MakeWireError): any;
  static DecodeEdgeError(E: TopoDSToStep_MakeEdgeError): any;
  static DecodeVertexError(E: TopoDSToStep_MakeVertexError): any;
  static AddResult_1(FP: any, Shape: TopoDS_Shape, entity: any): void;
  static AddResult_2(FP: any, Tool: TopoDSToStep_Tool): void;
  delete(): void;
}
...
export declare type module_TKSTEP_wasm = {

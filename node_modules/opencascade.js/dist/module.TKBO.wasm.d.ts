declare const libName = "./module.TKBO.wasm.d.ts";
...
export declare class BOPDS_PairMapHasher {
  constructor();
  static HashCode(thePair: BOPDS_Pair, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(thePair1: BOPDS_Pair, thePair2: BOPDS_Pair): Standard_Boolean;
  delete(): void;
}
...
export declare class BOPAlgo_MakePeriodic extends BOPAlgo_Options {
  ...
  History(): any;
  Clear(): void;
  static ToDirectionID(theDirectionID: Standard_Integer): Standard_Integer;
  delete(): void;
}
...
export declare class BOPAlgo_Tools {
  constructor();
  static FillMap_2(thePB1: any, theF: Standard_Integer, theMILI: BOPDS_IndexedDataMapOfPaveBlockListOfInteger, theAllocator: any): void;
  static ComputeToleranceOfCB(theCB: any, theDS: BOPDS_PDS, theContext: any): Standard_Real;
  static EdgesToWires(theEdges: TopoDS_Shape, theWires: TopoDS_Shape, theShared: Standard_Boolean, theAngTol: Standard_Real): Standard_Integer;
  ...
  static ClassifyFaces(theFaces: TopTools_ListOfShape, theSolids: TopTools_ListOfShape, theRunParallel: Standard_Boolean, theContext: any, theInParts: TopTools_IndexedDataMapOfShapeListOfShape, theShapeBoxMap: TopTools_DataMapOfShapeBox, theSolidsIF: TopTools_DataMapOfShapeListOfShape): void;
  static FillInternals(theSolids: TopTools_ListOfShape, theParts: TopTools_ListOfShape, theImages: TopTools_DataMapOfShapeListOfShape, theContext: any): void;
...
export declare class BOPAlgo_WireSplitter extends BOPAlgo_Algo {
  ...
  static SplitBlock(theF: TopoDS_Face, theCB: BOPTools_ConnexityBlock, theContext: any): void;
  delete(): void;
}
...
export declare class BOPAlgo_EdgeInfo {
  constructor()
  SetEdge(theE: TopoDS_Edge): void;
  Edge(): TopoDS_Edge;
  SetPassed(theFlag: Standard_Boolean): void;
  Passed(): Standard_Boolean;
  SetInFlag(theFlag: Standard_Boolean): void;
  IsIn(): Standard_Boolean;
  SetAngle(theAngle: Standard_Real): void;
  Angle(): Standard_Real;
  IsInside(): Standard_Boolean;
  SetIsInside(theIsInside: Standard_Boolean): void;
  delete(): void;
}
...
export declare class BOPDS_Tools {
  constructor();
  static TypeToInteger_1(theT1: TopAbs_ShapeEnum, theT2: TopAbs_ShapeEnum): Standard_Integer;
  static TypeToInteger_2(theT: TopAbs_ShapeEnum): Standard_Integer;
  static HasBRep(theT: TopAbs_ShapeEnum): Standard_Boolean;
...
export declare class BOPDS_DS {
  ...
  static NbInterfTypes(): Standard_Integer;
...
export declare class BOPDS_PaveMapHasher {
  constructor();
  static HashCode(thePave: BOPDS_Pave, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(aPave1: BOPDS_Pave, aPave2: BOPDS_Pave): Standard_Boolean;
  delete(): void;
}
...
export declare class BOPTools_AlgoTools {
  constructor();
  static DTolerance(): Standard_Real;
  static ComputeVV_1(theV: TopoDS_Vertex, theP: gp_Pnt, theTolP: Standard_Real): Standard_Integer;
  static ComputeVV_2(theV1: TopoDS_Vertex, theV2: TopoDS_Vertex, theFuzz: Standard_Real): Standard_Integer;
  static MakeVertex(theLV: TopTools_ListOfShape, theV: TopoDS_Vertex): void;
  static MakeNewVertex_1(aP1: gp_Pnt, aTol: Standard_Real, aNewVertex: TopoDS_Vertex): void;
  static MakeNewVertex_2(aV1: TopoDS_Vertex, aV2: TopoDS_Vertex, aNewVertex: TopoDS_Vertex): void;
  static MakeNewVertex_3(aE1: TopoDS_Edge, aP1: Standard_Real, aE2: TopoDS_Edge, aP2: Standard_Real, aNewVertex: TopoDS_Vertex): void;
  static MakeNewVertex_4(aE1: TopoDS_Edge, aP1: Standard_Real, aF2: TopoDS_Face, aNewVertex: TopoDS_Vertex): void;
  static UpdateVertex_1(aIC: IntTools_Curve, aT: Standard_Real, aV: TopoDS_Vertex): void;
  static UpdateVertex_2(aE: TopoDS_Edge, aT: Standard_Real, aV: TopoDS_Vertex): void;
  static UpdateVertex_3(aVF: TopoDS_Vertex, aVN: TopoDS_Vertex): void;
  static MakeEdge(theCurve: IntTools_Curve, theV1: TopoDS_Vertex, theT1: Standard_Real, theV2: TopoDS_Vertex, theT2: Standard_Real, theTolR3D: Standard_Real, theE: TopoDS_Edge): void;
  static CopyEdge(theEdge: TopoDS_Edge): TopoDS_Edge;
  static MakeSplitEdge(aE1: TopoDS_Edge, aV1: TopoDS_Vertex, aP1: Standard_Real, aV2: TopoDS_Vertex, aP2: Standard_Real, aNewEdge: TopoDS_Edge): void;
  static MakeSectEdge(aIC: IntTools_Curve, aV1: TopoDS_Vertex, aP1: Standard_Real, aV2: TopoDS_Vertex, aP2: Standard_Real, aNewEdge: TopoDS_Edge): void;
  static ComputeState_1(thePoint: gp_Pnt, theSolid: TopoDS_Solid, theTol: Standard_Real, theContext: any): TopAbs_State;
  static ComputeState_2(theVertex: TopoDS_Vertex, theSolid: TopoDS_Solid, theTol: Standard_Real, theContext: any): TopAbs_State;
  static ComputeState_3(theEdge: TopoDS_Edge, theSolid: TopoDS_Solid, theTol: Standard_Real, theContext: any): TopAbs_State;
  static ComputeState_4(theFace: TopoDS_Face, theSolid: TopoDS_Solid, theTol: Standard_Real, theBounds: TopTools_IndexedMapOfShape, theContext: any): TopAbs_State;
  static ComputeStateByOnePoint(theShape: TopoDS_Shape, theSolid: TopoDS_Solid, theTol: Standard_Real, theContext: any): TopAbs_State;
  static GetFaceOff(theEdge: TopoDS_Edge, theFace: TopoDS_Face, theLCEF: BOPTools_ListOfCoupleOfShape, theFaceOff: TopoDS_Face, theContext: any): Standard_Boolean;
  static IsInternalFace_1(theFace: TopoDS_Face, theEdge: TopoDS_Edge, theFace1: TopoDS_Face, theFace2: TopoDS_Face, theContext: any): Standard_Integer;
  static IsInternalFace_2(theFace: TopoDS_Face, theEdge: TopoDS_Edge, theLF: TopTools_ListOfShape, theContext: any): Standard_Integer;
  static IsInternalFace_3(theFace: TopoDS_Face, theSolid: TopoDS_Solid, theMEF: TopTools_IndexedDataMapOfShapeListOfShape, theTol: Standard_Real, theContext: any): Standard_Boolean;
  static MakePCurve(theE: TopoDS_Edge, theF1: TopoDS_Face, theF2: TopoDS_Face, theCurve: IntTools_Curve, thePC1: Standard_Boolean, thePC2: Standard_Boolean, theContext: any): void;
  static IsHole(theW: TopoDS_Shape, theF: TopoDS_Shape): Standard_Boolean;
  static IsSplitToReverse_1(theSplit: TopoDS_Shape, theShape: TopoDS_Shape, theContext: any, theError: Standard_Integer): Standard_Boolean;
  static IsSplitToReverseWithWarn(theSplit: TopoDS_Shape, theShape: TopoDS_Shape, theContext: any, theReport: any): Standard_Boolean;
  static IsSplitToReverse_2(theSplit: TopoDS_Face, theShape: TopoDS_Face, theContext: any, theError: Standard_Integer): Standard_Boolean;
  static IsSplitToReverse_3(theSplit: TopoDS_Edge, theShape: TopoDS_Edge, theContext: any, theError: Standard_Integer): Standard_Boolean;
  static Sense(theF1: TopoDS_Face, theF2: TopoDS_Face, theContext: any): Standard_Integer;
  static MakeConnexityBlock(theLS: TopTools_ListOfShape, theMapAvoid: TopTools_IndexedMapOfShape, theLSCB: TopTools_ListOfShape, theAllocator: any): void;
  static MakeConnexityBlocks_1(theS: TopoDS_Shape, theConnectionType: TopAbs_ShapeEnum, theElementType: TopAbs_ShapeEnum, theLCB: TopTools_ListOfShape): void;
  static MakeConnexityBlocks_2(theS: TopoDS_Shape, theConnectionType: TopAbs_ShapeEnum, theElementType: TopAbs_ShapeEnum, theLCB: TopTools_ListOfListOfShape, theConnectionMap: TopTools_IndexedDataMapOfShapeListOfShape): void;
  static MakeConnexityBlocks_3(theLS: TopTools_ListOfShape, theConnectionType: TopAbs_ShapeEnum, theElementType: TopAbs_ShapeEnum, theLCB: BOPTools_ListOfConnexityBlock): void;
  static OrientEdgesOnWire(theWire: TopoDS_Shape): void;
  static OrientFacesOnShell(theShell: TopoDS_Shape): void;
  static CorrectTolerances(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theTolMax: Standard_Real, theRunParallel: Standard_Boolean): void;
  static CorrectCurveOnSurface(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theTolMax: Standard_Real, theRunParallel: Standard_Boolean): void;
  static CorrectPointOnCurve(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theTolMax: Standard_Real, theRunParallel: Standard_Boolean): void;
  static CorrectShapeTolerances(theS: TopoDS_Shape, theMapToAvoid: TopTools_IndexedMapOfShape, theRunParallel: Standard_Boolean): void;
  static AreFacesSameDomain(theF1: TopoDS_Face, theF2: TopoDS_Face, theContext: any, theFuzz: Standard_Real): Standard_Boolean;
  static GetEdgeOff(theEdge: TopoDS_Edge, theFace: TopoDS_Face, theEdgeOff: TopoDS_Edge): Standard_Boolean;
  static GetEdgeOnFace(theEdge: TopoDS_Edge, theFace: TopoDS_Face, theEdgeOnF: TopoDS_Edge): Standard_Boolean;
  static CorrectRange_1(aE1: TopoDS_Edge, aE2: TopoDS_Edge, aSR: IntTools_Range, aNewSR: IntTools_Range): void;
  static CorrectRange_2(aE: TopoDS_Edge, aF: TopoDS_Face, aSR: IntTools_Range, aNewSR: IntTools_Range): void;
  static IsMicroEdge(theEdge: TopoDS_Edge, theContext: any, theCheckSplittable: Standard_Boolean): Standard_Boolean;
  static IsInvertedSolid(theSolid: TopoDS_Solid): Standard_Boolean;
  static ComputeTolerance(theFace: TopoDS_Face, theEdge: TopoDS_Edge, theMaxDist: Standard_Real, theMaxPar: Standard_Real): Standard_Boolean;
  static MakeContainer(theType: TopAbs_ShapeEnum, theShape: TopoDS_Shape): void;
  static PointOnEdge(aEdge: TopoDS_Edge, aPrm: Standard_Real, aP: gp_Pnt): void;
  static IsBlockInOnFace(aShR: IntTools_Range, aF: TopoDS_Face, aE: TopoDS_Edge, aContext: any): Standard_Boolean;
  static Dimensions(theS: TopoDS_Shape, theDMin: Standard_Integer, theDMax: Standard_Integer): void;
  static Dimension(theS: TopoDS_Shape): Standard_Integer;
  static TreatCompound(theS: TopoDS_Shape, theList: TopTools_ListOfShape, theMap: TopTools_MapOfShape): void;
  static IsOpenShell(theShell: TopoDS_Shell): Standard_Boolean;
  delete(): void;
}

export declare class BOPTools_AlgoTools2D {
  constructor();
  static BuildPCurveForEdgeOnFace(aE: TopoDS_Edge, aF: TopoDS_Face, theContext: any): void;
  static EdgeTangent(anE: TopoDS_Edge, aT: Standard_Real, Tau: gp_Vec): Standard_Boolean;
  static PointOnSurface(aE: TopoDS_Edge, aF: TopoDS_Face, aT: Standard_Real, U: Standard_Real, V: Standard_Real, theContext: any): void;
  static CurveOnSurface_1(aE: TopoDS_Edge, aF: TopoDS_Face, aC: any, aToler: Standard_Real, theContext: any): void;
  static CurveOnSurface_2(aE: TopoDS_Edge, aF: TopoDS_Face, aC: any, aFirst: Standard_Real, aLast: Standard_Real, aToler: Standard_Real, theContext: any): void;
  static HasCurveOnSurface_1(aE: TopoDS_Edge, aF: TopoDS_Face, aC: any, aFirst: Standard_Real, aLast: Standard_Real, aToler: Standard_Real): Standard_Boolean;
  static HasCurveOnSurface_2(aE: TopoDS_Edge, aF: TopoDS_Face): Standard_Boolean;
  static AdjustPCurveOnFace_1(theF: TopoDS_Face, theC3D: any, theC2D: any, theC2DA: any, theContext: any): void;
  static AdjustPCurveOnFace_2(theF: TopoDS_Face, theFirst: Standard_Real, theLast: Standard_Real, theC2D: any, theC2DA: any, theContext: any): void;
  static AdjustPCurveOnSurf(aF: BRepAdaptor_Surface, aT1: Standard_Real, aT2: Standard_Real, aC2D: any, aC2DA: any): void;
  static IntermediatePoint_1(aFirst: Standard_Real, aLast: Standard_Real): Standard_Real;
  static IntermediatePoint_2(anE: TopoDS_Edge): Standard_Real;
  static Make2D(aE: TopoDS_Edge, aF: TopoDS_Face, aC: any, aFirst: Standard_Real, aLast: Standard_Real, aToler: Standard_Real, theContext: any): void;
  static MakePCurveOnFace_1(aF: TopoDS_Face, C3D: any, aC: any, aToler: Standard_Real, theContext: any): void;
  static MakePCurveOnFace_2(aF: TopoDS_Face, C3D: any, aT1: Standard_Real, aT2: Standard_Real, aC: any, aToler: Standard_Real, theContext: any): void;
  static AttachExistingPCurve(aEold: TopoDS_Edge, aEnew: TopoDS_Edge, aF: TopoDS_Face, aCtx: any): Standard_Integer;
  static IsEdgeIsoline(theE: TopoDS_Edge, theF: TopoDS_Face, isTheUIso: Standard_Boolean, isTheVIso: Standard_Boolean): void;
  delete(): void;
}
...
export declare class BOPTools_AlgoTools3D {
  ...
  static GetNormalToFaceOnEdge_1(aE: TopoDS_Edge, aF: TopoDS_Face, aT: Standard_Real, aD: gp_Dir, theContext: any): void;
  static GetNormalToFaceOnEdge_2(aE: TopoDS_Edge, aF: TopoDS_Face, aD: gp_Dir, theContext: any): void;
  static SenseFlag(aNF1: gp_Dir, aNF2: gp_Dir): Standard_Integer;
  static GetNormalToSurface(aS: any, U: Standard_Real, V: Standard_Real, aD: gp_Dir): Standard_Boolean;
  static GetApproxNormalToFaceOnEdge_1(aE: TopoDS_Edge, aF: TopoDS_Face, aT: Standard_Real, aPx: gp_Pnt, aD: gp_Dir, theContext: any): Standard_Boolean;
  ...
  static GetApproxNormalToFaceOnEdge_3(theE: TopoDS_Edge, theF: TopoDS_Face, aT: Standard_Real, aDt2D: Standard_Real, aP: gp_Pnt, aDNF: gp_Dir, theContext: any): Standard_Boolean;
  static PointNearEdge_1(aE: TopoDS_Edge, aF: TopoDS_Face, aT: Standard_Real, aDt2D: Standard_Real, aP2D: gp_Pnt2d, aPx: gp_Pnt, theContext: any): Standard_Integer;
  static PointNearEdge_2(aE: TopoDS_Edge, aF: TopoDS_Face, aT: Standard_Real, aDt2D: Standard_Real, aP2D: gp_Pnt2d, aPx: gp_Pnt): Standard_Integer;
  static PointNearEdge_3(aE: TopoDS_Edge, aF: TopoDS_Face, aT: Standard_Real, aP2D: gp_Pnt2d, aPx: gp_Pnt, theContext: any): Standard_Integer;
  static PointNearEdge_4(aE: TopoDS_Edge, aF: TopoDS_Face, aP2D: gp_Pnt2d, aPx: gp_Pnt, theContext: any): Standard_Integer;
  ...
  static PointInFace_1(theF: TopoDS_Face, theP: gp_Pnt, theP2D: gp_Pnt2d, theContext: any): Standard_Integer;
  static PointInFace_2(theF: TopoDS_Face, theE: TopoDS_Edge, theT: Standard_Real, theDt2D: Standard_Real, theP: gp_Pnt, theP2D: gp_Pnt2d, theContext: any): Standard_Integer;
  static PointInFace_3(theF: TopoDS_Face, theL: any, theP: gp_Pnt, theP2D: gp_Pnt2d, theContext: any, theDt2D: Standard_Real): Standard_Integer;
  delete(): void;
}
...
export declare class BOPTools_SetMapHasher {
  constructor();
  static HashCode(theSet: BOPTools_Set, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(aSet1: BOPTools_Set, aSet2: BOPTools_Set): Standard_Boolean;
  delete(): void;
}
...
export declare class IntTools {
  constructor();
  static Length(E: TopoDS_Edge): Standard_Real;
  static RemoveIdenticalRoots(aSeq: IntTools_SequenceOfRoots, anEpsT: Standard_Real): void;
  static SortRoots(aSeq: IntTools_SequenceOfRoots, anEpsT: Standard_Real): void;
  static FindRootStates(aSeq: IntTools_SequenceOfRoots, anEpsNull: Standard_Real): void;
  static Parameter(P: gp_Pnt, Curve: any, aParm: Standard_Real): Standard_Integer;
  static GetRadius(C: BRepAdaptor_Curve, t1: Standard_Real, t3: Standard_Real, R: Standard_Real): Standard_Integer;
  static PrepareArgs(C: BRepAdaptor_Curve, tMax: Standard_Real, tMin: Standard_Real, Discret: Standard_Integer, Deflect: Standard_Real, anArgs: IntTools_CArray1OfReal): Standard_Integer;
  delete(): void;
}
...
export declare class IntTools_CurveRangeSampleMapHasher {
  constructor();
  static HashCode(theKey: IntTools_CurveRangeSample, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(S1: IntTools_CurveRangeSample, S2: IntTools_CurveRangeSample): Standard_Boolean;
  delete(): void;
}
...
export declare class IntTools_SurfaceRangeSampleMapHasher {
  constructor();
  static HashCode(theKey: IntTools_SurfaceRangeSample, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(S1: IntTools_SurfaceRangeSample, S2: IntTools_SurfaceRangeSample): Standard_Boolean;
  delete(): void;
}
...
export declare class IntTools_Tools {
  constructor();
  static ComputeVV(V1: TopoDS_Vertex, V2: TopoDS_Vertex): Standard_Integer;
  static HasInternalEdge(aW: TopoDS_Wire): Standard_Boolean;
  ...
  static IsVertex_1(E: TopoDS_Edge, t: Standard_Real): Standard_Boolean;
  static IsVertex_2(E: TopoDS_Edge, V: TopoDS_Vertex, t: Standard_Real): Standard_Boolean;
  static IsVertex_3(aCmnPrt: IntTools_CommonPrt): Standard_Boolean;
  static IsMiddlePointsEqual(E1: TopoDS_Edge, E2: TopoDS_Edge): Standard_Boolean;
  static IsVertex_4(aP: gp_Pnt, aTolPV: Standard_Real, aV: TopoDS_Vertex): Standard_Boolean;
  static IntermediatePoint(aFirst: Standard_Real, aLast: Standard_Real): Standard_Real;
  static SplitCurve(aC: IntTools_Curve, aS: IntTools_SequenceOfCurves): Standard_Integer;
  static RejectLines(aSIn: IntTools_SequenceOfCurves, aSOut: IntTools_SequenceOfCurves): void;
  static IsDirsCoinside_1(D1: gp_Dir, D2: gp_Dir): Standard_Boolean;
  static IsDirsCoinside_2(D1: gp_Dir, D2: gp_Dir, aTol: Standard_Real): Standard_Boolean;
  static IsClosed(aC: any): Standard_Boolean;
  static CurveTolerance(aC: any, aTolBase: Standard_Real): Standard_Real;
  static CheckCurve(theCurve: IntTools_Curve, theBox: Bnd_Box): Standard_Boolean;
  static IsOnPave(theT: Standard_Real, theRange: IntTools_Range, theTol: Standard_Real): Standard_Boolean;
  static VertexParameters(theCP: IntTools_CommonPrt, theT1: Standard_Real, theT2: Standard_Real): void;
  static VertexParameter(theCP: IntTools_CommonPrt, theT: Standard_Real): void;
  static IsOnPave1(theT: Standard_Real, theRange: IntTools_Range, theTol: Standard_Real): Standard_Boolean;
  static IsInRange(theRRef: IntTools_Range, theR: IntTools_Range, theTol: Standard_Real): Standard_Boolean;
  static SegPln(theLin: gp_Lin, theTLin1: Standard_Real, theTLin2: Standard_Real, theTolLin: Standard_Real, thePln: gp_Pln, theTolPln: Standard_Real, theP: gp_Pnt, theT: Standard_Real, theTolP: Standard_Real, theTmin: Standard_Real, theTmax: Standard_Real): Standard_Integer;
  static ComputeTolerance(theCurve3D: any, theCurve2D: any, theSurf: any, theFirst: Standard_Real, theLast: Standard_Real, theMaxDist: Standard_Real, theMaxPar: Standard_Real, theTolRange: Standard_Real): Standard_Boolean;
  static ComputeIntRange(theTol1: Standard_Real, theTol2: Standard_Real, theAngle: Standard_Real): Standard_Real;
  delete(): void;
}
...
export declare class IntTools_WLineTool {
  constructor();
  static NotUseSurfacesForApprox(aF1: TopoDS_Face, aF2: TopoDS_Face, WL: any, ifprm: Standard_Integer, ilprm: Standard_Integer): Standard_Boolean;
  static DecompositionOfWLine(theWLine: any, theSurface1: any, theSurface2: any, theFace1: TopoDS_Face, theFace2: TopoDS_Face, theLConstructor: GeomInt_LineConstructor, theAvoidLConstructor: Standard_Boolean, theTol: Standard_Real, theNewLines: IntPatch_SequenceOfLine, theReachedTol3d: Standard_Real, a10: any): Standard_Boolean;
  delete(): void;
}
...
export declare class BOPAlgo_ListOfEdgeInfo extends NCollection_BaseList {
  begin(): any;
  end(): any;
  cbegin(): any;
  cend(): any;
  Size(): Standard_Integer;
  Assign(theOther: BOPAlgo_ListOfEdgeInfo): BOPAlgo_ListOfEdgeInfo;
  Clear(theAllocator: any): void;
  First_1(): BOPAlgo_EdgeInfo;
  First_2(): BOPAlgo_EdgeInfo;
  Last_1(): BOPAlgo_EdgeInfo;
  Last_2(): BOPAlgo_EdgeInfo;
  Append_1(theItem: BOPAlgo_EdgeInfo): BOPAlgo_EdgeInfo;
  Append_3(theOther: BOPAlgo_ListOfEdgeInfo): void;
  Prepend_1(theItem: BOPAlgo_EdgeInfo): BOPAlgo_EdgeInfo;
  Prepend_2(theOther: BOPAlgo_ListOfEdgeInfo): void;
  RemoveFirst(): void;
  Reverse(): void;
  delete(): void;
}

  export declare class BOPAlgo_ListOfEdgeInfo_1 extends BOPAlgo_ListOfEdgeInfo {
    constructor();
  }

  export declare class BOPAlgo_ListOfEdgeInfo_2 extends BOPAlgo_ListOfEdgeInfo {
    constructor(theAllocator: any);
  }

  export declare class BOPAlgo_ListOfEdgeInfo_3 extends BOPAlgo_ListOfEdgeInfo {
    constructor(theOther: BOPAlgo_ListOfEdgeInfo);
  }

export declare class BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo extends NCollection_BaseMap {
  begin(): any;
  end(): any;
  cbegin(): any;
  cend(): any;
  Exchange(theOther: BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo): void;
  Assign(theOther: BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo): BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo;
  ReSize(N: Standard_Integer): void;
  Add(theKey1: TopoDS_Shape, theItem: BOPAlgo_ListOfEdgeInfo): Standard_Integer;
  Contains(theKey1: TopoDS_Shape): Standard_Boolean;
  Substitute(theIndex: Standard_Integer, theKey1: TopoDS_Shape, theItem: BOPAlgo_ListOfEdgeInfo): void;
  Swap(theIndex1: Standard_Integer, theIndex2: Standard_Integer): void;
  RemoveLast(): void;
  RemoveFromIndex(theIndex: Standard_Integer): void;
  RemoveKey(theKey1: TopoDS_Shape): void;
  FindKey(theIndex: Standard_Integer): TopoDS_Shape;
  FindFromIndex(theIndex: Standard_Integer): BOPAlgo_ListOfEdgeInfo;
  ChangeFromIndex(theIndex: Standard_Integer): BOPAlgo_ListOfEdgeInfo;
  FindIndex(theKey1: TopoDS_Shape): Standard_Integer;
  ChangeFromKey(theKey1: TopoDS_Shape): BOPAlgo_ListOfEdgeInfo;
  Seek(theKey1: TopoDS_Shape): BOPAlgo_ListOfEdgeInfo;
  ChangeSeek(theKey1: TopoDS_Shape): BOPAlgo_ListOfEdgeInfo;
  Clear_1(doReleaseMemory: Standard_Boolean): void;
  Clear_2(theAllocator: any): void;
  Size(): Standard_Integer;
  delete(): void;
  ...
  export declare class BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_1 extends BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo {
    constructor();
  }

  export declare class BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_2 extends BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo {
    constructor(theNbBuckets: Standard_Integer, theAllocator: any);
  }

  export declare class BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_3 extends BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo {
    constructor(theOther: BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo);
  }
...
export declare type module_TKBO_wasm = {
  ...
  BOPDS_PairMapHasher: typeof BOPDS_PairMapHasher;
  ...
  BOPDS_PaveMapHasher: typeof BOPDS_PaveMapHasher;
  ...
  BOPTools_SetMapHasher: typeof BOPTools_SetMapHasher;
  ...
  NCollection_List: typeof NCollection_List;
  BOPAlgo_ListOfEdgeInfo_1: typeof BOPAlgo_ListOfEdgeInfo_1;
  BOPAlgo_ListOfEdgeInfo_2: typeof BOPAlgo_ListOfEdgeInfo_2;
  BOPAlgo_ListOfEdgeInfo_3: typeof BOPAlgo_ListOfEdgeInfo_3;
  NCollection_IndexedDataMap: typeof NCollection_IndexedDataMap;
  BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_1: typeof BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_1;
  BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_2: typeof BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_2;
  BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_3: typeof BOPAlgo_IndexedDataMapOfShapeListOfEdgeInfo_3;
  handle: typeof handle;

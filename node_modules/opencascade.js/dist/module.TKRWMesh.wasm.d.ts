declare const libName = "./module.TKRWMesh.wasm.d.ts";
...
export declare class RWMesh_NodeAttributes {
  constructor();
  delete(): void;
}
...
export declare class RWGltf_GltfBufferView {
  constructor()
  delete(): void;
}

export declare class RWGltf_GltfAccessor {
  constructor()
  delete(): void;
}

export declare class RWGltf_GltfFace {
  constructor();
  delete(): void;
}
...
export declare class RWGltf_GltfMaterialMap extends RWMesh_MaterialMap {
  ...
  static baseColorTexture(theMat: any): any;
  delete(): void;
}
...
export declare class RWGltf_GltfSharedIStream {
  constructor();
  delete(): void;
}
...
export declare class RWObj {
  constructor();
  static ReadFile(theFile: Standard_CString, aProgress: Message_ProgressRange): any;
  delete(): void;
}

export declare class RWObj_Material {
  constructor()
  delete(): void;
}

export declare class RWObj_SubMesh {
  constructor();
  delete(): void;
}
...
export declare type module_TKRWMesh_wasm = {
  ...
  RWGltf_GltfSharedIStream: typeof RWGltf_GltfSharedIStream;

declare const libName = "./module.TKShHealing.wasm.d.ts";
...
export declare class ShapeAnalysis {
  ...
  static TotCross2D(sewd: any, aFace: TopoDS_Face): Standard_Real;
...
export declare class ShapeExtend {
  constructor();
  static Init(): void;
  static EncodeStatus(status: ShapeExtend_Status): Standard_Integer;
  static DecodeStatus(flag: Standard_Integer, status: ShapeExtend_Status): Standard_Boolean;
  delete(): void;
}
...
export declare class ShapeAnalysis_Curve {
  ...
  static IsPlanar_1(pnts: TColgp_Array1OfPnt, Normal: gp_XYZ, preci: Standard_Real): Standard_Boolean;
  static IsPlanar_2(curve: any, Normal: gp_XYZ, preci: Standard_Real): Standard_Boolean;
  static GetSamplePoints_1(curve: any, first: Standard_Real, last: Standard_Real, seq: TColgp_SequenceOfPnt2d): Standard_Boolean;
  static GetSamplePoints_2(curve: any, first: Standard_Real, last: Standard_Real, seq: TColgp_SequenceOfPnt): Standard_Boolean;
...
export declare class ShapeAnalysis_Edge {
  ...
  static ComputeDeviation(CRef: Adaptor3d_Curve, Other: Adaptor3d_Curve, SameParameter: Standard_Boolean, dev: Standard_Real, NCONTROL: Standard_Integer): Standard_Boolean;
...
export declare class ShapeAnalysis_FreeBounds {
  ...
  static ConnectEdgesToWires(edges: any, toler: Standard_Real, shared: Standard_Boolean, wires: any): void;
  static ConnectWiresToWires_1(iwires: any, toler: Standard_Real, shared: Standard_Boolean, owires: any): void;
  static ConnectWiresToWires_2(iwires: any, toler: Standard_Real, shared: Standard_Boolean, owires: any, vertices: TopTools_DataMapOfShapeShape): void;
...
export declare class ShapeAnalysis_Geom {
  constructor();
  static NearestPlane(Pnts: TColgp_Array1OfPnt, aPln: gp_Pln, Dmax: Standard_Real): Standard_Boolean;
  static PositionTrsf(coefs: any, trsf: gp_Trsf, unit: Standard_Real, prec: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare class ShapeAnalysis_TransferParametersProj extends ShapeAnalysis_TransferParameters {
  ...
  IsSameRange(): Standard_Boolean;
  static CopyNMVertex_1(theVert: TopoDS_Vertex, toedge: TopoDS_Edge, fromedge: TopoDS_Edge): TopoDS_Vertex;
  static CopyNMVertex_2(theVert: TopoDS_Vertex, toFace: TopoDS_Face, fromFace: TopoDS_Face): TopoDS_Vertex;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class ShapeConstruct {
  constructor();
  static ConvertCurveToBSpline_1(C3D: any, First: Standard_Real, Last: Standard_Real, Tol3d: Standard_Real, Continuity: GeomAbs_Shape, MaxSegments: Standard_Integer, MaxDegree: Standard_Integer): any;
  static ConvertCurveToBSpline_2(C2D: any, First: Standard_Real, Last: Standard_Real, Tol2d: Standard_Real, Continuity: GeomAbs_Shape, MaxSegments: Standard_Integer, MaxDegree: Standard_Integer): any;
  static ConvertSurfaceToBSpline(surf: any, UF: Standard_Real, UL: Standard_Real, VF: Standard_Real, VL: Standard_Real, Tol3d: Standard_Real, Continuity: GeomAbs_Shape, MaxSegments: Standard_Integer, MaxDegree: Standard_Integer): any;
  static JoinPCurves(theEdges: any, theFace: TopoDS_Face, theEdge: TopoDS_Edge): Standard_Boolean;
  static JoinCurves_1(c3d1: any, ac3d2: any, Orient1: TopAbs_Orientation, Orient2: TopAbs_Orientation, first1: Standard_Real, last1: Standard_Real, first2: Standard_Real, last2: Standard_Real, c3dOut: any, isRev1: Standard_Boolean, isRev2: Standard_Boolean): Standard_Boolean;
  static JoinCurves_2(c2d1: any, ac2d2: any, Orient1: TopAbs_Orientation, Orient2: TopAbs_Orientation, first1: Standard_Real, last1: Standard_Real, first2: Standard_Real, last2: Standard_Real, c2dOut: any, isRev1: Standard_Boolean, isRev2: Standard_Boolean, isError: Standard_Boolean): Standard_Boolean;
  delete(): void;
}
...
export declare class ShapeConstruct_Curve {
  ...
  static FixKnots_1(knots: any): Standard_Boolean;
  static FixKnots_2(knots: TColStd_Array1OfReal): Standard_Boolean;
  delete(): void;
}
...
export declare class ShapeCustom {
  constructor();
  static ApplyModifier(S: TopoDS_Shape, M: any, context: TopTools_DataMapOfShapeShape, MD: BRepTools_Modifier, theProgress: Message_ProgressRange, aReShape: any): TopoDS_Shape;
...
export declare class ShapeCustom_Curve2d {
  constructor();
  static IsLinear(thePoles: TColgp_Array1OfPnt2d, theTolerance: Standard_Real, theDeviation: Standard_Real): Standard_Boolean;
  static ConvertToLine2d(theCurve: any, theFirstIn: Standard_Real, theLastIn: Standard_Real, theTolerance: Standard_Real, theNewFirst: Standard_Real, theNewLast: Standard_Real, theDeviation: Standard_Real): any;
  static SimplifyBSpline2d(theBSpline2d: any, theTolerance: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare class ShapeFix {
  constructor();
  static SameParameter(shape: TopoDS_Shape, enforce: Standard_Boolean, preci: Standard_Real, theProgress: Message_ProgressRange, theMsgReg: any): Standard_Boolean;
  static EncodeRegularity(shape: TopoDS_Shape, tolang: Standard_Real): void;
  static RemoveSmallEdges(shape: TopoDS_Shape, Tolerance: Standard_Real, context: any): TopoDS_Shape;
  static FixVertexPosition(theshape: TopoDS_Shape, theTolerance: Standard_Real, thecontext: any): Standard_Boolean;
...
export declare class ShapeProcess {
  constructor();
  static RegisterOperator(name: Standard_CString, op: any): Standard_Boolean;
  static FindOperator(name: Standard_CString, op: any): Standard_Boolean;
  static Perform(context: any, seq: Standard_CString, theProgress: Message_ProgressRange): Standard_Boolean;
  delete(): void;
}
...
export declare class ShapeProcess_OperLibrary {
  constructor();
  static Init(): void;
  static ApplyModifier(S: TopoDS_Shape, context: any, M: any, map: TopTools_DataMapOfShapeShape, msg: any, theMutableInput: Standard_Boolean): TopoDS_Shape;
  delete(): void;
}
...
export declare class ShapeUpgrade {
  constructor();
  static C0BSplineToSequenceOfC1BSplineCurve_1(BS: any, seqBS: any): Standard_Boolean;
  static C0BSplineToSequenceOfC1BSplineCurve_2(BS: any, seqBS: any): Standard_Boolean;
  delete(): void;
}
...
export declare class SubSequenceOfEdges {
  constructor();
  delete(): void;
}
...
export declare type module_TKShHealing_wasm = {
  ...
  SubSequenceOfEdges: typeof SubSequenceOfEdges;

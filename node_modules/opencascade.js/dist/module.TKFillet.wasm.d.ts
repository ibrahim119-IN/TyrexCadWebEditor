declare const libName = "./module.TKFillet.wasm.d.ts";
...
export declare class BRepBlend_BlendTool {
  constructor();
  static Project(P: gp_Pnt2d, S: any, C: any, Paramproj: Standard_Real, Dist: Standard_Real): Standard_Boolean;
  static Inters(P1: gp_Pnt2d, P2: gp_Pnt2d, S: any, C: any, Param: Standard_Real, Dist: Standard_Real): Standard_Boolean;
  static Parameter(V: any, A: any): Standard_Real;
  static Tolerance(V: any, A: any): Standard_Real;
  ...
  static CurveOnSurf(C: any, S: any): any;
  delete(): void;
}
...
export declare class ChFi3d {
  constructor();
  static DefineConnectType(E: TopoDS_Edge, F1: TopoDS_Face, F2: TopoDS_Face, SinTol: Standard_Real, CorrectPoint: Standard_Boolean): ChFiDS_TypeOfConcavity;
  static IsTangentFaces(theEdge: TopoDS_Edge, theFace1: TopoDS_Face, theFace2: TopoDS_Face, Order: GeomAbs_Shape): Standard_Boolean;
  static ConcaveSide(S1: BRepAdaptor_Surface, S2: BRepAdaptor_Surface, E: TopoDS_Edge, Or1: TopAbs_Orientation, Or2: TopAbs_Orientation): Standard_Integer;
  static NextSide_1(Or1: TopAbs_Orientation, Or2: TopAbs_Orientation, OrSave1: TopAbs_Orientation, OrSave2: TopAbs_Orientation, ChoixSauv: Standard_Integer): Standard_Integer;
  static NextSide_2(Or: TopAbs_Orientation, OrSave: TopAbs_Orientation, OrFace: TopAbs_Orientation): void;
  static SameSide(Or: TopAbs_Orientation, OrSave1: TopAbs_Orientation, OrSave2: TopAbs_Orientation, OrFace1: TopAbs_Orientation, OrFace2: TopAbs_Orientation): Standard_Boolean;
  delete(): void;
}
...
export declare class ChFiKPart_ComputeData {
  constructor();
  static Compute(DStr: TopOpeBRepDS_DataStructure, Data: any, S1: any, S2: any, Or1: TopAbs_Orientation, Or2: TopAbs_Orientation, Sp: any, Iedge: Standard_Integer): Standard_Boolean;
  static ComputeCorner_1(DStr: TopOpeBRepDS_DataStructure, Data: any, S1: any, S2: any, OrFace1: TopAbs_Orientation, OrFace2: TopAbs_Orientation, Or1: TopAbs_Orientation, Or2: TopAbs_Orientation, minRad: Standard_Real, majRad: Standard_Real, P1S1: gp_Pnt2d, P2S1: gp_Pnt2d, P1S2: gp_Pnt2d, P2S2: gp_Pnt2d): Standard_Boolean;
  static ComputeCorner_2(DStr: TopOpeBRepDS_DataStructure, Data: any, S1: any, S2: any, OrFace1: TopAbs_Orientation, OrFace2: TopAbs_Orientation, Or1: TopAbs_Orientation, Or2: TopAbs_Orientation, Rad: Standard_Real, PS1: gp_Pnt2d, P1S2: gp_Pnt2d, P2S2: gp_Pnt2d): Standard_Boolean;
  static ComputeCorner_3(DStr: TopOpeBRepDS_DataStructure, Data: any, S: any, S1: any, S2: any, OfS: TopAbs_Orientation, OS: TopAbs_Orientation, OS1: TopAbs_Orientation, OS2: TopAbs_Orientation, Radius: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare type module_TKFillet_wasm = {

declare const libName = "./module.TKFeat.wasm.d.ts";
...
export declare class BRepFeat_RibSlot extends BRepBuilderAPI_MakeShape {
  ...
  NewEdges(): TopTools_ListOfShape;
  TgtEdges(): TopTools_ListOfShape;
  static IntPar(C: any, P: gp_Pnt): Standard_Real;
  static ChoiceOfFaces(faces: TopTools_ListOfShape, cc: any, par: Standard_Real, bnd: Standard_Real, Pln: any): TopoDS_Face;
  CurrentStatusError(): BRepFeat_StatusError;
  delete(): void;
}
...
export declare class LocOpe {
  constructor();
  static Closed_1(W: TopoDS_Wire, OnF: TopoDS_Face): Standard_Boolean;
  static Closed_2(E: TopoDS_Edge, OnF: TopoDS_Face): Standard_Boolean;
  static TgtFaces(E: TopoDS_Edge, F1: TopoDS_Face, F2: TopoDS_Face): Standard_Boolean;
  static SampleEdges(S: TopoDS_Shape, Pt: TColgp_SequenceOfPnt): void;
  delete(): void;
}
...
export declare type module_TKFeat_wasm = {

declare const libName = "./module.TKCAF.wasm.d.ts";
...
export declare class TDataXtd_Shape extends TDataStd_GenericEmpty {
  constructor()
  static Find(current: TDF_Label, S: any): Standard_Boolean;
  static New(label: TDF_Label): any;
  static Set(label: TDF_Label, shape: TopoDS_Shape): any;
...
export declare class TDataXtd_Point extends TDataStd_GenericEmpty {
  ...
  static Set_2(label: TDF_Label, P: gp_Pnt): any;
  ID(): Standard_GUID;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class TDataXtd_Axis extends TDataStd_GenericEmpty {
  ...
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label): any;
  static Set_2(label: TDF_Label, L: gp_Lin): any;
  ID(): Standard_GUID;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class TDataXtd_Plane extends TDataStd_GenericEmpty {
  ...
  static GetID(): Standard_GUID;
  static Set_1(label: TDF_Label): any;
  static Set_2(label: TDF_Label, P: gp_Pln): any;
  ID(): Standard_GUID;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class TDataXtd_Geometry extends TDF_Attribute {
  constructor()
  static Set(label: TDF_Label): any;
  static Type_1(L: TDF_Label): TDataXtd_GeometryEnum;
  static Type_2(S: any): TDataXtd_GeometryEnum;
  static Point_1(L: TDF_Label, G: gp_Pnt): Standard_Boolean;
  static Point_2(S: any, G: gp_Pnt): Standard_Boolean;
  static Axis_1(L: TDF_Label, G: gp_Ax1): Standard_Boolean;
  static Axis_2(S: any, G: gp_Ax1): Standard_Boolean;
  static Line_1(L: TDF_Label, G: gp_Lin): Standard_Boolean;
  static Line_2(S: any, G: gp_Lin): Standard_Boolean;
  static Circle_1(L: TDF_Label, G: gp_Circ): Standard_Boolean;
  static Circle_2(S: any, G: gp_Circ): Standard_Boolean;
  static Ellipse_1(L: TDF_Label, G: gp_Elips): Standard_Boolean;
  static Ellipse_2(S: any, G: gp_Elips): Standard_Boolean;
  static Plane_1(L: TDF_Label, G: gp_Pln): Standard_Boolean;
  static Plane_2(S: any, G: gp_Pln): Standard_Boolean;
  static Cylinder_1(L: TDF_Label, G: gp_Cylinder): Standard_Boolean;
  static Cylinder_2(S: any, G: gp_Cylinder): Standard_Boolean;
  static GetID(): Standard_GUID;
...
export declare class TDataXtd_Position extends TDF_Attribute {
  constructor()
  static Set_1(aLabel: TDF_Label, aPos: gp_Pnt): void;
  static Set_2(aLabel: TDF_Label): any;
  static Get(aLabel: TDF_Label, aPos: gp_Pnt): Standard_Boolean;
  ID(): Standard_GUID;
  static GetID(): Standard_GUID;
...
export declare class TDataXtd_Constraint extends TDF_Attribute {
  ...
  static CollectChildConstraints(aLabel: TDF_Label, TheList: TDF_LabelList): void;
  ID(): Standard_GUID;
...
export declare class TNaming_Naming extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Insert(under: TDF_Label): any;
  static Name(where: TDF_Label, Selection: TopoDS_Shape, Context: TopoDS_Shape, Geometry: Standard_Boolean, KeepOrientation: Standard_Boolean, BNproblem: Standard_Boolean): any;
...
export declare class TDataXtd_Presentation extends TDF_Attribute {
  constructor()
  static Set(theLabel: TDF_Label, theDriverId: Standard_GUID): any;
  ...
  static getColorNameFromOldEnum(theOld: Standard_Integer): Quantity_NameOfColor;
  static getOldColorNameFromNewEnum(theNew: Quantity_NameOfColor): Standard_Integer;
  delete(): void;
}
...
export declare class TDataXtd_Triangulation extends TDF_Attribute {
  constructor()
  static GetID(): Standard_GUID;
  static Set_1(theLabel: TDF_Label): any;
  static Set_2(theLabel: TDF_Label, theTriangulation: any): any;
...
export declare class TNaming {
  constructor();
  static Substitute(labelsource: TDF_Label, labelcible: TDF_Label, mapOldNew: TopTools_DataMapOfShapeShape): void;
  static Update(label: TDF_Label, mapOldNew: TopTools_DataMapOfShapeShape): void;
  static Displace(label: TDF_Label, aLocation: TopLoc_Location, WithOld: Standard_Boolean): void;
  static ChangeShapes(label: TDF_Label, M: TopTools_DataMapOfShapeShape): void;
  static Transform(label: TDF_Label, aTransformation: gp_Trsf): void;
  static Replicate_1(NS: any, T: gp_Trsf, L: TDF_Label): void;
  static Replicate_2(SH: TopoDS_Shape, T: gp_Trsf, L: TDF_Label): void;
  static MakeShape(MS: TopTools_MapOfShape): TopoDS_Shape;
  static FindUniqueContext(S: TopoDS_Shape, Context: TopoDS_Shape): TopoDS_Shape;
  static FindUniqueContextSet(S: TopoDS_Shape, Context: TopoDS_Shape, Arr: any): TopoDS_Shape;
  static SubstituteSShape(accesslabel: TDF_Label, From: TopoDS_Shape, To: TopoDS_Shape): Standard_Boolean;
  static OuterWire(theFace: TopoDS_Face, theWire: TopoDS_Wire): Standard_Boolean;
  static OuterShell(theSolid: TopoDS_Solid, theShell: TopoDS_Shell): Standard_Boolean;
  static IDList(anIDList: TDF_IDList): void;
  delete(): void;
}
...
export declare class TNaming_CopyShape {
  constructor();
  static CopyTool(aShape: TopoDS_Shape, aMap: TColStd_IndexedDataMapOfTransientTransient, aResult: TopoDS_Shape): void;
  static Translate_1(aShape: TopoDS_Shape, aMap: TColStd_IndexedDataMapOfTransientTransient, aResult: TopoDS_Shape, TrTool: any): void;
  static Translate_2(L: TopLoc_Location, aMap: TColStd_IndexedDataMapOfTransientTransient): TopLoc_Location;
  delete(): void;
}
...
export declare class TNaming_Localizer {
  ...
  static IsNew(S: TopoDS_Shape, NS: any): Standard_Boolean;
  static FindGenerator(NS: any, S: TopoDS_Shape, theListOfGenerators: TopTools_ListOfShape): void;
  static FindShapeContext(NS: any, theS: TopoDS_Shape, theSC: TopoDS_Shape): void;
  delete(): void;
}

export declare class TNaming_NamingTool {
  constructor();
  static CurrentShape(Valid: TDF_LabelMap, Forbiden: TDF_LabelMap, NS: any, MS: TopTools_IndexedMapOfShape): void;
  static CurrentShapeFromShape(Valid: TDF_LabelMap, Forbiden: TDF_LabelMap, Acces: TDF_Label, S: TopoDS_Shape, MS: TopTools_IndexedMapOfShape): void;
  static BuildDescendants(NS: any, Labels: TDF_LabelMap): void;
  delete(): void;
}
...
export declare class TNaming_Selector {
  constructor(aLabel: TDF_Label)
  static IsIdentified(access: TDF_Label, selection: TopoDS_Shape, NS: any, Geometry: Standard_Boolean): Standard_Boolean;
...
export declare class TNaming_Tool {
  constructor();
  static CurrentShape_1(NS: any): TopoDS_Shape;
  static CurrentShape_2(NS: any, Updated: TDF_LabelMap): TopoDS_Shape;
  static CurrentNamedShape_1(NS: any, Updated: TDF_LabelMap): any;
  static CurrentNamedShape_2(NS: any): any;
  static NamedShape(aShape: TopoDS_Shape, anAcces: TDF_Label): any;
  static GetShape(NS: any): TopoDS_Shape;
  static OriginalShape(NS: any): TopoDS_Shape;
  static GeneratedShape(S: TopoDS_Shape, Generation: any): TopoDS_Shape;
  static Collect(NS: any, Labels: TNaming_MapOfNamedShape, OnlyModif: Standard_Boolean): void;
  static HasLabel_1(access: TDF_Label, aShape: TopoDS_Shape): Standard_Boolean;
  static Label_1(access: TDF_Label, aShape: TopoDS_Shape, TransDef: Standard_Integer): TDF_Label;
  static InitialShape(aShape: TopoDS_Shape, anAcces: TDF_Label, Labels: TDF_LabelList): TopoDS_Shape;
  static ValidUntil_1(access: TDF_Label, S: TopoDS_Shape): Standard_Integer;
  static FindShape(Valid: TDF_LabelMap, Forbiden: TDF_LabelMap, Arg: any, S: TopoDS_Shape): void;
  delete(): void;
}
...
export declare type module_TKCAF_wasm = {

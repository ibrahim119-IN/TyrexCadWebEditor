declare const libName = "./module.TKV3d.wasm.d.ts";
...
export declare class SelectBasics_PickResult {
  static Min(thePickResult1: SelectBasics_PickResult, thePickResult2: SelectBasics_PickResult): SelectBasics_PickResult;
  IsValid(): Standard_Boolean;
  Invalidate(): void;
  Depth(): Standard_Real;
  SetDepth(theDepth: Standard_Real): void;
  HasPickedPoint(): Standard_Boolean;
  PickedPoint(): gp_Pnt;
  SetPickedPoint(theObjPickedPnt: gp_Pnt): void;
  DistToGeomCenter(): Standard_Real;
  SetDistToGeomCenter(theDistToCenter: Standard_Real): void;
  SurfaceNormal(): NCollection_Vec3<float>;
  SetSurfaceNormal_1(theNormal: NCollection_Vec3<float>): void;
  SetSurfaceNormal_2(theNormal: gp_Vec): void;
  delete(): void;
}

  export declare class SelectBasics_PickResult_1 extends SelectBasics_PickResult {
    constructor();
  }

  export declare class SelectBasics_PickResult_2 extends SelectBasics_PickResult {
    constructor(theDepth: Standard_Real, theDistToCenter: Standard_Real, theObjPickedPnt: gp_Pnt);
  }
...
export declare class PrsDim_AngleDimension extends PrsDim_Dimension {
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  FirstPoint(): gp_Pnt;
...
export declare class AIS_AnimationProgress {
  constructor()
  delete(): void;
}
...
export declare class AIS_ColorScale extends AIS_InteractiveObject {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static FindColor_1(theValue: Standard_Real, theMin: Standard_Real, theMax: Standard_Real, theColorsCount: Standard_Integer, theColorHlsMin: Graphic3d_Vec3d, theColorHlsMax: Graphic3d_Vec3d, theColor: Quantity_Color): Standard_Boolean;
  static FindColor_2(theValue: Standard_Real, theMin: Standard_Real, theMax: Standard_Real, theColorsCount: Standard_Integer, theColor: Quantity_Color): Standard_Boolean;
  static hueToValidRange(theHue: Standard_Real): Standard_Real;
  ...
  static MakeUniformColors(theNbColors: Standard_Integer, theLightness: Standard_Real, theHueFrom: Standard_Real, theHueTo: Standard_Real): Aspect_SequenceOfColor;
...
export declare class AIS_Shape extends AIS_InteractiveObject {
  ...
  BoundingBox_2(theBndBox: Bnd_Box): void;
  Color(aColor: Quantity_Color): void;
  Material(): Graphic3d_NameOfMaterial;
  Transparency(): Standard_Real;
  static SelectionType(theSelMode: Standard_Integer): TopAbs_ShapeEnum;
  static SelectionMode(theShapeType: TopAbs_ShapeEnum): Standard_Integer;
  ...
  static computeHlrPresentation(theProjector: any, thePrs: any, theShape: TopoDS_Shape, theDrawer: any): void;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  delete(): void;
}
...
export declare class PrsDim_DiameterDimension extends PrsDim_Dimension {
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  Circle(): gp_Circ;
...
export declare class PrsDim_EqualDistanceRelation extends PrsDim_Relation {
  ...
  Shape4(): TopoDS_Shape;
  static ComputeTwoEdgesLength(aPresentation: any, aDrawer: any, ArrowSize: Standard_Real, FirstEdge: TopoDS_Edge, SecondEdge: TopoDS_Edge, Plane: any, AutomaticPos: Standard_Boolean, IsSetBndBox: Standard_Boolean, BndBox: Bnd_Box, Position: gp_Pnt, FirstAttach: gp_Pnt, SecondAttach: gp_Pnt, FirstExtreme: gp_Pnt, SecondExtreme: gp_Pnt, SymbolPrs: DsgPrs_ArrowSide): void;
  static ComputeTwoVerticesLength(aPresentation: any, aDrawer: any, ArrowSize: Standard_Real, FirstVertex: TopoDS_Vertex, SecondVertex: TopoDS_Vertex, Plane: any, AutomaticPos: Standard_Boolean, IsSetBndBox: Standard_Boolean, BndBox: Bnd_Box, TypeDist: PrsDim_TypeOfDist, Position: gp_Pnt, FirstAttach: gp_Pnt, SecondAttach: gp_Pnt, FirstExtreme: gp_Pnt, SecondExtreme: gp_Pnt, SymbolPrs: DsgPrs_ArrowSide): void;
  static ComputeOneEdgeOneVertexLength(aPresentation: any, aDrawer: any, ArrowSize: Standard_Real, FirstShape: TopoDS_Shape, SecondShape: TopoDS_Shape, Plane: any, AutomaticPos: Standard_Boolean, IsSetBndBox: Standard_Boolean, BndBox: Bnd_Box, Position: gp_Pnt, FirstAttach: gp_Pnt, SecondAttach: gp_Pnt, FirstExtreme: gp_Pnt, SecondExtreme: gp_Pnt, SymbolPrs: DsgPrs_ArrowSide): void;
  delete(): void;
}
...
export declare class AIS_GraphicTool {
  constructor();
  static GetLineColor_1(aDrawer: any, TheTypeOfAttributes: AIS_TypeOfAttribute): Quantity_NameOfColor;
  static GetLineColor_2(aDrawer: any, TheTypeOfAttributes: AIS_TypeOfAttribute, TheLineColor: Quantity_Color): void;
  static GetLineWidth(aDrawer: any, TheTypeOfAttributes: AIS_TypeOfAttribute): Standard_Real;
  static GetLineType(aDrawer: any, TheTypeOfAttributes: AIS_TypeOfAttribute): Aspect_TypeOfLine;
  static GetLineAtt(aDrawer: any, TheTypeOfAttributes: AIS_TypeOfAttribute, aCol: Quantity_NameOfColor, aWidth: Standard_Real, aTyp: Aspect_TypeOfLine): void;
  static GetInteriorColor_1(aDrawer: any): Quantity_NameOfColor;
  static GetInteriorColor_2(aDrawer: any, aColor: Quantity_Color): void;
  static GetMaterial(aDrawer: any): Graphic3d_MaterialAspect;
  delete(): void;
}
...
export declare class PrsDim_LengthDimension extends PrsDim_Dimension {
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  FirstPoint(): gp_Pnt;
...
export declare class V3d_ImageDumpOptions {
  constructor()
  delete(): void;
}
...
export declare class PrsDim_RadiusDimension extends PrsDim_Dimension {
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  Circle(): gp_Circ;
...
export declare class AIS_WalkPart {
  constructor()
  IsEmpty(): boolean;
  delete(): void;
}

export declare class AIS_WalkDelta {
  constructor()
  IsJumping(): boolean;
  SetJumping(theIsJumping: boolean): void;
  IsCrouching(): boolean;
  SetCrouching(theIsCrouching: boolean): void;
  IsRunning(): boolean;
  SetRunning(theIsRunning: boolean): void;
  IsEmpty(): boolean;
  ToMove(): boolean;
  ToRotate(): boolean;
  delete(): void;
...
export declare class AIS_ViewCube extends AIS_InteractiveObject {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static IsBoxSide(theOrient: V3d_TypeOfOrientation): boolean;
  static IsBoxEdge(theOrient: V3d_TypeOfOrientation): boolean;
  static IsBoxCorner(theOrient: V3d_TypeOfOrientation): boolean;
  ViewAnimation(): any;
  SetViewAnimation(theAnimation: any): void;
...
export declare class DsgPrs {
  constructor();
  static ComputeSymbol(aPresentation: any, anAspect: any, pt1: gp_Pnt, pt2: gp_Pnt, dir1: gp_Dir, dir2: gp_Dir, ArrowSide: DsgPrs_ArrowSide, drawFromCenter: Standard_Boolean): void;
  static ComputePlanarFacesLengthPresentation(FirstArrowLength: Standard_Real, SecondArrowLength: Standard_Real, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, DirAttach: gp_Dir, OffsetPoint: gp_Pnt, PlaneOfFaces: gp_Pln, EndOfArrow1: gp_Pnt, EndOfArrow2: gp_Pnt, DirOfArrow1: gp_Dir): void;
  static ComputeCurvilinearFacesLengthPresentation(FirstArrowLength: Standard_Real, SecondArrowLength: Standard_Real, SecondSurf: any, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, DirAttach: gp_Dir, EndOfArrow2: gp_Pnt, DirOfArrow1: gp_Dir, VCurve: any, UCurve: any, FirstU: Standard_Real, deltaU: Standard_Real, FirstV: Standard_Real, deltaV: Standard_Real): void;
  static ComputeFacesAnglePresentation(ArrowLength: Standard_Real, Value: Standard_Real, CenterPoint: gp_Pnt, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, dir1: gp_Dir, dir2: gp_Dir, axisdir: gp_Dir, isPlane: Standard_Boolean, AxisOfSurf: gp_Ax1, OffsetPoint: gp_Pnt, AngleCirc: gp_Circ, FirstParAngleCirc: Standard_Real, LastParAngleCirc: Standard_Real, EndOfArrow1: gp_Pnt, EndOfArrow2: gp_Pnt, DirOfArrow1: gp_Dir, DirOfArrow2: gp_Dir, ProjAttachPoint2: gp_Pnt, AttachCirc: gp_Circ, FirstParAttachCirc: Standard_Real, LastParAttachCirc: Standard_Real): void;
  static ComputeRadiusLine(aCenter: gp_Pnt, anEndOfArrow: gp_Pnt, aPosition: gp_Pnt, drawFromCenter: Standard_Boolean, aRadLineOrign: gp_Pnt, aRadLineEnd: gp_Pnt): void;
  ...
  static DistanceFromApex(elips: gp_Elips, Apex: gp_Pnt, par: Standard_Real): Standard_Real;
  delete(): void;
}

export declare class DsgPrs_AnglePresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, aVal: Standard_Real, aText: TCollection_ExtendedString, aCircle: gp_Circ, aPosition: gp_Pnt, Apex: gp_Pnt, VminCircle: gp_Circ, VmaxCircle: gp_Circ, aArrowSize: Standard_Real): void;
  static Add_2(aPresentation: any, aDrawer: any, theval: Standard_Real, CenterPoint: gp_Pnt, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, dir1: gp_Dir, dir2: gp_Dir, OffsetPoint: gp_Pnt): void;
  static Add_3(aPresentation: any, aDrawer: any, theval: Standard_Real, thevalstring: TCollection_ExtendedString, CenterPoint: gp_Pnt, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, dir1: gp_Dir, dir2: gp_Dir, OffsetPoint: gp_Pnt): void;
  static Add_4(aPresentation: any, aDrawer: any, theval: Standard_Real, thevalstring: TCollection_ExtendedString, CenterPoint: gp_Pnt, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, dir1: gp_Dir, dir2: gp_Dir, OffsetPoint: gp_Pnt, ArrowSide: DsgPrs_ArrowSide): void;
  static Add_5(aPresentation: any, aDrawer: any, theval: Standard_Real, thevalstring: TCollection_ExtendedString, CenterPoint: gp_Pnt, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, dir1: gp_Dir, dir2: gp_Dir, axisdir: gp_Dir, OffsetPoint: gp_Pnt): void;
  static Add_6(aPresentation: any, aDrawer: any, theval: Standard_Real, thevalstring: TCollection_ExtendedString, CenterPoint: gp_Pnt, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, dir1: gp_Dir, dir2: gp_Dir, axisdir: gp_Dir, isPlane: Standard_Boolean, AxisOfSurf: gp_Ax1, OffsetPoint: gp_Pnt, ArrowSide: DsgPrs_ArrowSide): void;
  static Add_7(aPresentation: any, aDrawer: any, theval: Standard_Real, theCenter: gp_Pnt, AttachmentPoint1: gp_Pnt, theAxe: gp_Ax1, ArrowSide: DsgPrs_ArrowSide): void;
  delete(): void;
}

export declare class DsgPrs_Chamf2dPresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, aPntAttach: gp_Pnt, aPntEnd: gp_Pnt, aText: TCollection_ExtendedString): void;
  static Add_2(aPresentation: any, aDrawer: any, aPntAttach: gp_Pnt, aPntEnd: gp_Pnt, aText: TCollection_ExtendedString, ArrowSide: DsgPrs_ArrowSide): void;
  delete(): void;
}

export declare class DsgPrs_ConcentricPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, aCenter: gp_Pnt, aRadius: Standard_Real, aNorm: gp_Dir, aPoint: gp_Pnt): void;
  delete(): void;
}

export declare class Prs3d_Root {
  constructor();
  static CurrentGroup(thePrs3d: any): any;
  static NewGroup(thePrs3d: any): any;
  delete(): void;
}

export declare class DsgPrs_DatumPrs extends Prs3d_Root {
  constructor();
  static Add(thePresentation: any, theDatum: gp_Ax2, theDrawer: any): void;
  delete(): void;
}

export declare class DsgPrs_DiameterPresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, AttachmentPoint: gp_Pnt, aCircle: gp_Circ, ArrowSide: DsgPrs_ArrowSide, IsDiamSymbol: Standard_Boolean): void;
  static Add_2(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, AttachmentPoint: gp_Pnt, aCircle: gp_Circ, uFirst: Standard_Real, uLast: Standard_Real, ArrowSide: DsgPrs_ArrowSide, IsDiamSymbol: Standard_Boolean): void;
  delete(): void;
}

export declare class DsgPrs_EllipseRadiusPresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, theval: Standard_Real, aText: TCollection_ExtendedString, AttachmentPoint: gp_Pnt, anEndOfArrow: gp_Pnt, aCenter: gp_Pnt, IsMaxRadius: Standard_Boolean, ArrowSide: DsgPrs_ArrowSide): void;
  static Add_2(aPresentation: any, aDrawer: any, theval: Standard_Real, aText: TCollection_ExtendedString, anEllipse: gp_Elips, AttachmentPoint: gp_Pnt, anEndOfArrow: gp_Pnt, aCenter: gp_Pnt, uFirst: Standard_Real, IsInDomain: Standard_Boolean, IsMaxRadius: Standard_Boolean, ArrowSide: DsgPrs_ArrowSide): void;
  static Add_3(aPresentation: any, aDrawer: any, theval: Standard_Real, aText: TCollection_ExtendedString, aCurve: any, AttachmentPoint: gp_Pnt, anEndOfArrow: gp_Pnt, aCenter: gp_Pnt, uFirst: Standard_Real, IsInDomain: Standard_Boolean, IsMaxRadius: Standard_Boolean, ArrowSide: DsgPrs_ArrowSide): void;
  delete(): void;
}

export declare class DsgPrs_EqualDistancePresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, Point1: gp_Pnt, Point2: gp_Pnt, Point3: gp_Pnt, Point4: gp_Pnt, Plane: any): void;
  static AddInterval(aPresentation: any, aDrawer: any, aPoint1: gp_Pnt, aPoint2: gp_Pnt, aDir: gp_Dir, aPosition: gp_Pnt, anArrowSide: DsgPrs_ArrowSide, anExtremePnt1: gp_Pnt, anExtremePnt2: gp_Pnt): void;
  static AddIntervalBetweenTwoArcs(aPresentation: any, aDrawer: any, aCircle1: gp_Circ, aCircle2: gp_Circ, aPoint1: gp_Pnt, aPoint2: gp_Pnt, aPoint3: gp_Pnt, aPoint4: gp_Pnt, anArrowSide: DsgPrs_ArrowSide): void;
  delete(): void;
}

export declare class DsgPrs_EqualRadiusPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, FirstCenter: gp_Pnt, SecondCenter: gp_Pnt, FirstPoint: gp_Pnt, SecondPoint: gp_Pnt, Plane: any): void;
  delete(): void;
}

export declare class DsgPrs_FilletRadiusPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, thevalue: Standard_Real, aText: TCollection_ExtendedString, aPosition: gp_Pnt, aNormalDir: gp_Dir, aBasePnt: gp_Pnt, aFirstPoint: gp_Pnt, aSecondPoint: gp_Pnt, aCenter: gp_Pnt, ArrowPrs: DsgPrs_ArrowSide, drawRevers: Standard_Boolean, DrawPosition: gp_Pnt, EndOfArrow: gp_Pnt, TrimCurve: any, HasCircle: Standard_Boolean): void;
  delete(): void;
}

export declare class DsgPrs_FixPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, aPntAttach: gp_Pnt, aPntEnd: gp_Pnt, aNormPln: gp_Dir, aSymbSize: Standard_Real): void;
  delete(): void;
}

export declare class DsgPrs_IdenticPresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, aPntAttach: gp_Pnt, aPntOffset: gp_Pnt): void;
  static Add_2(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, aFAttach: gp_Pnt, aSAttach: gp_Pnt, aPntOffset: gp_Pnt): void;
  static Add_3(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, aAx2: gp_Ax2, aCenter: gp_Pnt, aFAttach: gp_Pnt, aSAttach: gp_Pnt, aPntOffset: gp_Pnt): void;
  static Add_4(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, aAx2: gp_Ax2, aCenter: gp_Pnt, aFAttach: gp_Pnt, aSAttach: gp_Pnt, aPntOffset: gp_Pnt, aPntOnCirc: gp_Pnt): void;
  static Add_5(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, anEllipse: gp_Elips, aFAttach: gp_Pnt, aSAttach: gp_Pnt, aPntOffset: gp_Pnt, aPntOnElli: gp_Pnt): void;
  delete(): void;
}

export declare class DsgPrs_LengthPresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aDirection: gp_Dir, OffsetPoint: gp_Pnt): void;
  static Add_2(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aDirection: gp_Dir, OffsetPoint: gp_Pnt, ArrowSide: DsgPrs_ArrowSide): void;
  static Add_3(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, PlaneOfFaces: gp_Pln, aDirection: gp_Dir, OffsetPoint: gp_Pnt, ArrowSide: DsgPrs_ArrowSide): void;
  static Add_4(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, SecondSurf: any, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aDirection: gp_Dir, OffsetPoint: gp_Pnt, ArrowSide: DsgPrs_ArrowSide): void;
  static Add_5(aPresentation: any, aDrawer: any, Pt1: gp_Pnt, Pt2: gp_Pnt, ArrowSide: DsgPrs_ArrowSide): void;
  delete(): void;
}

export declare class DsgPrs_MidPointPresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, theAxe: gp_Ax2, MidPoint: gp_Pnt, Position: gp_Pnt, AttachPoint: gp_Pnt, first: Standard_Boolean): void;
  static Add_2(aPresentation: any, aDrawer: any, theAxe: gp_Ax2, MidPoint: gp_Pnt, Position: gp_Pnt, AttachPoint: gp_Pnt, Point1: gp_Pnt, Point2: gp_Pnt, first: Standard_Boolean): void;
  static Add_3(aPresentation: any, aDrawer: any, aCircle: gp_Circ, MidPoint: gp_Pnt, Position: gp_Pnt, AttachPoint: gp_Pnt, Point1: gp_Pnt, Point2: gp_Pnt, first: Standard_Boolean): void;
  static Add_4(aPresentation: any, aDrawer: any, anElips: gp_Elips, MidPoint: gp_Pnt, Position: gp_Pnt, AttachPoint: gp_Pnt, Point1: gp_Pnt, Point2: gp_Pnt, first: Standard_Boolean): void;
  delete(): void;
}

export declare class DsgPrs_OffsetPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aDirection: gp_Dir, aDirection2: gp_Dir, OffsetPoint: gp_Pnt): void;
  static AddAxes(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aDirection: gp_Dir, aDirection2: gp_Dir, OffsetPoint: gp_Pnt): void;
  delete(): void;
}
...
export declare class DsgPrs_PerpenPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, pAx1: gp_Pnt, pAx2: gp_Pnt, pnt1: gp_Pnt, pnt2: gp_Pnt, OffsetPoint: gp_Pnt, intOut1: Standard_Boolean, intOut2: Standard_Boolean): void;
  delete(): void;
}

export declare class DsgPrs_ShadedPlanePresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, aPt1: gp_Pnt, aPt2: gp_Pnt, aPt3: gp_Pnt): void;
  delete(): void;
}

export declare class DsgPrs_ShapeDirPresentation {
  constructor();
  static Add(prs: any, aDrawer: any, shape: TopoDS_Shape, mode: Standard_Integer): void;
  delete(): void;
}

export declare class DsgPrs_SymbPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, aText: TCollection_ExtendedString, OffsetPoint: gp_Pnt): void;
  delete(): void;
}

export declare class DsgPrs_SymmetricPresentation {
  constructor();
  static Add_1(aPresentation: any, aDrawer: any, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aDirection1: gp_Dir, aAxis: gp_Lin, OffsetPoint: gp_Pnt): void;
  static Add_2(aPresentation: any, aDrawer: any, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aCircle1: gp_Circ, aAxis: gp_Lin, OffsetPoint: gp_Pnt): void;
  static Add_3(aPresentation: any, aDrawer: any, AttachmentPoint1: gp_Pnt, AttachmentPoint2: gp_Pnt, aAxis: gp_Lin, OffsetPoint: gp_Pnt): void;
  delete(): void;
}

export declare class DsgPrs_TangentPresentation {
  constructor();
  static Add(aPresentation: any, aDrawer: any, OffsetPoint: gp_Pnt, aDirection: gp_Dir, aLength: Standard_Real): void;
  delete(): void;
}

export declare class DsgPrs_XYZAxisPresentation {
  constructor();
  static Add_1(aPresentation: any, anLineAspect: any, aDir: gp_Dir, aVal: Standard_Real, aText: Standard_CString, aPfirst: gp_Pnt, aPlast: gp_Pnt): void;
  static Add_2(aPresentation: any, aLineAspect: any, anArrowAspect: any, aTextAspect: any, aDir: gp_Dir, aVal: Standard_Real, aText: Standard_CString, aPfirst: gp_Pnt, aPlast: gp_Pnt): void;
  delete(): void;
}
...
export declare class StdPrs_BRepFont extends Standard_Transient {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static FindAndCreate(theFontName: TCollection_AsciiString, theFontAspect: Font_FontAspect, theSize: Standard_Real, theStrictLevel: Font_StrictLevel): any;
  Release(): void;
...
export declare class Select3D_SensitiveSet extends Select3D_SensitiveEntity {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static DefaultBVHBuilder(): any;
  static SetDefaultBVHBuilder(theBuilder: any): void;
...
export declare class Prs3d {
  constructor();
  static MatchSegment(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, p1: gp_Pnt, p2: gp_Pnt, dist: Standard_Real): Standard_Boolean;
  static GetDeflection_1(theBndMin: Graphic3d_Vec3d, theBndMax: Graphic3d_Vec3d, theDeviationCoefficient: Standard_Real): Standard_Real;
  static GetDeflection_2(theBndBox: Bnd_Box, theDeviationCoefficient: Standard_Real, theMaximalChordialDeviation: Standard_Real): Standard_Real;
  static PrimitivesFromPolylines(thePoints: Prs3d_NListOfSequenceOfPnt): any;
  static AddPrimitivesGroup(thePrs: any, theAspect: any, thePolylines: Prs3d_NListOfSequenceOfPnt): void;
  static AddFreeEdges(theSegments: TColgp_SequenceOfPnt, thePolyTri: any, theLocation: gp_Trsf): void;
  delete(): void;
}

export declare class Prs3d_Arrow {
  constructor();
  static DrawShaded(theAxis: gp_Ax1, theTubeRadius: Standard_Real, theAxisLength: Standard_Real, theConeRadius: Standard_Real, theConeLength: Standard_Real, theNbFacettes: Standard_Integer): any;
  static DrawSegments(theLocation: gp_Pnt, theDir: gp_Dir, theAngle: Standard_Real, theLength: Standard_Real, theNbSegments: Standard_Integer): any;
  static Draw_1(theGroup: any, theLocation: gp_Pnt, theDirection: gp_Dir, theAngle: Standard_Real, theLength: Standard_Real): void;
  static Draw_2(thePrs: any, theLocation: gp_Pnt, theDirection: gp_Dir, theAngle: Standard_Real, theLength: Standard_Real): void;
  delete(): void;
}

export declare class Prs3d_BndBox extends Prs3d_Root {
  constructor();
  static Add_1(thePresentation: any, theBndBox: Bnd_Box, theDrawer: any): void;
  static Add_2(thePresentation: any, theBndBox: Bnd_OBB, theDrawer: any): void;
  static FillSegments_1(theBox: Bnd_OBB): any;
  static FillSegments_2(theBox: Bnd_Box): any;
  static FillSegments_3(theSegments: any, theBox: Bnd_OBB): void;
  static FillSegments_4(theSegments: any, theBox: Bnd_Box): void;
  static fillSegments(theSegments: any, theBox: gp_Pnt): void;
  delete(): void;
}
...
export declare class Prs3d_Text {
  constructor();
  static Draw_1(theGroup: any, theAspect: any, theText: TCollection_ExtendedString, theAttachmentPoint: gp_Pnt): any;
  static Draw_2(theGroup: any, theAspect: any, theText: TCollection_ExtendedString, theOrientation: gp_Ax2, theHasOwnAnchor: Standard_Boolean): any;
  static Draw_3(thePrs: any, theDrawer: any, theText: TCollection_ExtendedString, theAttachmentPoint: gp_Pnt): void;
  static Draw_4(thePrs: any, theAspect: any, theText: TCollection_ExtendedString, theOrientation: gp_Ax2, theHasOwnAnchor: Standard_Boolean): void;
  static Draw_5(thePrs: any, theAspect: any, theText: TCollection_ExtendedString, theAttachmentPoint: gp_Pnt): void;
  delete(): void;
}

export declare class Prs3d_ToolCylinder extends Prs3d_ToolQuadric {
  ...
  static Create(theBottomRad: Standard_Real, theTopRad: Standard_Real, theHeight: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  delete(): void;
}

export declare class Prs3d_ToolDisk extends Prs3d_ToolQuadric {
  ...
  static Create(theInnerRadius: Standard_Real, theOuterRadius: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  SetAngleRange(theStartAngle: Standard_Real, theEndAngle: Standard_Real): void;
  delete(): void;
}

export declare class Prs3d_ToolSector extends Prs3d_ToolQuadric {
  constructor(theRadius: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer)
  static Create(theRadius: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  delete(): void;
}

export declare class Prs3d_ToolSphere extends Prs3d_ToolQuadric {
  constructor(theRadius: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer)
  static Create(theRadius: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  delete(): void;
}

export declare class Prs3d_ToolTorus extends Prs3d_ToolQuadric {
  static Create_1(theMajorRad: Standard_Real, theMinorRad: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  static Create_2(theMajorRad: Standard_Real, theMinorRad: Standard_Real, theAngle: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  static Create_3(theMajorRad: Standard_Real, theMinorRad: Standard_Real, theAngle1: Standard_Real, theAngle2: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  static Create_4(theMajorRad: Standard_Real, theMinorRad: Standard_Real, theAngle1: Standard_Real, theAngle2: Standard_Real, theAngle: Standard_Real, theNbSlices: Standard_Integer, theNbStacks: Standard_Integer, theTrsf: gp_Trsf): any;
  delete(): void;
}
...
export declare class PrsDim {
  constructor();
  static Nearest_1(aShape: TopoDS_Shape, aPoint: gp_Pnt): gp_Pnt;
  static Nearest_2(theLine: gp_Lin, thePoint: gp_Pnt): gp_Pnt;
  static Nearest_3(theCurve: any, thePoint: gp_Pnt, theFirstPoint: gp_Pnt, theLastPoint: gp_Pnt, theNearestPoint: gp_Pnt): Standard_Boolean;
  static Farest(aShape: TopoDS_Shape, aPoint: gp_Pnt): gp_Pnt;
  static ComputeGeometry_1(theEdge: TopoDS_Edge, theCurve: any, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt): Standard_Boolean;
  static ComputeGeometry_2(theEdge: TopoDS_Edge, theCurve: any, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt, theIsInfinite: Standard_Boolean): Standard_Boolean;
  static ComputeGeometry_3(theEdge: TopoDS_Edge, theCurve: any, theFirstPnt: gp_Pnt, theLastPnt: gp_Pnt, theExtCurve: any, theIsInfinite: Standard_Boolean, theIsOnPlane: Standard_Boolean, thePlane: any): Standard_Boolean;
  static ComputeGeometry_4(theFirstEdge: TopoDS_Edge, theSecondEdge: TopoDS_Edge, theFirstCurve: any, theSecondCurve: any, theFirstPnt1: gp_Pnt, theLastPnt1: gp_Pnt, theFirstPnt2: gp_Pnt, theLastPnt2: gp_Pnt, thePlane: any): Standard_Boolean;
  static ComputeGeometry_5(theFirstEdge: TopoDS_Edge, theSecondEdge: TopoDS_Edge, theFirstCurve: any, theSecondCurve: any, theFirstPnt1: gp_Pnt, theLastPnt1: gp_Pnt, theFirstPnt2: gp_Pnt, theLastPnt2: gp_Pnt, theIsinfinite1: Standard_Boolean, theIsinfinite2: Standard_Boolean): Standard_Boolean;
  static ComputeGeometry_6(theFirstEdge: TopoDS_Edge, theSecondEdge: TopoDS_Edge, theExtIndex: Standard_Integer, theFirstCurve: any, theSecondCurve: any, theFirstPnt1: gp_Pnt, theLastPnt1: gp_Pnt, theFirstPnt2: gp_Pnt, theLastPnt2: gp_Pnt, theExtCurve: any, theIsinfinite1: Standard_Boolean, theIsinfinite2: Standard_Boolean, thePlane: any): Standard_Boolean;
  static ComputeGeomCurve(aCurve: any, first1: Standard_Real, last1: Standard_Real, FirstPnt1: gp_Pnt, LastPnt1: gp_Pnt, aPlane: any, isOnPlane: Standard_Boolean): Standard_Boolean;
  static ComputeGeometry_7(aVertex: TopoDS_Vertex, point: gp_Pnt, aPlane: any, isOnPlane: Standard_Boolean): Standard_Boolean;
  static GetPlaneFromFace(aFace: TopoDS_Face, aPlane: gp_Pln, aSurf: any, aSurfType: PrsDim_KindOfSurface, Offset: Standard_Real): Standard_Boolean;
  static InitFaceLength(aFace: TopoDS_Face, aPlane: gp_Pln, aSurface: any, aSurfaceType: PrsDim_KindOfSurface, anOffset: Standard_Real): void;
  static InitLengthBetweenCurvilinearFaces(theFirstFace: TopoDS_Face, theSecondFace: TopoDS_Face, theFirstSurf: any, theSecondSurf: any, theFirstAttach: gp_Pnt, theSecondAttach: gp_Pnt, theDirOnPlane: gp_Dir): void;
  static InitAngleBetweenPlanarFaces(theFirstFace: TopoDS_Face, theSecondFace: TopoDS_Face, theCenter: gp_Pnt, theFirstAttach: gp_Pnt, theSecondAttach: gp_Pnt, theIsFirstPointSet: Standard_Boolean): Standard_Boolean;
  static InitAngleBetweenCurvilinearFaces(theFirstFace: TopoDS_Face, theSecondFace: TopoDS_Face, theFirstSurfType: PrsDim_KindOfSurface, theSecondSurfType: PrsDim_KindOfSurface, theCenter: gp_Pnt, theFirstAttach: gp_Pnt, theSecondAttach: gp_Pnt, theIsFirstPointSet: Standard_Boolean): Standard_Boolean;
  static ProjectPointOnPlane(aPoint: gp_Pnt, aPlane: gp_Pln): gp_Pnt;
  static ProjectPointOnLine(aPoint: gp_Pnt, aLine: gp_Lin): gp_Pnt;
  static TranslatePointToBound(aPoint: gp_Pnt, aDir: gp_Dir, aBndBox: Bnd_Box): gp_Pnt;
  static InDomain(aFirstPar: Standard_Real, aLastPar: Standard_Real, anAttachPar: Standard_Real): Standard_Boolean;
  static NearestApex(elips: gp_Elips, pApex: gp_Pnt, nApex: gp_Pnt, fpara: Standard_Real, lpara: Standard_Real, IsInDomain: Standard_Boolean): gp_Pnt;
  static DistanceFromApex(elips: gp_Elips, Apex: gp_Pnt, par: Standard_Real): Standard_Real;
  static ComputeProjEdgePresentation(aPres: any, aDrawer: any, anEdge: TopoDS_Edge, ProjCurve: any, FirstP: gp_Pnt, LastP: gp_Pnt, aColor: Quantity_NameOfColor, aWidth: Standard_Real, aProjTOL: Aspect_TypeOfLine, aCallTOL: Aspect_TypeOfLine): void;
  static ComputeProjVertexPresentation(aPres: any, aDrawer: any, aVertex: TopoDS_Vertex, ProjPoint: gp_Pnt, aColor: Quantity_NameOfColor, aWidth: Standard_Real, aProjTOM: Aspect_TypeOfMarker, aCallTOL: Aspect_TypeOfLine): void;
  delete(): void;
}
...
export declare class Select3D_Pnt {
  constructor();
  delete(): void;
}
...
export declare class SelectBasics {
  constructor();
  static MaxOwnerPriority(): Standard_Integer;
  static MinOwnerPriority(): Standard_Integer;
  delete(): void;
}

export declare class SelectMgr {
  constructor();
  static ComputeSensitivePrs(theStructure: any, theSel: any, theLoc: gp_Trsf, theTrsfPers: any): void;
  delete(): void;
}
...
export declare class SelectMgr_SelectionImageFiller extends Standard_Transient {
  static CreateFiller(thePixMap: Image_PixMap, theSelector: SelectMgr_ViewerSelector, theType: StdSelect_TypeOfSelectionImage): any;
...
export declare class StdPrs_Curve extends Prs3d_Root {
  constructor();
  static Add_1(aPresentation: any, aCurve: Adaptor3d_Curve, aDrawer: any, drawCurve: Standard_Boolean): void;
  static Add_2(aPresentation: any, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDrawer: any, drawCurve: Standard_Boolean): void;
  static Add_3(aPresentation: any, aCurve: Adaptor3d_Curve, aDrawer: any, Points: TColgp_SequenceOfPnt, drawCurve: Standard_Boolean): void;
  static Add_4(aPresentation: any, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, Points: TColgp_SequenceOfPnt, aNbPoints: Standard_Integer, drawCurve: Standard_Boolean): void;
  static Match_1(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, aDrawer: any): Standard_Boolean;
  static Match_2(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, aDeflection: Standard_Real, aLimit: Standard_Real, aNbPoints: Standard_Integer): Standard_Boolean;
  static Match_3(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDrawer: any): Standard_Boolean;
  static Match_4(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDeflection: Standard_Real, aNbPoints: Standard_Integer): Standard_Boolean;
  delete(): void;
}
...
export declare class StdPrs_DeflectionCurve extends Prs3d_Root {
  ...
  static Add_1(aPresentation: any, aCurve: Adaptor3d_Curve, aDrawer: any, drawCurve: Standard_Boolean): void;
  static Add_2(aPresentation: any, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDrawer: any, drawCurve: Standard_Boolean): void;
  static Add_3(aPresentation: any, aCurve: Adaptor3d_Curve, aDeflection: Standard_Real, aLimit: Standard_Real, anAngle: Standard_Real, drawCurve: Standard_Boolean): void;
  static Add_4(aPresentation: any, aCurve: Adaptor3d_Curve, aDeflection: Standard_Real, aDrawer: any, Points: TColgp_SequenceOfPnt, drawCurve: Standard_Boolean): void;
  static Add_5(aPresentation: any, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDeflection: Standard_Real, Points: TColgp_SequenceOfPnt, anAngle: Standard_Real, drawCurve: Standard_Boolean): void;
  static Match_1(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, aDrawer: any): Standard_Boolean;
  static Match_2(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDrawer: any): Standard_Boolean;
  static Match_3(theX: Standard_Real, theY: Standard_Real, theZ: Standard_Real, theDistance: Standard_Real, theCurve: Adaptor3d_Curve, theDeflection: Standard_Real, theLimit: Standard_Real, theAngle: Standard_Real): Standard_Boolean;
  static Match_4(theX: Standard_Real, theY: Standard_Real, theZ: Standard_Real, theDistance: Standard_Real, theCurve: Adaptor3d_Curve, theU1: Standard_Real, theU2: Standard_Real, theDeflection: Standard_Real, theAngle: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare class StdPrs_Isolines extends Prs3d_Root {
  constructor();
  static Add_1(thePresentation: any, theFace: TopoDS_Face, theDrawer: any, theDeflection: Standard_Real): void;
  static Add_2(theFace: TopoDS_Face, theDrawer: any, theDeflection: Standard_Real, theUPolylines: Prs3d_NListOfSequenceOfPnt, theVPolylines: Prs3d_NListOfSequenceOfPnt): void;
  static AddOnTriangulation_1(thePresentation: any, theFace: TopoDS_Face, theDrawer: any): void;
  static AddOnTriangulation_2(theFace: TopoDS_Face, theDrawer: any, theUPolylines: Prs3d_NListOfSequenceOfPnt, theVPolylines: Prs3d_NListOfSequenceOfPnt): void;
  static AddOnTriangulation_3(thePresentation: any, theTriangulation: any, theSurface: any, theLocation: TopLoc_Location, theDrawer: any, theUIsoParams: TColStd_SequenceOfReal, theVIsoParams: TColStd_SequenceOfReal): void;
  static AddOnSurface_1(thePresentation: any, theFace: TopoDS_Face, theDrawer: any, theDeflection: Standard_Real): void;
  static AddOnSurface_2(theFace: TopoDS_Face, theDrawer: any, theDeflection: Standard_Real, theUPolylines: Prs3d_NListOfSequenceOfPnt, theVPolylines: Prs3d_NListOfSequenceOfPnt): void;
  static AddOnSurface_3(thePresentation: any, theSurface: any, theDrawer: any, theDeflection: Standard_Real, theUIsoParams: TColStd_SequenceOfReal, theVIsoParams: TColStd_SequenceOfReal): void;
  static UVIsoParameters(theFace: TopoDS_Face, theNbIsoU: Standard_Integer, theNbIsoV: Standard_Integer, theUVLimit: Standard_Real, theUIsoParams: TColStd_SequenceOfReal, theVIsoParams: TColStd_SequenceOfReal, theUmin: Standard_Real, theUmax: Standard_Real, theVmin: Standard_Real, theVmax: Standard_Real): void;
  delete(): void;
}

export declare class StdPrs_Plane extends Prs3d_Root {
  constructor();
  static Add(aPresentation: any, aPlane: Adaptor3d_Surface, aDrawer: any): void;
  static Match(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aPlane: Adaptor3d_Surface, aDrawer: any): Standard_Boolean;
  delete(): void;
}

export declare class StdPrs_ToolPoint {
  constructor();
  static Coord(aPoint: any, X: Standard_Real, Y: Standard_Real, Z: Standard_Real): void;
  delete(): void;
}

export declare class StdPrs_PoleCurve extends Prs3d_Root {
  constructor();
  static Add(aPresentation: any, aCurve: Adaptor3d_Curve, aDrawer: any): void;
  static Match(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, aDrawer: any): Standard_Boolean;
  static Pick(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aCurve: Adaptor3d_Curve, aDrawer: any): Standard_Integer;
  delete(): void;
}

export declare class StdPrs_ShadedShape extends Prs3d_Root {
  constructor();
  static Add_1(thePresentation: any, theShape: TopoDS_Shape, theDrawer: any, theVolume: StdPrs_Volume): void;
  static Add_2(thePresentation: any, theShape: TopoDS_Shape, theDrawer: any, theHasTexels: Standard_Boolean, theUVOrigin: gp_Pnt2d, theUVRepeat: gp_Pnt2d, theUVScale: gp_Pnt2d, theVolume: StdPrs_Volume): void;
  static ExploreSolids(theShape: TopoDS_Shape, theBuilder: BRep_Builder, theClosed: TopoDS_Compound, theOpened: TopoDS_Compound, theIgnore1DSubShape: Standard_Boolean): void;
  static AddWireframeForFreeElements(thePrs: any, theShape: TopoDS_Shape, theDrawer: any): void;
  static AddWireframeForFacesWithoutTriangles(thePrs: any, theShape: TopoDS_Shape, theDrawer: any): void;
  static FillTriangles_1(theShape: TopoDS_Shape): any;
  static FillTriangles_2(theShape: TopoDS_Shape, theHasTexels: Standard_Boolean, theUVOrigin: gp_Pnt2d, theUVRepeat: gp_Pnt2d, theUVScale: gp_Pnt2d): any;
  static FillFaceBoundaries(theShape: TopoDS_Shape, theUpperContinuity: GeomAbs_Shape): any;
  delete(): void;
}

export declare class StdPrs_ShadedSurface extends Prs3d_Root {
  constructor();
  static Add(aPresentation: any, aSurface: Adaptor3d_Surface, aDrawer: any): void;
  delete(): void;
}
...
export declare class StdPrs_ToolVertex {
  constructor();
  static Coord(aPoint: TopoDS_Vertex, X: Standard_Real, Y: Standard_Real, Z: Standard_Real): void;
  delete(): void;
}

export declare class StdPrs_WFDeflectionRestrictedFace extends Prs3d_Root {
  constructor();
  static Add_1(aPresentation: any, aFace: any, aDrawer: any): void;
  static AddUIso(aPresentation: any, aFace: any, aDrawer: any): void;
  static AddVIso(aPresentation: any, aFace: any, aDrawer: any): void;
  static Add_2(aPresentation: any, aFace: any, DrawUIso: Standard_Boolean, DrawVIso: Standard_Boolean, Deflection: Standard_Real, NBUiso: Standard_Integer, NBViso: Standard_Integer, aDrawer: any, Curves: Prs3d_NListOfSequenceOfPnt): void;
  static Match_1(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aFace: any, aDrawer: any): Standard_Boolean;
  static MatchUIso(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aFace: any, aDrawer: any): Standard_Boolean;
  static MatchVIso(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aFace: any, aDrawer: any): Standard_Boolean;
  static Match_2(X: Standard_Real, Y: Standard_Real, Z: Standard_Real, aDistance: Standard_Real, aFace: any, aDrawer: any, DrawUIso: Standard_Boolean, DrawVIso: Standard_Boolean, aDeflection: Standard_Real, NBUiso: Standard_Integer, NBViso: Standard_Integer): Standard_Boolean;
  delete(): void;
}

export declare class StdPrs_WFDeflectionSurface extends Prs3d_Root {
  constructor();
  static Add(aPresentation: any, aSurface: any, aDrawer: any): void;
  delete(): void;
}
...
export declare class StdPrs_WFRestrictedFace extends Prs3d_Root {
  constructor();
  static Add_1(thePresentation: any, theFace: any, theDrawUIso: Standard_Boolean, theDrawVIso: Standard_Boolean, theNbUIso: Standard_Integer, theNbVIso: Standard_Integer, theDrawer: any, theCurves: Prs3d_NListOfSequenceOfPnt): void;
  static Add_2(thePresentation: any, theFace: any, theDrawer: any): void;
  static Match_1(theX: Standard_Real, theY: Standard_Real, theZ: Standard_Real, theDistance: Standard_Real, theFace: any, theDrawUIso: Standard_Boolean, theDrawVIso: Standard_Boolean, theDeflection: Standard_Real, theNbUIso: Standard_Integer, theNbVIso: Standard_Integer, theDrawer: any): Standard_Boolean;
  static Match_2(theX: Standard_Real, theY: Standard_Real, theZ: Standard_Real, theDistance: Standard_Real, theFace: any, theDrawer: any): Standard_Boolean;
  static MatchUIso(theX: Standard_Real, theY: Standard_Real, theZ: Standard_Real, theDistance: Standard_Real, theFace: any, theDrawer: any): Standard_Boolean;
  static MatchVIso(theX: Standard_Real, theY: Standard_Real, theZ: Standard_Real, theDistance: Standard_Real, theFace: any, theDrawer: any): Standard_Boolean;
  static AddUIso(thePresentation: any, theFace: any, theDrawer: any): void;
  static AddVIso(thePresentation: any, theFace: any, theDrawer: any): void;
  delete(): void;
}

export declare class StdPrs_WFShape extends Prs3d_Root {
  constructor();
  static Add(thePresentation: any, theShape: TopoDS_Shape, theDrawer: any, theIsParallel: Standard_Boolean): void;
  static AddEdgesOnTriangulation_1(theShape: TopoDS_Shape, theToExcludeGeometric: Standard_Boolean): any;
  static AddEdgesOnTriangulation_2(theSegments: TColgp_SequenceOfPnt, theShape: TopoDS_Shape, theToExcludeGeometric: Standard_Boolean): void;
  static AddAllEdges(theShape: TopoDS_Shape, theDrawer: any): any;
  static AddVertexes(theShape: TopoDS_Shape, theVertexMode: Prs3d_VertexDrawMode): any;
  delete(): void;
}
...
export declare class StdSelect {
  constructor();
  static SetDrawerForBRepOwner(aSelection: any, aDrawer: any): void;
  delete(): void;
}
...
export declare class StdSelect_BRepSelectionTool {
  constructor();
  static Load_1(aSelection: any, aShape: TopoDS_Shape, aType: TopAbs_ShapeEnum, theDeflection: Standard_Real, theDeviationAngle: Standard_Real, AutoTriangulation: Standard_Boolean, aPriority: Standard_Integer, NbPOnEdge: Standard_Integer, MaximalParameter: Standard_Real): void;
  static Load_2(aSelection: any, Origin: any, aShape: TopoDS_Shape, aType: TopAbs_ShapeEnum, theDeflection: Standard_Real, theDeviationAngle: Standard_Real, AutoTriangulation: Standard_Boolean, aPriority: Standard_Integer, NbPOnEdge: Standard_Integer, MaximalParameter: Standard_Real): void;
  static GetStandardPriority(theShape: TopoDS_Shape, theType: TopAbs_ShapeEnum): Standard_Integer;
  static ComputeSensitive(theShape: TopoDS_Shape, theOwner: any, theSelection: any, theDeflection: Standard_Real, theDeflAngle: Standard_Real, theNbPOnEdge: Standard_Integer, theMaxiParam: Standard_Real, theAutoTriang: Standard_Boolean): void;
  static GetSensitiveForFace(theFace: TopoDS_Face, theOwner: any, theOutList: Select3D_EntitySequence, theAutoTriang: Standard_Boolean, theNbPOnEdge: Standard_Integer, theMaxiParam: Standard_Real, theInteriorFlag: Standard_Boolean): Standard_Boolean;
  static GetEdgeSensitive(theShape: TopoDS_Shape, theOwner: any, theSelection: any, theDeflection: Standard_Real, theDeviationAngle: Standard_Real, theNbPOnEdge: Standard_Integer, theMaxiParam: Standard_Real, theSensitive: any): void;
  static PreBuildBVH(theSelection: any): void;
  delete(): void;
}
...
export declare class V3d {
  constructor();
  static GetProjAxis(theOrientation: V3d_TypeOfOrientation): gp_Dir;
  static ArrowOfRadius(garrow: any, X0: Standard_Real, Y0: Standard_Real, Z0: Standard_Real, DX: Standard_Real, DY: Standard_Real, DZ: Standard_Real, Alpha: Standard_Real, Lng: Standard_Real): void;
  static CircleInPlane(gcircle: any, X0: Standard_Real, Y0: Standard_Real, Z0: Standard_Real, VX: Standard_Real, VY: Standard_Real, VZ: Standard_Real, Radius: Standard_Real): void;
  static SwitchViewsinWindow(aPreviousView: any, aNextView: any): void;
  static TypeOfOrientationToString(theType: V3d_TypeOfOrientation): Standard_CString;
  static TypeOfOrientationFromString_1(theTypeString: Standard_CString): V3d_TypeOfOrientation;
  static TypeOfOrientationFromString_2(theTypeString: Standard_CString, theType: V3d_TypeOfOrientation): Standard_Boolean;
  delete(): void;
}
...
export declare class V3d_DirectionalLight extends V3d_PositionLight {
  ...
  SetDirection_2(theDir: gp_Dir): void;
  SetDirection_3(theVx: Standard_Real, theVy: Standard_Real, theVz: Standard_Real): void;
  delete(): void;
}
...
export declare type module_TKV3d_wasm = {
  AIS: typeof AIS;
  ...
  SelectBasics_PickResult: typeof SelectBasics_PickResult;
  SelectBasics_PickResult_1: typeof SelectBasics_PickResult_1;
  SelectBasics_PickResult_2: typeof SelectBasics_PickResult_2;
  ...
  AIS_InteractiveObject: typeof AIS_InteractiveObject;
  ...
  PrsDim_AngleDimension: typeof PrsDim_AngleDimension;
  ...
  AIS_AnimationProgress: typeof AIS_AnimationProgress;
  AIS_Animation: typeof AIS_Animation;
  AIS_AnimationCamera: typeof AIS_AnimationCamera;
  AIS_GlobalStatus: typeof AIS_GlobalStatus;
  ...
  AIS_AttributeFilter: typeof AIS_AttributeFilter;
  ...
  PrsDim_Relation: typeof PrsDim_Relation;
  ...
  AIS_ColoredShape: typeof AIS_ColoredShape;
  ...
  PrsDim_DiameterDimension: typeof PrsDim_DiameterDimension;
  ...
  PrsDim_EllipseRadiusDimension: typeof PrsDim_EllipseRadiusDimension;
  ...
  AIS_ExclusionFilter: typeof AIS_ExclusionFilter;
  ...
  PrsDim_FixRelation: typeof PrsDim_FixRelation;
  ...
  AIS_GraphicTool: typeof AIS_GraphicTool;
  PrsDim_IdenticRelation: typeof PrsDim_IdenticRelation;
  PrsDim_LengthDimension: typeof PrsDim_LengthDimension;
  ...
  AIS_Line: typeof AIS_Line;
  AIS_Line_1: typeof AIS_Line_1;
  AIS_Line_2: typeof AIS_Line_2;
  V3d_ImageDumpOptions: typeof V3d_ImageDumpOptions;
  ...
  AIS_Manipulator: typeof AIS_Manipulator;
  ...
  PrsDim_MaxRadiusDimension: typeof PrsDim_MaxRadiusDimension;
  ...
  PrsDim_MinRadiusDimension: typeof PrsDim_MinRadiusDimension;
  ...
  PrsDim_ParallelRelation: typeof PrsDim_ParallelRelation;
  PrsDim_ParallelRelation_1: typeof PrsDim_ParallelRelation_1;
  PrsDim_ParallelRelation_2: typeof PrsDim_ParallelRelation_2;
  PrsDim_PerpendicularRelation: typeof PrsDim_PerpendicularRelation;
  ...
  PrsDim_RadiusDimension: typeof PrsDim_RadiusDimension;
  ...
  AIS_RubberBand: typeof AIS_RubberBand;
  ...
  Prs3d_BndBox: typeof Prs3d_BndBox;
  ...
  Prs3d_ToolTorus: typeof Prs3d_ToolTorus;
  ...
  SelectMgr_SelectionImageFiller: typeof SelectMgr_SelectionImageFiller;
  ...
  StdPrs_HLRShapeI: typeof StdPrs_HLRShapeI;

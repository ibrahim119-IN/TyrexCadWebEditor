declare const libName = "./module.TKVRML.wasm.d.ts";
...
export declare class VrmlAPI {
  constructor();
  static Write(aShape: TopoDS_Shape, aFileName: Standard_CString, aVersion: Standard_Integer): Standard_Boolean;
  delete(): void;
}
...
export declare class VrmlConverter_Curve {
  constructor();
  static Add_1(aCurve: Adaptor3d_Curve, aDrawer: any, anOStream: Standard_OStream): void;
  static Add_2(aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDrawer: any, anOStream: Standard_OStream): void;
  static Add_3(aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, anOStream: Standard_OStream, aNbPoints: Standard_Integer): void;
  delete(): void;
}

export declare class VrmlConverter_DeflectionCurve {
  constructor();
  static Add_1(anOStream: Standard_OStream, aCurve: Adaptor3d_Curve, aDrawer: any): void;
  static Add_2(anOStream: Standard_OStream, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDrawer: any): void;
  static Add_3(anOStream: Standard_OStream, aCurve: Adaptor3d_Curve, aDeflection: Standard_Real, aLimit: Standard_Real): void;
  static Add_4(anOStream: Standard_OStream, aCurve: Adaptor3d_Curve, aDeflection: Standard_Real, aDrawer: any): void;
  static Add_5(anOStream: Standard_OStream, aCurve: Adaptor3d_Curve, U1: Standard_Real, U2: Standard_Real, aDeflection: Standard_Real): void;
  static Add_6(anOStream: Standard_OStream, aCurve: Adaptor3d_Curve, aParams: any, aNbNodes: Standard_Integer, aDrawer: any): void;
  delete(): void;
}
...
export declare class VrmlConverter_HLRShape {
  constructor();
  static Add(anOStream: Standard_OStream, aShape: TopoDS_Shape, aDrawer: any, aProjector: any): void;
  delete(): void;
}
...
export declare class VrmlConverter_ShadedShape {
  constructor();
  static Add(anOStream: Standard_OStream, aShape: TopoDS_Shape, aDrawer: any): void;
  static ComputeNormal(aFace: TopoDS_Face, pc: Poly_Connect, Nor: TColgp_Array1OfDir): void;
  delete(): void;
}
...
export declare class VrmlConverter_WFDeflectionRestrictedFace {
  constructor();
  static Add_1(anOStream: Standard_OStream, aFace: any, aDrawer: any): void;
  static AddUIso(anOStream: Standard_OStream, aFace: any, aDrawer: any): void;
  static AddVIso(anOStream: Standard_OStream, aFace: any, aDrawer: any): void;
  static Add_2(anOStream: Standard_OStream, aFace: any, DrawUIso: Standard_Boolean, DrawVIso: Standard_Boolean, Deflection: Standard_Real, NBUiso: Standard_Integer, NBViso: Standard_Integer, aDrawer: any): void;
  delete(): void;
}
...
export declare class VrmlConverter_WFRestrictedFace {
  ...
  static AddUIso(anOStream: Standard_OStream, aFace: any, aDrawer: any): void;
  static AddVIso(anOStream: Standard_OStream, aFace: any, aDrawer: any): void;
  static Add_2(anOStream: Standard_OStream, aFace: any, DrawUIso: Standard_Boolean, DrawVIso: Standard_Boolean, NBUiso: Standard_Integer, NBViso: Standard_Integer, aDrawer: any): void;
  delete(): void;
}
...
export declare class VrmlData_Node extends Standard_Transient {
  ...
  Clone(a0: any): any;
  static ReadBoolean(theBuffer: VrmlData_InBuffer, theResult: Standard_Boolean): VrmlData_ErrorStatus;
  static ReadString(theBuffer: VrmlData_InBuffer, theRes: TCollection_AsciiString): VrmlData_ErrorStatus;
  static ReadMultiString(theBuffer: VrmlData_InBuffer, theRes: NCollection_List<TCollection_AsciiString>): VrmlData_ErrorStatus;
  static ReadInteger(theBuffer: VrmlData_InBuffer, theResult: long): VrmlData_ErrorStatus;
  static OK_1(theStat: VrmlData_ErrorStatus): Standard_Boolean;
  static OK_2(outStat: VrmlData_ErrorStatus, theStat: VrmlData_ErrorStatus): Standard_Boolean;
  static GlobalIndent(): Standard_Integer;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class VrmlData_InBuffer {
  constructor(theStream: Standard_IStream)
  delete(): void;
}
...
export declare type module_TKVRML_wasm = {
  Vrml: typeof Vrml;
  ...
  VrmlData_Node: typeof VrmlData_Node;
  ...
  VrmlData_InBuffer: typeof VrmlData_InBuffer;

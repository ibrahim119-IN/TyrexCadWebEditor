declare const libName = "./module.TKXSBase.wasm.d.ts";
...
export declare class Interface_Protocol extends Standard_Transient {
  static Active(): any;
  static SetActive(aprotocol: any): void;
...
export declare class Interface_InterfaceModel extends Standard_Transient {
  ...
  static Template(name: Standard_CString): any;
  static SetTemplate(name: Standard_CString, model: any): Standard_Boolean;
  static ListTemplates(): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class IFSelect {
  constructor();
  static SaveSession(WS: any, file: Standard_CString): Standard_Boolean;
  static RestoreSession(WS: any, file: Standard_CString): Standard_Boolean;
  delete(): void;
}

export declare class IFSelect_Activator extends Standard_Transient {
  static Adding(actor: any, number: Standard_Integer, command: Standard_CString, mode: Standard_Integer): void;
  Add(number: Standard_Integer, command: Standard_CString): void;
  AddSet(number: Standard_Integer, command: Standard_CString): void;
  static Remove(command: Standard_CString): void;
  static Select(command: Standard_CString, number: Standard_Integer, actor: any): Standard_Boolean;
  static Mode(command: Standard_CString): Standard_Integer;
  static Commands(mode: Standard_Integer, command: Standard_CString): any;
...
export declare class IFSelect_Act extends IFSelect_Activator {
  ...
  Do(number: Standard_Integer, pilot: any): IFSelect_ReturnStatus;
  Help(number: Standard_Integer): Standard_CString;
  static SetGroup(group: Standard_CString, file: Standard_CString): void;
  static AddFunc(name: Standard_CString, help: Standard_CString, func: IFSelect_ActFunc): void;
  static AddFSet(name: Standard_CString, help: Standard_CString, func: IFSelect_ActFunc): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class IFSelect_Functions {
  constructor();
  static GiveEntity(WS: any, name: Standard_CString): any;
  static GiveEntityNumber(WS: any, name: Standard_CString): Standard_Integer;
  static GiveList(WS: any, first: Standard_CString, second: Standard_CString): any;
  static GiveDispatch(WS: any, name: Standard_CString, mode: Standard_Boolean): any;
  static Init(): void;
  delete(): void;
}
...
export declare class IFSelect_ParamEditor extends IFSelect_Editor {
  ...
  Load(form: any, ent: any, model: any): Standard_Boolean;
  Apply(form: any, ent: any, model: any): Standard_Boolean;
  static StaticEditor(list: any, label: Standard_CString): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class IFSelect_Signature extends Interface_SignType {
  ...
  static MatchValue(val: Standard_CString, text: TCollection_AsciiString, exact: Standard_Boolean): Standard_Boolean;
  static IntValue(val: Standard_Integer): Standard_CString;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class IFSelect_SignValidity extends IFSelect_Signature {
  constructor()
  static CVal(ent: any, model: any): Standard_CString;
  Value(ent: any, model: any): Standard_CString;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class Interface_GeneralLib {
  static SetGlobal(amodule: any, aprotocol: any): void;
...
export declare class Transfer_FindHasher {
  constructor();
  static HashCode(theFinder: any, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(K1: any, K2: any): Standard_Boolean;
  delete(): void;
}
...
export declare class XSControl_Controller extends Standard_Transient {
  ...
  static Recorded(name: Standard_CString): any;
...
export declare class Interface_MSG {
  ...
  static Read_1(S: Standard_IStream): Standard_Integer;
  static Read_2(file: Standard_CString): Standard_Integer;
  static Write(S: Standard_OStream, rootkey: Standard_CString): Standard_Integer;
  static IsKey(mess: Standard_CString): Standard_Boolean;
  static Translated(key: Standard_CString): Standard_CString;
  static Record(key: Standard_CString, item: Standard_CString): void;
  static SetTrace(toprint: Standard_Boolean, torecord: Standard_Boolean): void;
  static SetMode(running: Standard_Boolean, raising: Standard_Boolean): void;
  static PrintTrace(S: Standard_OStream): void;
  static Intervalled(val: Standard_Real, order: Standard_Integer, upper: Standard_Boolean): Standard_Real;
  static TDate(text: Standard_CString, yy: Standard_Integer, mm: Standard_Integer, dd: Standard_Integer, hh: Standard_Integer, mn: Standard_Integer, ss: Standard_Integer, format: Standard_CString): void;
  static NDate(text: Standard_CString, yy: Standard_Integer, mm: Standard_Integer, dd: Standard_Integer, hh: Standard_Integer, mn: Standard_Integer, ss: Standard_Integer): Standard_Boolean;
  static CDate(text1: Standard_CString, text2: Standard_CString): Standard_Integer;
  static Blanks_1(val: Standard_Integer, max: Standard_Integer): Standard_CString;
  static Blanks_2(val: Standard_CString, max: Standard_Integer): Standard_CString;
  static Blanks_3(count: Standard_Integer): Standard_CString;
  static Print(S: Standard_OStream, val: Standard_CString, max: Standard_Integer, just: Standard_Integer): void;
  delete(): void;
}
...
export declare class Interface_FloatWriter {
  ...
  static Convert(val: Standard_Real, text: Standard_CString, zerosup: Standard_Boolean, Range1: Standard_Real, Range2: Standard_Real, mainform: Standard_CString, rangeform: Standard_CString): Standard_Integer;
  delete(): void;
}
...
export declare class Interface_Category {
  ...
  static AddCategory(theName: Standard_CString): Standard_Integer;
  static NbCategories(): Standard_Integer;
  static Name(theNum: Standard_Integer): Standard_CString;
  static Number(theName: Standard_CString): Standard_Integer;
  static Init(): void;
  delete(): void;
}
...
export declare class Interface_MapAsciiStringHasher {
  ...
  static IsEqual(K1: TCollection_AsciiString, K2: TCollection_AsciiString): Standard_Boolean;
  delete(): void;
}
...
export declare class Interface_STAT {
  ...
  static StartCount(items: Standard_Integer, title: Standard_CString): void;
  static NextPhase(items: Standard_Integer, cycles: Standard_Integer): void;
  static SetPhase(items: Standard_Integer, cycles: Standard_Integer): void;
  static NextCycle(items: Standard_Integer): void;
  static NextStep(): void;
  static NextItem(nbitems: Standard_Integer): void;
  static End(): void;
  static Where(phase: Standard_Boolean): Standard_CString;
  static Percent(phase: Standard_Boolean): Standard_Integer;
  delete(): void;
}
...
export declare class MoniTool_TypedValue extends Standard_Transient {
  ...
  static AddLib(tv: any, def: Standard_CString): Standard_Boolean;
  static Lib(def: Standard_CString): any;
  static FromLib(def: Standard_CString): any;
  static LibList(): any;
  static StaticValue(name: Standard_CString): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class Interface_Static extends Interface_TypedValue {
  ...
  static Static(name: Standard_CString): any;
  ...
  static IDef(name: Standard_CString, part: Standard_CString): Standard_Integer;
  ...
  static IVal(name: Standard_CString): Standard_Integer;
  ...
  static SetIVal(name: Standard_CString, val: Standard_Integer): Standard_Boolean;
  ...
  static Items(mode: Standard_Integer, criter: Standard_CString): any;
...
export declare class MoniTool_CaseData extends Standard_Transient {
  ...
  Msg(): Message_Msg;
  static SetDefWarning(acode: Standard_CString): void;
  static SetDefFail(acode: Standard_CString): void;
  static DefCheck(acode: Standard_CString): Standard_Integer;
  static SetDefMsg(casecode: Standard_CString, mesdef: Standard_CString): void;
  static DefMsg(casecode: Standard_CString): Standard_CString;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class MoniTool_DataInfo {
  constructor();
  static Type(ent: any): any;
  static TypeName(ent: any): Standard_CString;
  delete(): void;
}

export declare class MoniTool_MTHasher {
  constructor();
  static HashCode(theString: Standard_CString, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(Str1: Standard_CString, Str2: Standard_CString): Standard_Boolean;
  delete(): void;
}

export declare class MoniTool_ElemHasher {
  constructor();
  static HashCode(theElement: any, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(K1: any, K2: any): Standard_Boolean;
  delete(): void;
}
...
export declare class MoniTool_Timer extends Standard_Transient {
  ...
  static Timer_3(name: Standard_CString): any;
  static Start_2(name: Standard_CString): void;
  static Stop_2(name: Standard_CString): void;
  static Dictionary(): MoniTool_DataMapOfTimer;
  static ClearTimers(): void;
  static DumpTimers(ostr: Standard_OStream): void;
  static ComputeAmendments(): void;
  static GetAmendments(Access: Standard_Real, Internal: Standard_Real, External: Standard_Real, Error10: Standard_Real): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class StepData_StepReaderData extends Interface_FileReaderData {
...
export declare class StepData {
  constructor();
  static HeaderProtocol(): any;
  static AddHeaderProtocol(headerproto: any): void;
  static Init(): void;
  static Protocol(): any;
  delete(): void;
}
...
export declare class Transfer_SimpleBinderOfTransient extends Transfer_Binder {
  ...
  Result(): any;
  static GetTypedResult(bnd: any, atype: any, res: any): Standard_Boolean;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class TransferBRep_ShapeInfo {
  constructor();
  static Type(ent: TopoDS_Shape): any;
  static TypeName(ent: TopoDS_Shape): Standard_CString;
  delete(): void;
}
...
export declare class UnitsMethods {
  constructor();
  static InitializeFactors(LengthFactor: Standard_Real, PlaneAngleFactor: Standard_Real, SolidAngleFactor: Standard_Real): void;
  static LengthFactor(): Standard_Real;
  static PlaneAngleFactor(): Standard_Real;
  static SolidAngleFactor(): Standard_Real;
  static Set3dConversion(B: Standard_Boolean): void;
  static Convert3d(): Standard_Boolean;
  static RadianToDegree(C: any, S: any): any;
  static DegreeToRadian(C: any, S: any): any;
  static MirrorPCurve(C: any): any;
  static GetLengthFactorValue(param: Standard_Integer): Standard_Real;
  static GetCasCadeLengthUnit(): Standard_Real;
  static SetCasCadeLengthUnit(param: Standard_Integer): void;
  delete(): void;
}
...
export declare class XSAlgo {
  constructor();
  static Init(): void;
  static SetAlgoContainer(aContainer: any): void;
  static AlgoContainer(): any;
  delete(): void;
}
...
export declare class XSControl {
  constructor();
  static Session(pilot: any): any;
  static Vars(pilot: any): any;
  delete(): void;
}
...
export declare class XSControl_ConnectedShapes extends IFSelect_SelectExplore {
  ...
  Explore(level: Standard_Integer, ent: any, G: Interface_Graph, explored: Interface_EntityIterator): Standard_Boolean;
  ExploreLabel(): TCollection_AsciiString;
  static AdjacentEntities(ashape: TopoDS_Shape, TP: any, type: TopAbs_ShapeEnum): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class XSControl_FuncShape {
  constructor();
  static Init(): void;
  static MoreShapes(session: any, list: any, name: Standard_CString): Standard_Integer;
  static FileAndVar(session: any, file: Standard_CString, var_: Standard_CString, def: Standard_CString, resfile: TCollection_AsciiString, resvar: TCollection_AsciiString): Standard_Boolean;
  delete(): void;
}
...
export declare class XSControl_TransferReader extends Standard_Transient {
  ...
  static PrintStatsProcess(theTP: any, theWhat: Standard_Integer, theMode: Standard_Integer): void;
  static PrintStatsOnList(theTP: any, theList: any, theWhat: Standard_Integer, theMode: Standard_Integer): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare type module_TKXSBase_wasm = {

declare const libName = "./module.TKService.wasm.d.ts";
...
export declare class Image_ColorRGB {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_Byte;
  g_1(): Standard_Byte;
  b_1(): Standard_Byte;
  r_2(): Standard_Byte;
...
export declare class Image_ColorRGB32 {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_Byte;
  g_1(): Standard_Byte;
...
export declare class Image_ColorRGBA {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_Byte;
  g_1(): Standard_Byte;
...
export declare class Image_ColorBGR {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_Byte;
  g_1(): Standard_Byte;
...
export declare class Image_ColorBGR32 {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_Byte;
  g_1(): Standard_Byte;
...
export declare class Image_ColorBGRA {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_Byte;
  g_1(): Standard_Byte;
...
export declare class Image_ColorRGF {
  constructor();
  static Length(): Standard_Integer;
...
export declare class Image_ColorRGBF {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_ShortReal;
  g_1(): Standard_ShortReal;
...
export declare class Image_ColorBGRF {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_ShortReal;
  g_1(): Standard_ShortReal;
...
export declare class Image_ColorRGBAF {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_ShortReal;
  g_1(): Standard_ShortReal;
...
export declare class Image_ColorBGRAF {
  constructor();
  static Length(): Standard_Integer;
  r_1(): Standard_ShortReal;
  g_1(): Standard_ShortReal;
...
export declare class Image_PixMap extends Standard_Transient {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static IsBigEndianHost(): boolean;
  static SwapRgbaBgra(theImage: Image_PixMap): boolean;
  static ToBlackWhite(theImage: Image_PixMap): void;
  static DefaultAllocator(): any;
  Format(): Image_Format;
  ...
  static SizePixelBytes_2(thePixelFormat: Image_Format): Standard_Size;
...
export declare class Graphic3d_Fresnel {
  constructor()
  static CreateSchlick(theSpecularColor: Graphic3d_Vec3): Graphic3d_Fresnel;
  static CreateConstant(theReflection: Standard_ShortReal): Graphic3d_Fresnel;
  static CreateDielectric(theRefractionIndex: Standard_ShortReal): Graphic3d_Fresnel;
  static CreateConductor_1(theRefractionIndex: Standard_ShortReal, theAbsorptionIndex: Standard_ShortReal): Graphic3d_Fresnel;
  static CreateConductor_2(theRefractionIndex: Graphic3d_Vec3, theAbsorptionIndex: Graphic3d_Vec3): Graphic3d_Fresnel;
...
export declare class Graphic3d_BSDF {
  constructor()
  static CreateDiffuse(theWeight: Graphic3d_Vec3): Graphic3d_BSDF;
  static CreateMetallic(theWeight: Graphic3d_Vec3, theFresnel: Graphic3d_Fresnel, theRoughness: Standard_ShortReal): Graphic3d_BSDF;
  static CreateTransparent(theWeight: Graphic3d_Vec3, theAbsorptionColor: Graphic3d_Vec3, theAbsorptionCoeff: Standard_ShortReal): Graphic3d_BSDF;
  static CreateGlass(theWeight: Graphic3d_Vec3, theAbsorptionColor: Graphic3d_Vec3, theAbsorptionCoeff: Standard_ShortReal, theRefractionIndex: Standard_ShortReal): Graphic3d_BSDF;
  static CreateMetallicRoughness(thePbr: Graphic3d_PBRMaterial): Graphic3d_BSDF;
  Normalize(): void;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  delete(): void;
}
...
export declare class Graphic3d_PBRMaterial {
  ...
  static Roughness_1(theNormalizedRoughness: Standard_ShortReal): Standard_ShortReal;
  ...
  static GenerateEnvLUT(theLUT: any, theNbIntegralSamples: number): void;
  static RoughnessFromSpecular(theSpecular: Quantity_Color, theShiness: Standard_Real): Standard_ShortReal;
  static MetallicFromSpecular(theSpecular: Quantity_Color): Standard_ShortReal;
  static MinRoughness(): Standard_ShortReal;
  static SpecIBLMapSamplesFactor(theProbability: Standard_ShortReal, theRoughness: Standard_ShortReal): Standard_ShortReal;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  delete(): void;
}
...
export declare class Graphic3d_MaterialAspect {
  static NumberOfMaterials(): Standard_Integer;
  static MaterialName_1(theRank: Standard_Integer): Standard_CString;
  static MaterialType_1(theRank: Standard_Integer): Graphic3d_TypeOfMaterial;
  static MaterialFromName_1(theName: Standard_CString, theMat: Graphic3d_NameOfMaterial): Standard_Boolean;
  static MaterialFromName_2(theName: Standard_CString): Graphic3d_NameOfMaterial;
...
export declare class Graphic3d_PolygonOffset {
  constructor()
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  delete(): void;
}
...
export declare class Graphic3d_ShaderObject extends Standard_Transient {
  ...
  static CreateFromFile(theType: Graphic3d_TypeOfShaderObject, thePath: TCollection_AsciiString): any;
  static CreateFromSource(theType: Graphic3d_TypeOfShaderObject, theSource: TCollection_AsciiString): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class Graphic3d_ValueInterface {
  TypeID(): Standard_Size;
  delete(): void;
}
...
export declare class Graphic3d_ShaderProgram extends Standard_Transient {
  ...
  static ShadersFolder(): TCollection_AsciiString;
  delete(): void;
}
...
export declare class Graphic3d_TextureRoot extends Standard_Transient {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static TexturesFolder(): TCollection_AsciiString;
  IsDone(): Standard_Boolean;
  Path(): OSD_Path;
...
export declare class Graphic3d_Aspects extends Standard_Transient {
  ...
  static DefaultLinePatternForType(theType: Aspect_TypeOfLine): uint16_t;
  static DefaultLineTypeForPattern(thePattern: uint16_t): Aspect_TypeOfLine;
...
export declare class Graphic3d_BufferRange {
  IsEmpty(): Standard_Boolean;
  Upper(): Standard_Integer;
  Clear(): void;
  Unite(theRange: Graphic3d_BufferRange): void;
  delete(): void;
}

  export declare class Graphic3d_BufferRange_1 extends Graphic3d_BufferRange {
    constructor();
  }

  export declare class Graphic3d_BufferRange_2 extends Graphic3d_BufferRange {
    constructor(theStart: Standard_Integer, theLength: Standard_Integer);
  }

export declare class Graphic3d_Attribute {
  constructor();
  Stride_1(): Standard_Integer;
  static Stride_2(theType: Graphic3d_TypeOfData): Standard_Integer;
  delete(): void;
}
...
export declare class Graphic3d_Buffer extends NCollection_Buffer {
  ...
  Data_2(): Standard_Byte;
  ChangeData_2(): Standard_Byte;
...
export declare class Graphic3d_TransformPers extends Standard_Transient {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static IsZoomOrRotate_1(theMode: Graphic3d_TransModeFlags): Standard_Boolean;
  static IsTrihedronOr2d_1(theMode: Graphic3d_TransModeFlags): Standard_Boolean;
  static FromDeprecatedParams(theFlag: Graphic3d_TransModeFlags, thePoint: gp_Pnt): any;
...
export declare class Graphic3d_Structure extends Standard_Transient {
  ...
  static AcceptConnection(theStructure1: Graphic3d_Structure, theStructure2: Graphic3d_Structure, theType: Graphic3d_TypeOfConnection): Standard_Boolean;
  ...
  RemoveAll(): void;
  static Network(theStructure: Graphic3d_Structure, theType: Graphic3d_TypeOfConnection, theSet: NCollection_Map<Graphic3d_Structure >): void;
  ...
  static PrintNetwork(AStructure: any, AType: Graphic3d_TypeOfConnection): void;
  ...
  static Transforms(theTrsf: gp_Trsf, theX: Standard_Real, theY: Standard_Real, theZ: Standard_Real, theNewX: Standard_Real, theNewY: Standard_Real, theNewZ: Standard_Real): void;
  CStructure(): any;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  delete(): void;
}
...
export declare class Graphic3d_CubeMapOrder {
  ...
  IsValid(): boolean;
  static Default(): Graphic3d_ValidatedCubeMapOrder;
  delete(): void;
}
...
export declare class Graphic3d_Texture2D extends Graphic3d_TextureMap {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static NumberOfTextures(): Standard_Integer;
  static TextureName(theRank: Standard_Integer): TCollection_AsciiString;
...
export declare class Graphic3d_ZLayerSettings {
  constructor()
  Name(): TCollection_AsciiString;
  SetName(theName: TCollection_AsciiString): void;
  Lights(): any;
  ...
  Origin(): gp_XYZ;
  OriginTransformation(): any;
  SetOrigin(theOrigin: gp_XYZ): void;
  HasCullingDistance(): Standard_Boolean;
  CullingDistance(): Standard_Real;
  SetCullingDistance(theDistance: Standard_Real): void;
  HasCullingSize(): Standard_Boolean;
  CullingSize(): Standard_Real;
  SetCullingSize(theSize: Standard_Real): void;
  IsImmediate(): Standard_Boolean;
  SetImmediate(theValue: Standard_Boolean): void;
  IsRaytracable(): Standard_Boolean;
  SetRaytracable(theToRaytrace: Standard_Boolean): void;
  UseEnvironmentTexture(): Standard_Boolean;
  SetEnvironmentTexture(theValue: Standard_Boolean): void;
  ToEnableDepthTest(): Standard_Boolean;
  SetEnableDepthTest(theValue: Standard_Boolean): void;
  ToEnableDepthWrite(): Standard_Boolean;
  SetEnableDepthWrite(theValue: Standard_Boolean): void;
  ToClearDepth(): Standard_Boolean;
  SetClearDepth(theValue: Standard_Boolean): void;
  ToRenderInDepthPrepass(): Standard_Boolean;
  SetRenderInDepthPrepass(theToRender: Standard_Boolean): void;
  PolygonOffset(): Graphic3d_PolygonOffset;
  SetPolygonOffset(theParams: Graphic3d_PolygonOffset): void;
  ChangePolygonOffset(): Graphic3d_PolygonOffset;
  IsSettingEnabled(theSetting: Graphic3d_ZLayerSetting): Standard_Boolean;
  EnableSetting(theSetting: Graphic3d_ZLayerSetting): void;
  DisableSetting(theSetting: Graphic3d_ZLayerSetting): void;
...
export declare class Graphic3d_ArrayOfPrimitives extends Standard_Transient {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static CreateArray_1(theType: Graphic3d_TypeOfPrimitiveArray, theMaxVertexs: Standard_Integer, theMaxEdges: Standard_Integer, theArrayFlags: Graphic3d_ArrayFlags): any;
  static CreateArray_2(theType: Graphic3d_TypeOfPrimitiveArray, theMaxVertexs: Standard_Integer, theMaxBounds: Standard_Integer, theMaxEdges: Standard_Integer, theArrayFlags: Graphic3d_ArrayFlags): any;
  Attributes(): any;
...
export declare class Aspect_XRHapticActionData {
  constructor()
  IsValid(): boolean;
  delete(): void;
}

export declare class Aspect_ScrollDelta {
  HasPoint(): boolean;
  ResetPoint(): void;
  delete(): void;
}

  export declare class Aspect_ScrollDelta_1 extends Aspect_ScrollDelta {
    constructor();
  }

  export declare class Aspect_ScrollDelta_2 extends Aspect_ScrollDelta {
    constructor(thePnt: NCollection_Vec2<int>, theValue: Standard_Real, theFlags: Aspect_VKeyFlags);
  }

  export declare class Aspect_ScrollDelta_3 extends Aspect_ScrollDelta {
    constructor(theValue: Standard_Real, theFlags: Aspect_VKeyFlags);
  }
...
export declare class Aspect_XRAnalogActionData {
  constructor()
  IsChanged(): boolean;
  delete(): void;
}

export declare class Aspect_XRDigitalActionData {
  constructor()
  delete(): void;
}

export declare class Aspect_TrackedDevicePose {
  constructor()
  delete(): void;
}

export declare class Aspect_XRPoseActionData {
  constructor()
  delete(): void;
}
...
export declare class Font_Rect {
  constructor();
  TopLeft_1(): NCollection_Vec2<float>;
  TopLeft_2(theVec: NCollection_Vec2<float>): NCollection_Vec2<float>;
  TopRight(theVec: NCollection_Vec2<float>): NCollection_Vec2<float>;
  BottomLeft(theVec: NCollection_Vec2<float>): NCollection_Vec2<float>;
  BottomRight(theVec: NCollection_Vec2<float>): NCollection_Vec2<float>;
  Width(): number;
  Height(): number;
  DumpJson(theOStream: Standard_OStream, a1: Standard_Integer): void;
  delete(): void;
...
export declare class Font_FTFontParams {
  delete(): void;
}

  export declare class Font_FTFontParams_1 extends Font_FTFontParams {
    constructor();
  }

  export declare class Font_FTFontParams_2 extends Font_FTFontParams {
    constructor(thePointSize: number, theResolution: number);
  }
...
export declare class Font_FTFont extends Standard_Transient {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static FindAndCreate(theFontName: TCollection_AsciiString, theFontAspect: Font_FontAspect, theParams: Font_FTFontParams, theStrictLevel: Font_StrictLevel): any;
  static IsCharFromCJK(theUChar: Standard_Utf32Char): boolean;
  static IsCharFromHiragana(theUChar: Standard_Utf32Char): boolean;
  static IsCharFromKatakana(theUChar: Standard_Utf32Char): boolean;
  static IsCharFromKorean(theUChar: Standard_Utf32Char): boolean;
  static IsCharFromArabic(theUChar: Standard_Utf32Char): boolean;
  static IsCharRightToLeft(theUChar: Standard_Utf32Char): boolean;
  static CharSubset(theUChar: Standard_Utf32Char): Font_UnicodeSubset;
  IsValid(): boolean;
...
export declare class Font_TextFormatter extends Standard_Transient {
  ...
  static IsCommandSymbol(theSymbol: Standard_Utf32Char): Standard_Boolean;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class Font_SystemFont extends Standard_Transient {
  ...
  static HashCode(theSystemFont: any, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual_2(theFont1: any, theFont2: any): boolean;
  delete(): void;
}
...
export declare class Font_FontMgr extends Standard_Transient {
  ...
  static FontAspectToString(theAspect: Font_FontAspect): string;
...
export declare class Graphic3d_CubeMapPacked extends Graphic3d_CubeMap {
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class Graphic3d_CubeMapSeparate extends Graphic3d_CubeMap {
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  CompressedValue(theSupported: any): any;
...
export declare class Graphic3d_Texture1D extends Graphic3d_TextureMap {
  ...
  static NumberOfTextures(): Standard_Integer;
  static TextureName(aRank: Standard_Integer): TCollection_AsciiString;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class Image_Texture extends Standard_Transient {
  ...
  static HashCode(theTexture: any, theUpper: number): number;
  static IsEqual(theTex1: any, theTex2: any): Standard_Boolean;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  delete(): void;
}
...
export declare class Image_AlienPixMap extends Image_PixMap {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static IsTopDownDefault(): boolean;
...
export declare class Image_DDSParser {
  constructor();
  static Load_1(theSupported: any, theFile: TCollection_AsciiString, theFaceIndex: Standard_Integer, theFileOffset: int64_t): any;
  static Load_2(theSupported: any, theBuffer: any, theFaceIndex: Standard_Integer): any;
  delete(): void;
}
...
export declare class Image_VideoParams {
  constructor()
  SetFramerate_1(theNumerator: Standard_Integer, theDenominator: Standard_Integer): void;
  SetFramerate_2(theValue: Standard_Integer): void;
  delete(): void;
}
...
export declare class Graphic3d_Mat4 {
  ...
  static Map_1(theData: Standard_ShortReal): Graphic3d_Mat4;
  static Map_2(theData: Standard_ShortReal): Graphic3d_Mat4;
  DumpJson(theOStream: Standard_OStream, a1: Standard_Integer): void;
  delete(): void;
}
...
export declare class Graphic3d_Mat4d {
  ...
  static Map_1(theData: Standard_Real): Graphic3d_Mat4d;
  static Map_2(theData: Standard_Real): Graphic3d_Mat4d;
  DumpJson(theOStream: Standard_OStream, a1: Standard_Integer): void;
  delete(): void;
}
...
export declare type module_TKService_wasm = {
  ...
  Image_ColorRGB: typeof Image_ColorRGB;
  Image_ColorRGB32: typeof Image_ColorRGB32;
  Image_ColorRGBA: typeof Image_ColorRGBA;
  Image_ColorBGR: typeof Image_ColorBGR;
  Image_ColorBGR32: typeof Image_ColorBGR32;
  Image_ColorBGRA: typeof Image_ColorBGRA;
  Image_ColorRGF: typeof Image_ColorRGF;
  Image_ColorRGBF: typeof Image_ColorRGBF;
  Image_ColorBGRF: typeof Image_ColorBGRF;
  Image_ColorRGBAF: typeof Image_ColorRGBAF;
  Image_ColorBGRAF: typeof Image_ColorBGRAF;
  ...
  Graphic3d_ValueInterface: typeof Graphic3d_ValueInterface;
  ...
  Graphic3d_BufferRange: typeof Graphic3d_BufferRange;
  Graphic3d_BufferRange_1: typeof Graphic3d_BufferRange_1;
  Graphic3d_BufferRange_2: typeof Graphic3d_BufferRange_2;
  Graphic3d_Attribute: typeof Graphic3d_Attribute;
  ...
  Graphic3d_ZLayerSettings: typeof Graphic3d_ZLayerSettings;
  ...
  Aspect_Touch: typeof Aspect_Touch;
  Aspect_Touch_1: typeof Aspect_Touch_1;
  Aspect_Touch_2: typeof Aspect_Touch_2;
  Aspect_Touch_3: typeof Aspect_Touch_3;
  Aspect_XRHapticActionData: typeof Aspect_XRHapticActionData;
  Aspect_ScrollDelta: typeof Aspect_ScrollDelta;
  Aspect_ScrollDelta_1: typeof Aspect_ScrollDelta_1;
  Aspect_ScrollDelta_2: typeof Aspect_ScrollDelta_2;
  Aspect_ScrollDelta_3: typeof Aspect_ScrollDelta_3;
  Aspect_AspectFillAreaDefinitionError: typeof Aspect_AspectFillAreaDefinitionError;
  ...
  Aspect_AspectLineDefinitionError: typeof Aspect_AspectLineDefinitionError;
  ...
  Aspect_AspectMarkerDefinitionError: typeof Aspect_AspectMarkerDefinitionError;
  ...
  Aspect_Grid: typeof Aspect_Grid;
  Aspect_CircularGrid: typeof Aspect_CircularGrid;
  Aspect_DisplayConnection: typeof Aspect_DisplayConnection;
  Aspect_DisplayConnectionDefinitionError: typeof Aspect_DisplayConnectionDefinitionError;
  ...
  Aspect_GraphicDeviceDefinitionError: typeof Aspect_GraphicDeviceDefinitionError;
  ...
  Aspect_IdentDefinitionError: typeof Aspect_IdentDefinitionError;
  ...
  Aspect_XRAnalogActionData: typeof Aspect_XRAnalogActionData;
  Aspect_XRDigitalActionData: typeof Aspect_XRDigitalActionData;
  Aspect_TrackedDevicePose: typeof Aspect_TrackedDevicePose;
  Aspect_XRPoseActionData: typeof Aspect_XRPoseActionData;
  Aspect_XRSession: typeof Aspect_XRSession;
  Aspect_OpenVRSession: typeof Aspect_OpenVRSession;
  Aspect_RectangularGrid: typeof Aspect_RectangularGrid;
  ...
  Aspect_WindowError: typeof Aspect_WindowError;
  ...
  Font_Rect: typeof Font_Rect;
  Font_FTFontParams: typeof Font_FTFontParams;
  Font_FTFontParams_1: typeof Font_FTFontParams_1;
  Font_FTFontParams_2: typeof Font_FTFontParams_2;
  ...
  Image_DDSParser: typeof Image_DDSParser;
  Image_Diff: typeof Image_Diff;
  Image_SupportedFormats: typeof Image_SupportedFormats;
  Image_VideoParams: typeof Image_VideoParams;

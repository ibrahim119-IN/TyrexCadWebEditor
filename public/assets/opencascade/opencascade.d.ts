import { module_TKGeomAlgo_wasm } from './module.TKGeomAlgo.wasm';
import { module_TKV3d_wasm } from './module.TKV3d.wasm';
import { module_TKStdL_wasm } from './module.TKStdL.wasm';
import { module_TKSTEP_wasm } from './module.TKSTEP.wasm';
import { module_TKG2d_wasm } from './module.TKG2d.wasm';
import { module_TKCAF_wasm } from './module.TKCAF.wasm';
import { module_TKSTEPBase_wasm } from './module.TKSTEPBase.wasm';
import { module_TKVCAF_wasm } from './module.TKVCAF.wasm';
import { module_TKBinTObj_wasm } from './module.TKBinTObj.wasm';
import { module_TKRWMesh_wasm } from './module.TKRWMesh.wasm';
import { module_TKQADraw_wasm } from './module.TKQADraw.wasm';
import { module_TKGeomBase_wasm } from './module.TKGeomBase.wasm';
import { module_TKXSBase_wasm } from './module.TKXSBase.wasm';
import { module_TKXDESTEP_wasm } from './module.TKXDESTEP.wasm';
import { module_TKTopAlgo_wasm } from './module.TKTopAlgo.wasm';
import { module_TKXCAF_wasm } from './module.TKXCAF.wasm';
import { module_TKCDF_wasm } from './module.TKCDF.wasm';
import { module_TKTObj_wasm } from './module.TKTObj.wasm';
import { module_TKLCAF_wasm } from './module.TKLCAF.wasm';
import { module_TKMath_wasm } from './module.TKMath.wasm';
import { module_TKSTEPAttr_wasm } from './module.TKSTEPAttr.wasm';
import { module_TKBool_wasm } from './module.TKBool.wasm';
import { module_TKBin_wasm } from './module.TKBin.wasm';
import { module_TKBinXCAF_wasm } from './module.TKBinXCAF.wasm';
import { module_TKMesh_wasm } from './module.TKMesh.wasm';
import { module_TKSTEP209_wasm } from './module.TKSTEP209.wasm';
import { module_TKService_wasm } from './module.TKService.wasm';
import { module_TKBRep_wasm } from './module.TKBRep.wasm';
import { module_TKPrim_wasm } from './module.TKPrim.wasm';
import { module_TKStd_wasm } from './module.TKStd.wasm';
import { module_TKG3d_wasm } from './module.TKG3d.wasm';
import { module_TKXmlXCAF_wasm } from './module.TKXmlXCAF.wasm';
import { module_TKVRML_wasm } from './module.TKVRML.wasm';
import { module_TKBO_wasm } from './module.TKBO.wasm';
import { module_TKMeshVS_wasm } from './module.TKMeshVS.wasm';
import { module_TKXmlTObj_wasm } from './module.TKXmlTObj.wasm';
import { module_TKXDEIGES_wasm } from './module.TKXDEIGES.wasm';
import { module_TKSTL_wasm } from './module.TKSTL.wasm';
import { module_TKXMesh_wasm } from './module.TKXMesh.wasm';
import { module_TKXmlL_wasm } from './module.TKXmlL.wasm';
import { module_TKXml_wasm } from './module.TKXml.wasm';
import { module_TKIGES_wasm } from './module.TKIGES.wasm';
import { module_TKShHealing_wasm } from './module.TKShHealing.wasm';
import { module_TKBinL_wasm } from './module.TKBinL.wasm';
import { module_TKHLR_wasm } from './module.TKHLR.wasm';
import { module_TKFillet_wasm } from './module.TKFillet.wasm';
import { module_TKFeat_wasm } from './module.TKFeat.wasm';
import { module_TKOffset_wasm } from './module.TKOffset.wasm';
...
export declare class Standard {
  constructor();
  static Allocate(aSize: Standard_ThreadId): Standard_Address;
  static Free_1(thePtr: Standard_Address): void;
  static Reallocate(aStorage: Standard_Address, aNewSize: Standard_Size): Standard_Address;
  static AllocateAligned(theSize: Standard_Size, theAlign: Standard_Size): Standard_Address;
  static FreeAligned_1(thePtrAligned: Standard_Address): void;
  static Purge(): Standard_Integer;
  delete(): void;
}
...
export declare class Standard_Type extends Standard_Transient {
  ...
  static Register(theSystemName: string, theName: string, theSize: Standard_Size, theParent: any): Standard_Type;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class Standard_Failure extends Standard_Transient {
  ...
  static NewInstance(aMessage: Standard_CString): any;
  Jump(): void;
  static Caught(): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
...
export declare class NCollection_BaseAllocator extends Standard_Transient {
  ...
  static CommonBaseAllocator(): any;
  static StandardCallBack(theIsAlloc: Standard_Boolean, theStorage: Standard_Address, theRoundSize: Standard_Size, theSize: Standard_Size): void;
  static PrintMemUsageStatistics(): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class TCollection_AsciiString {
  ...
  static HashCode(theAsciiString: TCollection_AsciiString, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual_3(string1: TCollection_AsciiString, string2: TCollection_AsciiString): Standard_Boolean;
  static IsEqual_4(string1: TCollection_AsciiString, string2: Standard_CString): Standard_Boolean;
  static IsSameString(theString1: TCollection_AsciiString, theString2: TCollection_AsciiString, theIsCaseSensitive: Standard_Boolean): Standard_Boolean;
  delete(): void;
}
...
export declare class Standard_DumpValue {
  delete(): void;
}

  export declare class Standard_DumpValue_1 extends Standard_DumpValue {
    constructor();
  }

  export declare class Standard_DumpValue_2 extends Standard_DumpValue {
    constructor(theValue: TCollection_AsciiString, theStartPos: Standard_Integer);
  }
...
export declare class Quantity_Color {
  ...
  static ColorFromHex(theHexColorString: Standard_CString, theColor: Quantity_Color): boolean;
  static ColorToHex(theColor: Quantity_Color, theToPrefixHash: boolean): TCollection_AsciiString;
  static Convert_sRGB_To_HLS(theRgb: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_HLS_To_sRGB(theHls: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_LinearRGB_To_HLS(theRgb: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_HLS_To_LinearRGB(theHls: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_LinearRGB_To_Lab(theRgb: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_Lab_To_Lch(theLab: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_Lab_To_LinearRGB(theLab: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_Lch_To_Lab(theLch: NCollection_Vec3<float>): NCollection_Vec3<float>;
  ...
  static Convert_LinearRGB_To_sRGB_approx22_2(theRGB: NCollection_Vec3<float>): NCollection_Vec3<float>;
  static Convert_sRGB_To_LinearRGB_approx22_2(theRGB: NCollection_Vec3<float>): NCollection_Vec3<float>;
...
export declare class Quantity_ColorRGBA {
  ...
  static Convert_LinearRGB_To_sRGB(theRGB: NCollection_Vec4<float>): NCollection_Vec4<float>;
  static Convert_sRGB_To_LinearRGB(theRGB: NCollection_Vec4<float>): NCollection_Vec4<float>;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  InitFromJson(theSStream: Standard_SStream, theStreamPos: Standard_Integer): Standard_Boolean;
  delete(): void;
}
...
export declare class TCollection_ExtendedString {
  ...
  static HashCode(theString: TCollection_ExtendedString, theUpperBound: Standard_Integer): Standard_Integer;
...
export declare class OSD_Chronometer {
  ...
  static GetProcessCPU(UserSeconds: Standard_Real, SystemSeconds: Standard_Real): void;
  static GetThreadCPU(UserSeconds: Standard_Real, SystemSeconds: Standard_Real): void;
  delete(): void;
}
...
export declare class OSD_Thread {
  ...
  static Current(): Standard_ThreadId;
  delete(): void;
}
...
export declare class Message_ProgressIndicator extends Standard_Transient {
  ...
  static Start_2(theProgress: any): Message_ProgressRange;
...
export declare class OSD_MemInfo {
  ...
  static PrintInfo(): TCollection_AsciiString;
  delete(): void;
}
...
export declare class Message {
  ...
  static Send_2(theMessage: TCollection_AsciiString, theGravity: Message_Gravity): void;
  static SendFail_1(): any;
  static SendAlarm_1(): any;
  static SendWarning_1(): any;
  static SendInfo_1(): any;
  static SendTrace_1(): any;
  static SendFail_2(theMessage: TCollection_AsciiString): void;
  static SendAlarm_2(theMessage: TCollection_AsciiString): void;
  static SendWarning_2(theMessage: TCollection_AsciiString): void;
  static SendInfo_2(theMessage: TCollection_AsciiString): void;
  static SendTrace_2(theMessage: TCollection_AsciiString): void;
  static FillTime(Hour: Standard_Integer, Minute: Standard_Integer, Second: Standard_Real): TCollection_AsciiString;
  static DefaultReport(theToCreate: Standard_Boolean): any;
  static MetricFromString_1(theString: Standard_CString, theType: Message_MetricType): Standard_Boolean;
  static MetricToString(theType: Message_MetricType): Standard_CString;
  static MetricFromString_2(theString: Standard_CString): Message_MetricType;
...
export declare class Message_AlertExtended extends Message_Alert {
  constructor()
  static AddAlert(theReport: any, theAttribute: any, theGravity: Message_Gravity): any;
  GetMessageKey(): Standard_CString;
  Attribute(): any;
...
export declare class OSD_ThreadPool extends Standard_Transient {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static DefaultPool(theNbThreads: number): any;
  HasThreads(): boolean;
...
export declare class OSD_Parallel {
  constructor();
  static ToUseOcctThreads(): Standard_Boolean;
  static SetUseOcctThreads(theToUseOcct: Standard_Boolean): void;
  static NbLogicalProcessors(): Standard_Integer;
  delete(): void;
}
...
export declare class NCollection_CellFilter_InspectorXYZ {
  constructor();
  static Coord(i: number, thePnt: any): Standard_Real;
  Shift(thePnt: any, theTol: Standard_Real): any;
  delete(): void;
}

export declare class NCollection_CellFilter_InspectorXY {
  constructor();
  static Coord(i: number, thePnt: any): Standard_Real;
  Shift(thePnt: any, theTol: Standard_Real): any;
  delete(): void;
...
export declare class Message_ExecStatus {
  ...
  static StatusIndex(status: Message_Status): Standard_Integer;
  static LocalStatusIndex(status: Message_Status): Standard_Integer;
  static TypeOfStatus(status: Message_Status): Message_StatusType;
  static StatusByIndex(theIndex: Standard_Integer): Message_Status;
  delete(): void;
}
...
export declare class Message_Algorithm extends Standard_Transient {
  ...
  static PrepareReport_1(theError: any, theMaxCount: Standard_Integer): TCollection_ExtendedString;
  static PrepareReport_2(theReportSeq: TColStd_SequenceOfHExtendedString, theMaxCount: Standard_Integer): TCollection_ExtendedString;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class Standard_GUID {
  ...
  static HashCode(theGUID: Standard_GUID, theUpperBound: Standard_Integer): Standard_Integer;
...
export declare class FSD_Base64Decoder {
  constructor();
  static Decode(theStr: Standard_Byte, theLen: Standard_Size): any;
  delete(): void;
}

export declare class FSD_FileHeader {
  constructor();
  delete(): void;
}

export declare class FSD_CmpFile extends FSD_File {
  constructor()
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  ...
  Destroy(): void;
  static MagicNumber(): Standard_CString;
  delete(): void;
}
...
export declare class NCollection_UtfStringTool {
  constructor()
  FromLocale(theString: string): wchar_t;
  static ToLocale(theWideString: wchar_t, theBuffer: string, theSizeBytes: Standard_Integer): boolean;
  delete(): void;
}

export declare class Quantity_ColorHasher {
  constructor();
  static HashCode(theColor: Quantity_Color, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(theColor1: Quantity_Color, theColor2: Quantity_Color): Standard_Boolean;
  delete(): void;
}

export declare class Quantity_ColorRGBAHasher {
  constructor();
  static HashCode(theColor: Quantity_ColorRGBA, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(theColor1: Quantity_ColorRGBA, theColor2: Quantity_ColorRGBA): Standard_Boolean;
  delete(): void;
}
...
export declare class Message_AttributeMeter extends Message_Attribute {
  constructor(theName: TCollection_AsciiString)
  static UndefinedMetricValue(): Standard_Real;
  ...
  static StartAlert(theAlert: any): void;
  static StopAlert(theAlert: any): void;
  static SetAlertMetrics(theAlert: any, theStartValue: Standard_Boolean): void;
  DumpJson(theOStream: Standard_OStream, theDepth: Standard_Integer): void;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
...
export declare class Message_MsgFile {
  constructor();
  static Load(theDirName: Standard_CString, theFileName: Standard_CString): Standard_Boolean;
  static LoadFile(theFName: Standard_CString): Standard_Boolean;
  static LoadFromEnv(theEnvName: Standard_CString, theFileName: Standard_CString, theLangExt: Standard_CString): Standard_Boolean;
  static LoadFromString(theContent: Standard_CString, theLength: Standard_Integer): Standard_Boolean;
  static AddMsg(key: TCollection_AsciiString, text: TCollection_ExtendedString): Standard_Boolean;
  static HasMsg(key: TCollection_AsciiString): Standard_Boolean;
  static Msg_1(key: Standard_CString): TCollection_ExtendedString;
  static Msg_2(key: TCollection_AsciiString): TCollection_ExtendedString;
  delete(): void;
}
...
export declare class Message_PrinterOStream extends Message_Printer {
  ...
  static get_type_descriptor(): any;
  DynamicType(): any;
  static SetConsoleTextColor(theOStream: Standard_OStream, theTextColor: Message_ConsoleColor, theIsIntenseText: boolean): void;
  Close(): void;
...
export declare class NCollection_HeapAllocator extends NCollection_BaseAllocator {
  ...
  Free(anAddress: void): void;
  static GlobalHeapAllocator(): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class OSD {
  constructor();
  static SetSignal_1(theSignalMode: OSD_SignalMode, theFloatingSignal: Standard_Boolean): void;
  static SetSignal_2(theFloatingSignal: Standard_Boolean): void;
  static SetThreadLocalSignal(theSignalMode: OSD_SignalMode, theFloatingSignal: Standard_Boolean): void;
  static SetFloatingSignal(theFloatingSignal: Standard_Boolean): void;
  static SignalMode(): OSD_SignalMode;
  static ToCatchFloatingSignals(): Standard_Boolean;
  static SecSleep(theSeconds: Standard_Integer): void;
  static MilliSecSleep(theMilliseconds: Standard_Integer): void;
  static CStringToReal(aString: Standard_CString, aReal: Standard_Real): Standard_Boolean;
...
export declare class OSD_Directory extends OSD_FileNode {
  static BuildTemporary(): OSD_Directory;
...
export declare class OSD_MAllocHook {
  constructor();
  static SetCallback(theCB: any): void;
  static GetCallback(): any;
  static GetLogFileHandler(): any;
  static GetCollectBySize(): any;
  delete(): void;
}
...
export declare class OSD_Process {
  constructor()
  static ExecutablePath(): TCollection_AsciiString;
  static ExecutableFolder(): TCollection_AsciiString;
...
export declare class Quantity_Date {
  ...
  static IsValid(mm: Standard_Integer, dd: Standard_Integer, yy: Standard_Integer, hh: Standard_Integer, mn: Standard_Integer, ss: Standard_Integer, mis: Standard_Integer, mics: Standard_Integer): Standard_Boolean;
  static IsLeap(yy: Standard_Integer): Standard_Boolean;
  delete(): void;
}
...
export declare class Plugin {
  constructor();
  static Load(aGUID: Standard_GUID, theVerbose: Standard_Boolean): any;
  delete(): void;
}
...
export declare class Quantity_Period {
  ...
  static IsValid_1(dd: Standard_Integer, hh: Standard_Integer, mn: Standard_Integer, ss: Standard_Integer, mis: Standard_Integer, mics: Standard_Integer): Standard_Boolean;
  static IsValid_2(ss: Standard_Integer, mics: Standard_Integer): Standard_Boolean;
  delete(): void;
}
...
export declare class Resource_Manager extends Standard_Transient {
  ...
  static GetResourcePath(aPath: TCollection_AsciiString, aName: Standard_CString, isUserDefaults: Standard_Boolean): void;
  delete(): void;
}
...
export declare class Standard_MMgrOpt extends Standard_MMgrRoot {
  ...
  Free(thePtr: Standard_Address): void;
  Purge(isDestroyed: Standard_Boolean): Standard_Integer;
  static SetCallBackFunction(pFunc: any): void;
  delete(): void;
}
...
export declare class Storage_Schema extends Standard_Transient {
  ...
  static CheckTypeMigration(theTypeName: TCollection_AsciiString, theNewName: TCollection_AsciiString): Standard_Boolean;
...
export declare class TCollection {
  constructor();
  static NextPrimeForMap(I: Standard_Integer): Standard_Integer;
  delete(): void;
}
...
export declare class Units {
  constructor();
  static UnitsFile(afile: Standard_CString): void;
  static LexiconFile(afile: Standard_CString): void;
  static DictionaryOfUnits(amode: Standard_Boolean): any;
  static Quantity(aquantity: Standard_CString): any;
  static FirstQuantity(aunit: Standard_CString): Standard_CString;
  static LexiconUnits(amode: Standard_Boolean): any;
  static LexiconFormula(): any;
  static NullDimensions(): any;
  static Convert(avalue: Standard_Real, afirstunit: Standard_CString, asecondunit: Standard_CString): Standard_Real;
  static ToSI_1(aData: Standard_Real, aUnit: Standard_CString): Standard_Real;
  static ToSI_2(aData: Standard_Real, aUnit: Standard_CString, aDim: any): Standard_Real;
  static FromSI_1(aData: Standard_Real, aUnit: Standard_CString): Standard_Real;
  static FromSI_2(aData: Standard_Real, aUnit: Standard_CString, aDim: any): Standard_Real;
  static Dimensions(aType: Standard_CString): any;
  delete(): void;
}
...
export declare class Units_Dimensions extends Standard_Transient {
  ...
  static ALength(): any;
  static ATime(): any;
  static AElectricCurrent(): any;
  static AThermodynamicTemperature(): any;
  static AAmountOfSubstance(): any;
  static ALuminousIntensity(): any;
  static APlaneAngle(): any;
  static ASolidAngle(): any;
  static get_type_name(): string;
  static get_type_descriptor(): any;
  DynamicType(): any;
  delete(): void;
...
export declare class UnitsAPI {
  constructor();
  static CurrentToLS(aData: Standard_Real, aQuantity: Standard_CString): Standard_Real;
  static CurrentToSI(aData: Standard_Real, aQuantity: Standard_CString): Standard_Real;
  static CurrentFromLS(aData: Standard_Real, aQuantity: Standard_CString): Standard_Real;
  static CurrentFromSI(aData: Standard_Real, aQuantity: Standard_CString): Standard_Real;
  static AnyToLS_1(aData: Standard_Real, aUnit: Standard_CString): Standard_Real;
  static AnyToLS_2(aData: Standard_Real, aUnit: Standard_CString, aDim: any): Standard_Real;
  static AnyToSI_1(aData: Standard_Real, aUnit: Standard_CString): Standard_Real;
  static AnyToSI_2(aData: Standard_Real, aUnit: Standard_CString, aDim: any): Standard_Real;
  static AnyFromLS(aData: Standard_Real, aUnit: Standard_CString): Standard_Real;
  static AnyFromSI(aData: Standard_Real, aUnit: Standard_CString): Standard_Real;
  static CurrentToAny(aData: Standard_Real, aQuantity: Standard_CString, aUnit: Standard_CString): Standard_Real;
  static CurrentFromAny(aData: Standard_Real, aQuantity: Standard_CString, aUnit: Standard_CString): Standard_Real;
  static AnyToAny(aData: Standard_Real, aUnit1: Standard_CString, aUnit2: Standard_CString): Standard_Real;
  static LSToSI(aData: Standard_Real, aQuantity: Standard_CString): Standard_Real;
  static SIToLS(aData: Standard_Real, aQuantity: Standard_CString): Standard_Real;
  static SetLocalSystem(aSystemUnit: UnitsAPI_SystemUnits): void;
  static LocalSystem(): UnitsAPI_SystemUnits;
  static SetCurrentUnit(aQuantity: Standard_CString, aUnit: Standard_CString): void;
  static CurrentUnit(aQuantity: Standard_CString): Standard_CString;
  static Save(): void;
  static Reload(): void;
  static Dimensions(aQuantity: Standard_CString): any;
  static DimensionLess(): any;
  static DimensionMass(): any;
  static DimensionLength(): any;
  static DimensionTime(): any;
  static DimensionElectricCurrent(): any;
  static DimensionThermodynamicTemperature(): any;
  static DimensionAmountOfSubstance(): any;
  static DimensionLuminousIntensity(): any;
  static DimensionPlaneAngle(): any;
  static DimensionSolidAngle(): any;
  static Check(aQuantity: Standard_CString, aUnit: Standard_CString): Standard_Boolean;
  delete(): void;
}

export declare class Helpers {
  constructor();
  static ConvertAsciiString(s: TCollection_AsciiString): string;
  delete(): void;
}
...
export declare class TColStd_MapIntegerHasher {
  constructor();
  static HashCode(theKey: Standard_Integer, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(theKey1: Standard_Integer, theKey2: Standard_Integer): Standard_Boolean;
  delete(): void;
}
...
export declare class Message_HArrayOfMsg {
  ...
  static DownCast(theOther: Handle_Standard_Transient): Message_HArrayOfMsg;
  delete(): void;
}
...
export declare class TColStd_MapRealHasher {
  constructor();
  static HashCode(theKey: Standard_Real, theUpperBound: Standard_Integer): Standard_Integer;
  static IsEqual(theKey1: Standard_Real, theKey2: Standard_Real): Standard_Boolean;
  delete(): void;
}
...
export declare class Storage_PType extends NCollection_BaseMap {
  begin(): any;
  end(): any;
  cbegin(): any;
  cend(): any;
  Exchange(theOther: Storage_PType): void;
  Assign(theOther: Storage_PType): Storage_PType;
  ReSize(N: Standard_Integer): void;
  ...
  export declare class Storage_PType_1 extends Storage_PType {
    constructor();
  }

  export declare class Storage_PType_2 extends Storage_PType {
    constructor(theNbBuckets: Standard_Integer, theAllocator: Handle_NCollection_BaseAllocator);
  }

  export declare class Storage_PType_3 extends Storage_PType {
    constructor(theOther: Storage_PType);
  }
...
export declare type opencascade_js = {
  ...
  Standard_DumpValue_1: typeof Standard_DumpValue_1;
  Standard_DumpValue_2: typeof Standard_DumpValue_2;
  NCollection_BaseVector: typeof NCollection_BaseVector;
  ...
  NCollection_CellFilter_InspectorXYZ: typeof NCollection_CellFilter_InspectorXYZ;
  NCollection_CellFilter_InspectorXY: typeof NCollection_CellFilter_InspectorXY;
  ...
  FSD_Base64Decoder: typeof FSD_Base64Decoder;
  ...
  Quantity_ColorHasher: typeof Quantity_ColorHasher;
  Quantity_ColorRGBAHasher: typeof Quantity_ColorRGBAHasher;
  ...
  NCollection_UtfString: typeof NCollection_UtfString;
  ...
  NCollection_IndexedDataMap: typeof NCollection_IndexedDataMap;
  Storage_PType_1: typeof Storage_PType_1;
  Storage_PType_2: typeof Storage_PType_2;
  Storage_PType_3: typeof Storage_PType_3;
  handle: typeof handle;
...
export type openCascadeModuleObject = {
...
export type openCascadeInstance = {FS: typeof FS} & {ready: Promise<openCascadeInstance>} & module_TKGeomAlgo_wasm & module_TKV3d_wasm & module_TKStdL_wasm & module_TKSTEP_wasm & module_TKG2d_wasm & module_TKCAF_wasm & module_TKSTEPBase_wasm & module_TKVCAF_wasm & module_TKBinTObj_wasm & module_TKRWMesh_wasm & module_TKQADraw_wasm & module_TKGeomBase_wasm & module_TKXSBase_wasm & module_TKXDESTEP_wasm & module_TKTopAlgo_wasm & module_TKXCAF_wasm & module_TKCDF_wasm & module_TKTObj_wasm & module_TKLCAF_wasm & module_TKMath_wasm & module_TKSTEPAttr_wasm & module_TKBool_wasm & module_TKBin_wasm & module_TKBinXCAF_wasm & module_TKMesh_wasm & module_TKSTEP209_wasm & module_TKService_wasm & module_TKBRep_wasm & module_TKPrim_wasm & module_TKStd_wasm & module_TKG3d_wasm & module_TKXmlXCAF_wasm & module_TKVRML_wasm & module_TKBO_wasm & module_TKMeshVS_wasm & module_TKXmlTObj_wasm & module_TKXDEIGES_wasm & module_TKSTL_wasm & module_TKXMesh_wasm & module_TKXmlL_wasm & module_TKXml_wasm & module_TKIGES_wasm & module_TKShHealing_wasm & module_TKBinL_wasm & module_TKHLR_wasm & module_TKFillet_wasm & module_TKFeat_wasm & module_TKOffset_wasm & typeof ThisModule;

declare function openCascade(module: openCascadeModuleObject): Promise<openCascadeInstance>;
